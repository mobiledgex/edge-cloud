...
func ExecRequestSlicer(in *edgeproto.ExecRequest) []string {
	...
	s = append(s, in.AppInstKey.AppKey.Unsupported)
...
func ExecRequestHeaderSlicer() []string {
	...
	s = append(s, "AppInstKey-AppKey-Unsupported")
...
func init() {
	...
	ExecRequestFlagSet.StringVar(&ExecRequestIn.AppInstKey.AppKey.Unsupported, "appinstkey-appkey-unsupported", "", "AppInstKey.AppKey.Unsupported")
