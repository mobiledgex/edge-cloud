...
var FindCloudletReplyComments = map[string]string{
	...
	"ports:#.pktsize":                     "UDP datagram size (udp only)",
...
var CloudletLocationComments = map[string]string{
	...
	"appinstances:#.ports:#.pktsize":      "UDP datagram size (udp only)",
...
var AppInstListReplyOptionalArgs = []string{
	...
	"cloudlets:#.appinstances:#.ports:#.pktsize",
...
var AppInstListReplyComments = map[string]string{
	...
	"cloudlets:#.appinstances:#.ports:#.pktsize":      "UDP datagram size (udp only)",
...
var ServerEdgeEventComments = map[string]string{
	...
	"newcloudlet.ports:#.pktsize":                     "UDP datagram size (udp only)",
