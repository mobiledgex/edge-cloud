...
var FindCloudletReplyComments = map[string]string{
	...
	"ports:#.skiphealthcheck":             "Proxy health check for this port",
...
var CloudletLocationOptionalArgs = []string{
	...
	"appinstances:#.ports:#.skiphealthcheck",
...
var CloudletLocationComments = map[string]string{
	...
	"appinstances:#.ports:#.skiphealthcheck": "Proxy health check for this port",
...
var AppInstListReplyOptionalArgs = []string{
	...
	"cloudlets:#.appinstances:#.ports:#.skiphealthcheck",
...
var AppInstListReplyComments = map[string]string{
	...
	"cloudlets:#.appinstances:#.ports:#.skiphealthcheck": "Proxy health check for this port",
