...
var VMComments = map[string]string{
	...
	"state":              "VM State, one of Free, InProgress, InUse, Add, Remove, Update, ForceFree",
	...
	"flavor.deprecated":  "Set if this infra flavor gets deleted during runtime while in use",
}
