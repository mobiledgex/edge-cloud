...
var DebugRequestComments = map[string]string{
	...
	"levels":                                 "Comma separated list of debug level names: etcd,redis,api,notify,dmereq,locapi,infra,metrics,upgrade,info,sampled",
...
var DebugDataComments = map[string]string{
	...
	"requests:#.levels":                                 "Comma separated list of debug level names: etcd,redis,api,notify,dmereq,locapi,infra,metrics,upgrade,info,sampled",
