...
var AllDataOptionalArgs = []string{
	...
	"clusterinsts:#.fqdn",
	"clusterinsts:#.gpudriverlicenseconfig",
	"clusterinsts:#.gpudriverlicenseconfigmd5sum",
	"apps:#.fields",
...
var AllDataComments = map[string]string{
	...
	"clusterinsts:#.gpudriverlicenseconfig":                                          "GPU driver license configuration associated with ClusterInst",
	"clusterinsts:#.gpudriverlicenseconfigmd5sum":                                    "GPU driver license configuration md5sum associated with ClusterInst",
