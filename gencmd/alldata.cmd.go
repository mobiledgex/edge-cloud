...
var AllDataComments = map[string]string{
	...
	"flavors:#.type":      "Type of flavor, one of FlavorTypeGeneral, FlavorTypeGpu",
	"flavors:#.gputype":   "GPU Type of flavor, one of GpuTypeNone, GpuTypePassthrough, GpuTypeVgpu",
