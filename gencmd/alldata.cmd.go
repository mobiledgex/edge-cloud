...
func AllDataHideTags(in *edgeproto.AllData) {
	...
	for i0 := 0; i0 < len(in.CloudletInfos); i0++ {
		...
		for i2 := 0; i2 < len(in.CloudletInfos[i0].Resources.Info); i2++ {
		}
		if _, found := tags["nocmp"]; found {
...
var AllDataOptionalArgs = []string{
	...
	"settings.cloudletresourcealertthresholdpercentage",
	"operatorcodes:#.code",
	...
	"cloudletinfos:#.resources.info:#.units",
	"cloudletinfos:#.resources.info:#.alertthreshold",
	...
	"clusterinsts:#.resources.info:#.units",
	"clusterinsts:#.resources.info:#.alertthreshold",
...
var AllDataComments = map[string]string{
	...
	"settings.cloudletresourcealertthresholdpercentage":          "Cloudlet resource alert threshold percentage",
	...
	"cloudletinfos:#.resources.info:#.units":                     "Resource units",
	"cloudletinfos:#.resources.info:#.alertthreshold":            "Generate alert when more than threshold percentage of resource is used",
	...
	"clusterinsts:#.resources.info:#.units":                      "Resource units",
	"clusterinsts:#.resources.info:#.alertthreshold":             "Generate alert when more than threshold percentage of resource is used",
