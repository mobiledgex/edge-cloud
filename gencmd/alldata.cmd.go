...
var AllDataOptionalArgs = []string{
	...
	"apps:#.vmappostype",
	"apps:#.alertpolicies",
	"apps:#.firewallpolicy.concurrentconns",
	"apps:#.firewallpolicy.connsperip",
	"appinstances:#.fields",
...
var AllDataComments = map[string]string{
	...
	"apps:#.firewallpolicy.concurrentconns":                                         "Max total number of concurrent connections",
	"apps:#.firewallpolicy.connsperip":                                              "Max number of concurrent connections per IP",
