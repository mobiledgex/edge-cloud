...
func AllDataHideTags(in *edgeproto.AllData) {
	...
	for i0 := 0; i0 < len(in.Operators); i0++ {
	}
	for i0 := 0; i0 < len(in.OperatorCodes); i0++ {
	}
	for i0 := 0; i0 < len(in.Developers); i0++ {
	}
...
var AllDataOptionalArgs = []string{
	...
	"restagtables.key.operatorkey.name",
	"restagtables.tags",
	"restagtables.azone",
	"cloudlets.fields",
	"cloudlets.key.operatorkey.name",
	"cloudlets.key.name",
	...
	"autoprovpolicycloudlets.key.developer",
	"autoprovpolicycloudlets.key.name",
	"autoprovpolicycloudlets.cloudletkey.operatorkey.name",
	"autoprovpolicycloudlets.cloudletkey.name",
	"autoscalepolicies.fields",
	"autoscalepolicies.key.developer",
	...
	"appinstances.key.clusterinstkey.cloudletkey.operatorkey.name",
	"appinstances.key.clusterinstkey.cloudletkey.name",
	"appinstances.key.clusterinstkey.developer",
	...
	"appinstances.mappedports.pathprefix",
...
var AllDataComments = map[string]string{
	...
	"operators.fields":                                             "Fields are used for the Update API to specify which fields to apply",
	"operators.key.name":                                           "Company or Organization name of the operator",
	"operatorcodes.code":                                           "MCC plus MNC code, or custom carrier code designation.",
	"operatorcodes.operatorname":                                   "MobiledgeX operator name",
	"developers.fields":                                            "Fields are used for the Update API to specify which fields to apply",
	"developers.key.name":                                          "Organization or Company Name that a Developer is part of",
	"restagtables.key.name":                                        "Resource Table Name",
	"restagtables.key.operatorkey.name":                            "Company or Organization name of the operator",
	...
	"cloudlets.platformtype":                                       "Platform type, one of PlatformTypeFake, PlatformTypeDind, PlatformTypeOpenstack, PlatformTypeAzure, PlatformTypeGcp, PlatformTypeEdgebox, PlatformTypeFakeinfra",
	...
	"cloudlets.config.commercialcerts":                             "Get certs from vault or generate your own",
	"cloudlets.restagmap.value.name":                               "Resource Table Name",
	"cloudlets.restagmap.value.operatorkey.name":                   "Company or Organization name of the operator",
	...
	"cloudletinfos.key.operatorkey.name":                           "Company or Organization name of the operator",
	...
	"cloudletpoolmembers.cloudletkey.operatorkey.name":             "Company or Organization name of the operator",
	...
	"autoprovpolicies.key.developer":                               "Name of the Developer that this policy belongs to",
	...
	"autoprovpolicies.cloudlets.key.operatorkey.name":              "Company or Organization name of the operator",
	...
	"autoprovpolicycloudlets.key.developer":                        "Name of the Developer that this policy belongs to",
	"autoprovpolicycloudlets.key.name":                             "Policy name",
	"autoprovpolicycloudlets.cloudletkey.operatorkey.name":         "Company or Organization name of the operator",
	...
	"autoscalepolicies.key.developer":                              "Name of the Developer that this policy belongs to",
	...
	"privacypolicies.key.developer":                                "Name of the Developer that this policy belongs to",
	...
	"apps.configs.kind":                                            "kind (type) of config, i.e. k8s-manifest, helm-values, deploygen-config",
	...
	"appinstances.key.clusterinstkey.cloudletkey.operatorkey.name": "Company or Organization name of the operator",
	"appinstances.key.clusterinstkey.cloudletkey.name":             "Name of the cloudlet",
	"appinstances.key.clusterinstkey.developer":                    "Name of Developer that this cluster belongs to",
	...
	"appinstances.mappedports.pathprefix":                          "Public facing path for HTTP L7 access.",
	...
	"appinstances.configs.kind":                                    "kind (type) of config, i.e. k8s-manifest, helm-values, deploygen-config",
