...
var AllDataOptionalArgs = []string{
	...
	"cloudletinfos:#.resourcessnapshot.info:#.maxvalue",
	...
	"clusterinsts:#.resourcessnapshot.info:#.maxvalue",
...
var AllDataComments = map[string]string{
	...
	"cloudletinfos:#.resourcessnapshot.info:#.maxvalue":                             "Resource max value",
	...
	"clusterinsts:#.resourcessnapshot.info:#.maxvalue":                              "Resource max value",
