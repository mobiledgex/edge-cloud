...
func AllDataHideTags(in *edgeproto.AllData) {
	...
	for i0 := 0; i0 < len(in.CloudletInfos); i0++ {
		...
		for i2 := 0; i2 < len(in.CloudletInfos[i0].ResourcesSnapshot.Vms); i2++ {
			for i3 := 0; i3 < len(in.CloudletInfos[i0].ResourcesSnapshot.Vms[i2].Ipaddresses); i3++ {
			}
			for i3 := 0; i3 < len(in.CloudletInfos[i0].ResourcesSnapshot.Vms[i2].Containers); i3++ {
			}
		}
	...
	for i0 := 0; i0 < len(in.ClusterInsts); i0++ {
		...
		if _, found := tags["nocmp"]; found {
			in.ClusterInsts[i0].ResourcesSnapshot = edgeproto.InfraResourcesSnapshot{}
		}
		if _, found := tags["timestamp"]; found {
...
var AllDataOptionalArgs = []string{
	...
	"cloudletinfos:#.resourcessnapshot.vms:#.name",
	"cloudletinfos:#.resourcessnapshot.vms:#.type",
	"cloudletinfos:#.resourcessnapshot.vms:#.status",
	"cloudletinfos:#.resourcessnapshot.vms:#.infraflavor",
	"cloudletinfos:#.resourcessnapshot.vms:#.ipaddresses:#.externalip",
	"cloudletinfos:#.resourcessnapshot.vms:#.ipaddresses:#.internalip",
	"cloudletinfos:#.resourcessnapshot.vms:#.containers:#.name",
	"cloudletinfos:#.resourcessnapshot.vms:#.containers:#.type",
	"cloudletinfos:#.resourcessnapshot.vms:#.containers:#.status",
	"cloudletinfos:#.resourcessnapshot.vms:#.containers:#.clusterip",
	"cloudletinfos:#.resourcessnapshot.vms:#.containers:#.restarts",
	...
	"clusterinsts:#.optres",
	"clusterinsts:#.resourcessnapshot.vms:#.name",
	"clusterinsts:#.resourcessnapshot.vms:#.type",
	"clusterinsts:#.resourcessnapshot.vms:#.status",
	"clusterinsts:#.resourcessnapshot.vms:#.infraflavor",
	"clusterinsts:#.resourcessnapshot.vms:#.ipaddresses:#.externalip",
	"clusterinsts:#.resourcessnapshot.vms:#.ipaddresses:#.internalip",
	"clusterinsts:#.resourcessnapshot.vms:#.containers:#.name",
	"clusterinsts:#.resourcessnapshot.vms:#.containers:#.type",
	"clusterinsts:#.resourcessnapshot.vms:#.containers:#.status",
	"clusterinsts:#.resourcessnapshot.vms:#.containers:#.clusterip",
	"clusterinsts:#.resourcessnapshot.vms:#.containers:#.restarts",
	"clusterinsts:#.resourcessnapshot.info:#.name",
	"clusterinsts:#.resourcessnapshot.info:#.value",
	"clusterinsts:#.resourcessnapshot.info:#.inframaxvalue",
	"clusterinsts:#.resourcessnapshot.info:#.quotamaxvalue",
	"clusterinsts:#.resourcessnapshot.info:#.description",
	"clusterinsts:#.resourcessnapshot.info:#.units",
	"clusterinsts:#.resourcessnapshot.info:#.alertthreshold",
	"clusterinsts:#.resourcessnapshot.clusterinsts:#.clusterkey.name",
	"clusterinsts:#.resourcessnapshot.clusterinsts:#.organization",
	"clusterinsts:#.resourcessnapshot.vmappinsts:#.appkey.organization",
	"clusterinsts:#.resourcessnapshot.vmappinsts:#.appkey.name",
	"clusterinsts:#.resourcessnapshot.vmappinsts:#.appkey.version",
	"clusterinsts:#.resourcessnapshot.vmappinsts:#.clusterinstkey.clusterkey.name",
	"clusterinsts:#.resourcessnapshot.vmappinsts:#.clusterinstkey.organization",
...
var AllDataComments = map[string]string{
	...
	"cloudlets:#.state":                                                             "Current state of the cloudlet, one of TrackedStateUnknown, NotPresent, CreateRequested, Creating, CreateError, Ready, UpdateRequested, Updating, UpdateError, DeleteRequested, Deleting, DeleteError, DeletePrepare, CrmInitok, CreatingDependencies, DeleteDone, ResourceUpdateRequested",
	...
	"cloudletinfos:#.state":                                                         "State of cloudlet, one of CloudletStateUnknown, CloudletStateErrors, CloudletStateReady, CloudletStateOffline, CloudletStateNotPresent, CloudletStateInit, CloudletStateUpgrade, CloudletStateNeedSync, CloudletStateResourceUpdate",
	...
	"cloudletinfos:#.resourcessnapshot.vms:#.name":                                  "Virtual machine name",
	"cloudletinfos:#.resourcessnapshot.vms:#.type":                                  "Type can be platform, rootlb, cluster-master, cluster-node, vmapp",
	"cloudletinfos:#.resourcessnapshot.vms:#.status":                                "Runtime status of the VM",
	"cloudletinfos:#.resourcessnapshot.vms:#.infraflavor":                           "Flavor allocated within the cloudlet infrastructure, distinct from the control plane flavor",
	"cloudletinfos:#.resourcessnapshot.vms:#.containers:#.name":                     "Name of the container",
	"cloudletinfos:#.resourcessnapshot.vms:#.containers:#.type":                     "Type can be docker or kubernetes",
	"cloudletinfos:#.resourcessnapshot.vms:#.containers:#.status":                   "Runtime status of the container",
	"cloudletinfos:#.resourcessnapshot.vms:#.containers:#.clusterip":                "IP within the CNI and is applicable to kubernetes only",
	"cloudletinfos:#.resourcessnapshot.vms:#.containers:#.restarts":                 "Restart count, applicable to kubernetes only",
	...
	"clusterinsts:#.state":                                                          "State of the cluster instance, one of TrackedStateUnknown, NotPresent, CreateRequested, Creating, CreateError, Ready, UpdateRequested, Updating, UpdateError, DeleteRequested, Deleting, DeleteError, DeletePrepare, CrmInitok, CreatingDependencies, DeleteDone, ResourceUpdateRequested",
	...
	"clusterinsts:#.resourcessnapshot.vms:#.name":                                   "Virtual machine name",
	"clusterinsts:#.resourcessnapshot.vms:#.type":                                   "Type can be platform, rootlb, cluster-master, cluster-node, vmapp",
	"clusterinsts:#.resourcessnapshot.vms:#.status":                                 "Runtime status of the VM",
	"clusterinsts:#.resourcessnapshot.vms:#.infraflavor":                            "Flavor allocated within the cloudlet infrastructure, distinct from the control plane flavor",
	"clusterinsts:#.resourcessnapshot.vms:#.containers:#.name":                      "Name of the container",
	"clusterinsts:#.resourcessnapshot.vms:#.containers:#.type":                      "Type can be docker or kubernetes",
	"clusterinsts:#.resourcessnapshot.vms:#.containers:#.status":                    "Runtime status of the container",
	"clusterinsts:#.resourcessnapshot.vms:#.containers:#.clusterip":                 "IP within the CNI and is applicable to kubernetes only",
	"clusterinsts:#.resourcessnapshot.vms:#.containers:#.restarts":                  "Restart count, applicable to kubernetes only",
	"clusterinsts:#.resourcessnapshot.info:#.name":                                  "Resource name",
	"clusterinsts:#.resourcessnapshot.info:#.value":                                 "Resource value",
	"clusterinsts:#.resourcessnapshot.info:#.inframaxvalue":                         "Resource infra max value",
	"clusterinsts:#.resourcessnapshot.info:#.quotamaxvalue":                         "Resource quota max value",
	"clusterinsts:#.resourcessnapshot.info:#.description":                           "Resource description",
	"clusterinsts:#.resourcessnapshot.info:#.units":                                 "Resource units",
	"clusterinsts:#.resourcessnapshot.info:#.alertthreshold":                        "Generate alert when more than threshold percentage of resource is used",
	"clusterinsts:#.resourcessnapshot.clusterinsts:#.clusterkey.name":               "Cluster name",
	"clusterinsts:#.resourcessnapshot.clusterinsts:#.organization":                  "Name of Developer organization that this cluster belongs to",
	"clusterinsts:#.resourcessnapshot.vmappinsts:#.appkey.organization":             "App developer organization",
	"clusterinsts:#.resourcessnapshot.vmappinsts:#.appkey.name":                     "App name",
	"clusterinsts:#.resourcessnapshot.vmappinsts:#.appkey.version":                  "App version",
	"clusterinsts:#.resourcessnapshot.vmappinsts:#.clusterinstkey.clusterkey.name":  "Cluster name",
	"clusterinsts:#.resourcessnapshot.vmappinsts:#.clusterinstkey.organization":     "Name of Developer organization that this cluster belongs to",
	...
	"appinstances:#.state":                                                          "Current state of the AppInst on the Cloudlet, one of TrackedStateUnknown, NotPresent, CreateRequested, Creating, CreateError, Ready, UpdateRequested, Updating, UpdateError, DeleteRequested, Deleting, DeleteError, DeletePrepare, CrmInitok, CreatingDependencies, DeleteDone, ResourceUpdateRequested",
	...
	"vmpools:#.state":                                                               "Current state of the VM pool, one of TrackedStateUnknown, NotPresent, CreateRequested, Creating, CreateError, Ready, UpdateRequested, Updating, UpdateError, DeleteRequested, Deleting, DeleteError, DeletePrepare, CrmInitok, CreatingDependencies, DeleteDone, ResourceUpdateRequested",
