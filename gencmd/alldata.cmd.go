...
var AllDataOptionalArgs = []string{
	...
	"cloudlets:#.infraaccesstype",
	"cloudlets:#.deploymenttype",
	"cloudlets:#.nummasters",
	"cloudlets:#.numnodes",
	"cloudlets:#.infraexternalnetwork",
	"cloudlets:#.infraflavorname",
...
var AllDataComments = map[string]string{
	...
	"cloudlets:#.infraaccesstype":                                "Infra Access Type is the type of access available to Infra API Endpoint, one of AccessTypePublic, AccessTypePrivate",
	"cloudlets:#.deploymenttype":                                 "Type of deployment to bring up CRM services, one of DeploymentTypeDocker, DeploymentTypeK8S",
	"cloudlets:#.nummasters":                                     "Number of k8s masters (Only valid for k8s deployment)",
	"cloudlets:#.numnodes":                                       "Number of k8s nodes (Only valid for k8s deployment)",
	"cloudlets:#.infraexternalnetwork":                           "External network name on infra",
	"cloudlets:#.infraflavorname":                                "Flavor name on infra",
	...
	"apps:#.configs:#.kind":                                      "kind (type) of config, i.e. envVarsYaml, hemlCustomizationYaml",
