...
var AllDataComments = map[string]string{
	...
	"cloudlets:#.maintenancestate":                               "State for maintenance, one of MaintenanceStart, MaintenanceStartNoFailover, NormalOperationInit",
	...
	"cloudletinfos:#.maintenancestate":                           "State for maintenance, one of MaintenanceStart, MaintenanceStartNoFailover, NormalOperationInit",
