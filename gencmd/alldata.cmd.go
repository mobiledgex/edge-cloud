...
var AllDataOptionalArgs = []string{
	...
	"cloudletinfos:#.resources.hwinfo",
...
var AllDataComments = map[string]string{
	...
	"cloudletinfos:#.resources.hwinfo":                           "HW resource information",
	...
	"clusterinsts:#.resources.hwinfo":                            "HW resource information",
...
var AllDataSpecialArgs = map[string]string{
	...
	"cloudletinfos:#.resources.hwinfo":        "StringToString",
	...
	"clusterinsts:#.resources.hwinfo":         "StringToString",
