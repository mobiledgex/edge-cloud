...
var AllDataOptionalArgs = []string{
	...
	"cloudletinfos:#.deprecatedflavors:#.name",
	"cloudletinfos:#.deprecatedflavors:#.vcpus",
	"cloudletinfos:#.deprecatedflavors:#.ram",
...
var AllDataComments = map[string]string{
	...
	"cloudletinfos:#.flavors:#.deprecated":                                          "true if the infra flavor has been deleted while in use",
	...
	"cloudletinfos:#.deprecatedflavors:#.name":                                      "Name of the flavor on the Cloudlet",
	"cloudletinfos:#.deprecatedflavors:#.vcpus":                                     "Number of VCPU cores on the Cloudlet",
	"cloudletinfos:#.deprecatedflavors:#.ram":                                       "Ram in MB on the Cloudlet",
	...
	"vmpools:#.vms:#.flavor.deprecated":                                             "true if the infra flavor has been deleted while in use",
