...
var AllDataOptionalArgs = []string{
	...
	"cloudletinfos:#.resourcessnapshot.k8sappinsts:#.appkey.organization",
	"cloudletinfos:#.resourcessnapshot.k8sappinsts:#.appkey.name",
	"cloudletinfos:#.resourcessnapshot.k8sappinsts:#.appkey.version",
	"cloudletinfos:#.resourcessnapshot.k8sappinsts:#.clusterinstkey.clusterkey.name",
	"cloudletinfos:#.resourcessnapshot.k8sappinsts:#.clusterinstkey.organization",
	...
	"clusterinsts:#.fqdn",
	"clusterinsts:#.gpuconfig.driver.name",
	"clusterinsts:#.gpuconfig.driver.organization",
	"clusterinsts:#.gpuconfig.properties",
	"clusterinsts:#.gpuconfig.licenseconfig",
	"clusterinsts:#.gpuconfig.licenseconfigmd5sum",
	"apps:#.fields",
...
var AllDataComments = map[string]string{
	...
	"cloudlets:#.gpuconfig.licenseconfig":                                            "Cloudlet specific license config to setup license (will be stored in secure storage)",
	...
	"cloudletinfos:#.resourcessnapshot.k8sappinsts:#.appkey.organization":            "App developer organization",
	"cloudletinfos:#.resourcessnapshot.k8sappinsts:#.appkey.name":                    "App name",
	"cloudletinfos:#.resourcessnapshot.k8sappinsts:#.appkey.version":                 "App version",
	"cloudletinfos:#.resourcessnapshot.k8sappinsts:#.clusterinstkey.clusterkey.name": "Cluster name",
	"cloudletinfos:#.resourcessnapshot.k8sappinsts:#.clusterinstkey.organization":    "Name of Developer organization that this cluster belongs to",
	...
	"clusterinsts:#.gpuconfig.driver.name":                                           "Name of the driver",
	"clusterinsts:#.gpuconfig.driver.organization":                                   "Organization to which the driver belongs to",
	"clusterinsts:#.gpuconfig.properties":                                            "Properties to identify specifics of GPU",
	"clusterinsts:#.gpuconfig.licenseconfig":                                         "Cloudlet specific license config to setup license (will be stored in secure storage)",
	"clusterinsts:#.gpuconfig.licenseconfigmd5sum":                                   "Cloudlet specific license config md5sum, to ensure integrity of license config",
...
var AllDataSpecialArgs = map[string]string{
	...
	"clusterinsts:#.gpuconfig.properties":     "StringToString",
