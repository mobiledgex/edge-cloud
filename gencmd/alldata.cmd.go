...
var AllDataOptionalArgs = []string{
	...
	"appinstances:#.runtimeinfo.latency",
...
var AllDataComments = map[string]string{
	...
	"appinstances:#.runtimeinfo.latency":                         "RTT latency from device to appinst and backend",
	...
	"appinstances:#.measurelatency":                              "Check to see if need to measure latency",
