...
var AllDataOptionalArgs = []string{
	...
	"settings.disablectrlratelimit",
	"settings.maxnumratelimiters",
	"operatorcodes:#.code",
...
var AllDataComments = map[string]string{
	...
	"settings.disablectrlratelimit":                                                 "Disable rate limiting for Controller APIs (default is true)",
	"settings.maxnumratelimiters":                                                   "Maximum number of limiters... TODO...",
