...
var AllDataOptionalArgs = []string{
	...
	"settings.resourcesnapshotthreadrefreshinterval",
	"settings.resourcesnapshotmaxupdateinterval",
	"operatorcodes:#.code",
...
var AllDataComments = map[string]string{
	...
	"settings.resourcesnapshotthreadrefreshinterval":                                "ResourceSnapshot Refresh thread run interval",
	"settings.resourcesnapshotmaxupdateinterval":                                    "ResourceSnapshot Refresh Max update interval",
