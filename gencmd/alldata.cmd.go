...
var AllDataOptionalArgs = []string{
	...
	"apps:#.vmappostype",
	"apps:#.alertpolicies",
	"apps:#.qosnetworkprioritytype",
	"apps:#.qoslatencyprofile",
	"apps:#.qosthroughputprofile",
	"appinstances:#.fields",
...
var AllDataComments = map[string]string{
	...
	"apps:#.qosnetworkprioritytype":                                                 "For DT QOS Priority Sessions API, one of Default, Latency, Throughput",
	"apps:#.qoslatencyprofile":                                                      ", one of Default, Low",
	"apps:#.qosthroughputprofile":                                                   ", one of Default, S, M, L",
