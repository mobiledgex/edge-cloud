...
var AllDataOptionalArgs = []string{
	...
	"cloudletinfos:#.resources.provisionedclusters",
	...
	"clusterinsts:#.resources.provisionedclusters",
...
var AllDataComments = map[string]string{
	...
	"cloudletinfos:#.resources.provisionedclusters":              "Provisioned Clusters",
	...
	"clusterinsts:#.resources.provisionedclusters":               "Provisioned Clusters",
...
var AllDataSpecialArgs = map[string]string{
	...
	"cloudletinfos:#.resources.provisionedclusters": "StringToString",
	...
	"clusterinsts:#.resources.provisionedclusters":  "StringToString",
