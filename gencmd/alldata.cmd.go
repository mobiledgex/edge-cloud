...
var AllDataComments = map[string]string{
	...
	"cloudletinfos:#.flavors:#.deprecated":                                           "True if this infra flavor has been deleted while in use",
	...
	"vmpools:#.vms:#.flavor.deprecated":                                              "True if this infra flavor has been deleted while in use",
