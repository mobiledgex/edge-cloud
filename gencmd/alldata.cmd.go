...
var AllDataComments = map[string]string{
	...
	"alertpolicies:#.cpuutilizationlimit":                                           "container or pod CPU utilization rate(percentage) across all nodes",
	"alertpolicies:#.memutilizationlimit":                                           "container or pod memory utilization rate(percentage) across all nodes",
	"alertpolicies:#.diskutilizationlimit":                                          "container or pod disk utilization rate(percentage) across all nodes",
	"alertpolicies:#.activeconnlimit":                                               "Active Connections alert threshold",
	"alertpolicies:#.severity":                                                      "Alert Policy Severity",
