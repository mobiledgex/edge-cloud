...
var AppComments = map[string]string{
	...
	"qossessionprofile":            "Qualifier for the requested latency profile, one of LowLatency, ThroughputDownS, ThroughputDownM, ThroughputDownL",
...
var DeploymentCloudletRequestComments = map[string]string{
	...
	"app.qossessionprofile":                          "Qualifier for the requested latency profile, one of LowLatency, ThroughputDownS, ThroughputDownM, ThroughputDownL",
