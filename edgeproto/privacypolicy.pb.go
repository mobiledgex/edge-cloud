...
type PrivacyPolicy struct {
	...
	// list of outbound security rules for whitelisting traffic. If no rules are specified, the default is to whilelist all outbound traffic.
	...
	// list of inbound security rules for whitelisting traffic. If no rules are specified, the default is to blacklist all inbound traffic.
	InboundSecurityRules []SecurityRule `protobuf:"bytes,4,rep,name=inbound_security_rules,json=inboundSecurityRules,proto3" json:"inbound_security_rules"`
}
...
var fileDescriptor_66d34ae35d090dc3 = []byte{
	...
	,
}
...
func (m *PrivacyPolicy) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.InboundSecurityRules) > 0 {
		for iNdEx := len(m.InboundSecurityRules) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.InboundSecurityRules[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *PrivacyPolicy) Matches(o *PrivacyPolicy, fopts ...MatchOpt) bool {
	...
	if !opts.Filter || o.InboundSecurityRules != nil {
		if m.InboundSecurityRules == nil && o.InboundSecurityRules != nil || m.InboundSecurityRules != nil && o.InboundSecurityRules == nil {
			return false
		} else if m.InboundSecurityRules != nil && o.InboundSecurityRules != nil {
			if len(m.InboundSecurityRules) != len(o.InboundSecurityRules) {
				return false
			}
			for i := 0; i < len(m.InboundSecurityRules); i++ {
			}
		}
	}
	return true
...
const PrivacyPolicyFieldInboundSecurityRules = "4"
const PrivacyPolicyFieldInboundSecurityRulesProtocol = "4.1"
const PrivacyPolicyFieldInboundSecurityRulesPortRangeMin = "4.2"
const PrivacyPolicyFieldInboundSecurityRulesPortRangeMax = "4.3"
const PrivacyPolicyFieldInboundSecurityRulesRemoteCidr = "4.4"
...
var PrivacyPolicyAllFields = []string{
	...
	PrivacyPolicyFieldInboundSecurityRulesProtocol,
	PrivacyPolicyFieldInboundSecurityRulesPortRangeMin,
	PrivacyPolicyFieldInboundSecurityRulesPortRangeMax,
	PrivacyPolicyFieldInboundSecurityRulesRemoteCidr,
}
...
var PrivacyPolicyAllFieldsMap = map[string]struct{}{
	...
	PrivacyPolicyFieldInboundSecurityRulesProtocol:      struct{}{},
	PrivacyPolicyFieldInboundSecurityRulesPortRangeMin:  struct{}{},
	PrivacyPolicyFieldInboundSecurityRulesPortRangeMax:  struct{}{},
	PrivacyPolicyFieldInboundSecurityRulesRemoteCidr:    struct{}{},
}
...
var PrivacyPolicyAllFieldsStringMap = map[string]string{
	...
	PrivacyPolicyFieldInboundSecurityRulesProtocol:      "Inbound Security Rules Protocol",
	PrivacyPolicyFieldInboundSecurityRulesPortRangeMin:  "Inbound Security Rules Port Range Min",
	PrivacyPolicyFieldInboundSecurityRulesPortRangeMax:  "Inbound Security Rules Port Range Max",
	PrivacyPolicyFieldInboundSecurityRulesRemoteCidr:    "Inbound Security Rules Remote Cidr",
}
...
func (m *PrivacyPolicy) DiffFields(o *PrivacyPolicy, fields map[string]struct{}) {
	...
	if len(m.InboundSecurityRules) != len(o.InboundSecurityRules) {
		fields[PrivacyPolicyFieldInboundSecurityRules] = struct{}{}
	} else {
		for i0 := 0; i0 < len(m.InboundSecurityRules); i0++ {
			if m.InboundSecurityRules[i0].Protocol != o.InboundSecurityRules[i0].Protocol {
				fields[PrivacyPolicyFieldInboundSecurityRulesProtocol] = struct{}{}
				fields[PrivacyPolicyFieldInboundSecurityRules] = struct{}{}
			}
			if m.InboundSecurityRules[i0].PortRangeMin != o.InboundSecurityRules[i0].PortRangeMin {
				fields[PrivacyPolicyFieldInboundSecurityRulesPortRangeMin] = struct{}{}
				fields[PrivacyPolicyFieldInboundSecurityRules] = struct{}{}
			}
			if m.InboundSecurityRules[i0].PortRangeMax != o.InboundSecurityRules[i0].PortRangeMax {
				fields[PrivacyPolicyFieldInboundSecurityRulesPortRangeMax] = struct{}{}
				fields[PrivacyPolicyFieldInboundSecurityRules] = struct{}{}
			}
			if m.InboundSecurityRules[i0].RemoteCidr != o.InboundSecurityRules[i0].RemoteCidr {
				fields[PrivacyPolicyFieldInboundSecurityRulesRemoteCidr] = struct{}{}
				fields[PrivacyPolicyFieldInboundSecurityRules] = struct{}{}
			}
		}
	}
...
var UpdatePrivacyPolicyFieldsMap = map[string]struct{}{
	...
	PrivacyPolicyFieldOutboundSecurityRulesPortRangeMax: struct{}{},
	PrivacyPolicyFieldOutboundSecurityRulesRemoteCidr:   struct{}{},
	PrivacyPolicyFieldInboundSecurityRules:              struct{}{},
	PrivacyPolicyFieldInboundSecurityRulesProtocol:      struct{}{},
	PrivacyPolicyFieldInboundSecurityRulesPortRangeMin:  struct{}{},
	PrivacyPolicyFieldInboundSecurityRulesPortRangeMax:  struct{}{},
	PrivacyPolicyFieldInboundSecurityRulesRemoteCidr:    struct{}{},
...
func (m *PrivacyPolicy) CopyInFields(src *PrivacyPolicy) int {
	...
	if _, set := fmap["4"]; set {
		if src.InboundSecurityRules != nil {
			m.InboundSecurityRules = src.InboundSecurityRules
			changed++
		} else if m.InboundSecurityRules != nil {
			m.InboundSecurityRules = nil
			changed++
		}
	}
	return changed
...
func (m *PrivacyPolicy) DeepCopyIn(src *PrivacyPolicy) {
	...
	if src.InboundSecurityRules != nil {
		m.InboundSecurityRules = make([]SecurityRule, len(src.InboundSecurityRules), len(src.InboundSecurityRules))
		for ii, s := range src.InboundSecurityRules {
			m.InboundSecurityRules[ii].DeepCopyIn(&s)
		}
	} else {
		m.InboundSecurityRules = nil
	}
...
func (m *PrivacyPolicy) ValidateEnums() error {
	...
	for _, e := range m.InboundSecurityRules {
		if err := e.ValidateEnums(); err != nil {
			return err
		}
	}
...
func (m *PrivacyPolicy) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field InboundSecurityRules", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.InboundSecurityRules = append(m.InboundSecurityRules, SecurityRule{})
			if err := m.InboundSecurityRules[len(m.InboundSecurityRules)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
