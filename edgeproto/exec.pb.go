...
const (
	...
	// Platform VM
	VMType_PLATFORM_VM VMType = 1
	// Shared RootLB VM
	VMType_SHARED_ROOTLB_VM VMType = 2
	// Dedicated RootLB VM
	VMType_DEDICATED_ROOTLB_VM VMType = 3
)
...
func (VMType) EnumDescriptor() ([]byte, []int) { return fileDescriptorExec, []int{0} }
...
type ExecRequest struct {
	...
	// VM Type
	VmType VMType `protobuf:"varint,16,opt,name=vm_type,json=vmType,proto3,enum=edgeproto.VMType" json:"vm_type,omitempty"`
}
...
func init() {
	...
	proto.RegisterEnum("edgeproto.VMType", VMType_name, VMType_value)
}
...
func (m *ExecRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.VmType != 0 {
		...
		dAtA[i] = 0x1
		i++
		i = encodeVarintExec(dAtA, i, uint64(m.VmType))
	}
	return i, nil
}
...
func (m *ExecRequest) ValidateEnums() error {
	...
	if _, ok := VMType_name[int32(m.VmType)]; !ok {
...
const (
	VMTypeUNKNOWN_VM          uint64 = 1 << 0
	VMTypePLATFORM_VM         uint64 = 1 << 1
	VMTypeSHARED_ROOTLB_VM    uint64 = 1 << 2
	VMTypeDEDICATED_ROOTLB_VM uint64 = 1 << 3
)

var VMType_CamelName = map[int32]string{
	// UNKNOWN_VM -> UnknownVm
	0: "UnknownVm",
	// PLATFORM_VM -> PlatformVm
	1: "PlatformVm",
	// SHARED_ROOTLB_VM -> SharedRootlbVm
	2: "SharedRootlbVm",
	// DEDICATED_ROOTLB_VM -> DedicatedRootlbVm
	3: "DedicatedRootlbVm",
}
var VMType_CamelValue = map[string]int32{
	"UnknownVm":         0,
	"PlatformVm":        1,
	"SharedRootlbVm":    2,
	"DedicatedRootlbVm": 3,
...
func (e *VMType) UnmarshalYAML(unmarshal func(interface{}) error) error {
	var str string
	err := unmarshal(&str)
	if err != nil {
		return err
	}
	val, ok := VMType_CamelValue[util.CamelCase(str)]
	if !ok {
		// may be enum value instead of string
		ival, err := strconv.Atoi(str)
		val = int32(ival)
		if err == nil {
			_, ok = VMType_CamelName[val]
		}
	}
	if !ok {
...
func (e VMType) MarshalYAML() (interface{}, error) {
	return proto.EnumName(VMType_CamelName, int32(e)), nil
}

// custom JSON encoding/decoding
func (e *VMType) UnmarshalJSON(b []byte) error {
	var str string
...
var fileDescriptorExec = []byte{
	...
	,
}
