...
type AllData struct {
	...
	CloudletVmPools         []CloudletVMPool         `protobuf:"bytes,19,rep,name=cloudlet_vm_pools,json=cloudletVmPools" json:"cloudlet_vm_pools"`
}
...
func (m *AllData) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.CloudletVmPools) > 0 {
		for _, msg := range m.CloudletVmPools {
			dAtA[i] = 0x9a
			i++
			dAtA[i] = 0x1
			i++
...
func (m *AllData) DeepCopyIn(src *AllData) {
	...
	if src.CloudletVmPools != nil {
		m.CloudletVmPools = make([]CloudletVMPool, len(src.CloudletVmPools), len(src.CloudletVmPools))
		for ii, s := range src.CloudletVmPools {
			m.CloudletVmPools[ii].DeepCopyIn(&s)
		}
	} else {
		m.CloudletVmPools = nil
	}
}
...
func (m *AllData) ValidateEnums() error {
	...
	for _, e := range m.CloudletVmPools {
		if err := e.ValidateEnums(); err != nil {
			return err
		}
	}
...
func IgnoreAllDataFields(taglist string) cmp.Option {
	...
	if _, found := tags["timestamp"]; found {
		names = append(names, "CloudletVmPools.CloudletVms.UpdatedAt")
	}
	if _, found := tags["nocmp"]; found {
		names = append(names, "CloudletVmPools.Action")
	}
...
func (m *AllData) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 19:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CloudletVmPools", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.CloudletVmPools = append(m.CloudletVmPools, CloudletVMPool{})
			if err := m.CloudletVmPools[len(m.CloudletVmPools)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorAlldata = []byte{
	...
	,
}
