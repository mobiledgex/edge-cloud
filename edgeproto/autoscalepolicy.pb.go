...
type AutoScalePolicy struct {
	...
	StabilizationWindowSec uint32 `protobuf:"varint,8,opt,name=stabilization_window_sec,json=stabilizationWindowSec,proto3" json:"stabilization_window_sec,omitempty"`
	// Target per-node cpu utilization (percentage 1 to 100), 0 means disabled
	TargetCpu uint32 `protobuf:"varint,9,opt,name=target_cpu,json=targetCpu,proto3" json:"target_cpu,omitempty"`
	// Target per-node memory utilization (percentage 1 to 100), 0 means disabled
	TargetMem uint32 `protobuf:"varint,10,opt,name=target_mem,json=targetMem,proto3" json:"target_mem,omitempty"`
	// Target per-node number of active connections, 0 means disabled
	TargetActiveConnections uint64 `protobuf:"varint,11,opt,name=target_active_connections,json=targetActiveConnections,proto3" json:"target_active_connections,omitempty"`
...
var fileDescriptor_b83abf40cad3a321 = []byte{
	...
	,
}
...
func (m *AutoScalePolicy) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.TargetActiveConnections != 0 {
		i = encodeVarintAutoscalepolicy(dAtA, i, uint64(m.TargetActiveConnections))
		i--
		dAtA[i] = 0x58
	}
	if m.TargetMem != 0 {
		i = encodeVarintAutoscalepolicy(dAtA, i, uint64(m.TargetMem))
		i--
		dAtA[i] = 0x50
	}
	if m.TargetCpu != 0 {
		i = encodeVarintAutoscalepolicy(dAtA, i, uint64(m.TargetCpu))
		i--
		dAtA[i] = 0x48
	}
	if m.StabilizationWindowSec != 0 {
		i = encodeVarintAutoscalepolicy(dAtA, i, uint64(m.StabilizationWindowSec))
		i--
		dAtA[i] = 0x40
	}
...
func (m *AutoScalePolicy) Matches(o *AutoScalePolicy, fopts ...MatchOpt) bool {
	...
	if !opts.Filter || o.StabilizationWindowSec != 0 {
		if o.StabilizationWindowSec != m.StabilizationWindowSec {
			return false
		}
	}
	if !opts.Filter || o.TargetCpu != 0 {
		if o.TargetCpu != m.TargetCpu {
			return false
		}
	}
	if !opts.Filter || o.TargetMem != 0 {
		if o.TargetMem != m.TargetMem {
			return false
		}
	}
	if !opts.Filter || o.TargetActiveConnections != 0 {
		if o.TargetActiveConnections != m.TargetActiveConnections {
			return false
		}
	}
...
const AutoScalePolicyFieldStabilizationWindowSec = "8"
const AutoScalePolicyFieldTargetCpu = "9"
const AutoScalePolicyFieldTargetMem = "10"
const AutoScalePolicyFieldTargetActiveConnections = "11"
const AutoScalePolicyFieldDeletePrepare = "12"
...
var AutoScalePolicyAllFields = []string{
	...
	AutoScalePolicyFieldStabilizationWindowSec,
	AutoScalePolicyFieldTargetCpu,
	AutoScalePolicyFieldTargetMem,
	AutoScalePolicyFieldTargetActiveConnections,
...
var AutoScalePolicyAllFieldsMap = map[string]struct{}{
	...
	AutoScalePolicyFieldStabilizationWindowSec:  struct{}{},
...
var AutoScalePolicyAllFieldsStringMap = map[string]string{
	...
	AutoScalePolicyFieldStabilizationWindowSec:  "Stabilization Window Sec",
	AutoScalePolicyFieldTargetCpu:               "Target Cpu",
	AutoScalePolicyFieldTargetMem:               "Target Mem",
	AutoScalePolicyFieldTargetActiveConnections: "Target Active Connections",
	AutoScalePolicyFieldDeletePrepare:           "Delete Prepare",
}
...
type AutoScalePolicyStore interface {
	Create(ctx context.Context, m *AutoScalePolicy, wait func(int64)) (*Result, error)
	Update(ctx context.Context, m *AutoScalePolicy, wait func(int64)) (*Result, error)
	Delete(ctx context.Context, m *AutoScalePolicy, wait func(int64)) (*Result, error)
...
type AutoScalePolicyStoreImpl struct {
	kvstore objstore.KVStore
}

func NewAutoScalePolicyStore(kvstore objstore.KVStore) *AutoScalePolicyStoreImpl {
	return &AutoScalePolicyStoreImpl{kvstore: kvstore}
}

func (s *AutoScalePolicyStoreImpl) Create(ctx context.Context, m *AutoScalePolicy, wait func(int64)) (*Result, error) {
...
func (s *AutoScalePolicyStoreImpl) Update(ctx context.Context, m *AutoScalePolicy, wait func(int64)) (*Result, error) {
	fmap := MakeFieldMap(m.Fields)
	err := m.Validate(fmap)
	if err != nil {
		return nil, err
...
func (s *AutoScalePolicyStoreImpl) Put(ctx context.Context, m *AutoScalePolicy, wait func(int64), ops ...objstore.KVOp) (*Result, error) {
	err := m.Validate(AutoScalePolicyAllFieldsMap)
	m.Fields = nil
	if err != nil {
		return nil, err
...
func (s *AutoScalePolicyStoreImpl) Delete(ctx context.Context, m *AutoScalePolicy, wait func(int64)) (*Result, error) {
...
func (s *AutoScalePolicyStoreImpl) LoadOne(key string) (*AutoScalePolicy, int64, error) {
...
func (s *AutoScalePolicyStoreImpl) Get(ctx context.Context, key *PolicyKey, buf *AutoScalePolicy) bool {
...
func (s *AutoScalePolicyStoreImpl) parseGetData(val []byte, buf *AutoScalePolicy) bool {
	if len(val) == 0 {
		return false
	}
	if buf != nil {
...
func (s *AutoScalePolicyStoreImpl) STMDel(stm concurrency.STM, key *PolicyKey) {
	keystr := objstore.DbKeyString("AutoScalePolicy", key)
	stm.Del(keystr)
}
...
func IgnoreAutoScalePolicyFields(taglist string) cmp.Option {
	names := []string{}
	...
	return cmpopts.IgnoreFields(AutoScalePolicy{}, names...)
}
...
func (m *AutoScalePolicy) Size() (n int) {
	...
	if m.StabilizationWindowSec != 0 {
		n += 1 + sovAutoscalepolicy(uint64(m.StabilizationWindowSec))
	}
	if m.TargetCpu != 0 {
		n += 1 + sovAutoscalepolicy(uint64(m.TargetCpu))
	}
	if m.TargetMem != 0 {
		n += 1 + sovAutoscalepolicy(uint64(m.TargetMem))
	}
	if m.TargetActiveConnections != 0 {
		n += 1 + sovAutoscalepolicy(uint64(m.TargetActiveConnections))
	}
	if m.DeletePrepare {
		n += 2
	}
...
func (m *AutoScalePolicy) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field StabilizationWindowSec", wireType)
			}
			m.StabilizationWindowSec = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowAutoscalepolicy
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.StabilizationWindowSec |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 9:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TargetCpu", wireType)
			}
			m.TargetCpu = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TargetCpu |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 10:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TargetMem", wireType)
			}
			m.TargetMem = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TargetMem |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 11:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TargetActiveConnections", wireType)
			}
			m.TargetActiveConnections = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowAutoscalepolicy
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TargetActiveConnections |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
