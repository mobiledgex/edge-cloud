...
// Infra Access Type
//
// InfraAccessType is the type of access available to Infra API endpoint
type InfraAccessType int32

const (
	// Infra API endpoint is accessible from public network
	InfraAccessType_ACCESS_TYPE_PUBLIC InfraAccessType = 0
	// Infra API endpoint is not accessible from public network
	InfraAccessType_ACCESS_TYPE_PRIVATE InfraAccessType = 1
)

var InfraAccessType_name = map[int32]string{
	0: "ACCESS_TYPE_PUBLIC",
	1: "ACCESS_TYPE_PRIVATE",
}
var InfraAccessType_value = map[string]int32{
	"ACCESS_TYPE_PUBLIC":  0,
	"ACCESS_TYPE_PRIVATE": 1,
}

func (x InfraAccessType) String() string {
	return proto.EnumName(InfraAccessType_name, int32(x))
}
func (InfraAccessType) EnumDescriptor() ([]byte, []int) { return fileDescriptorCloudlet, []int{2} }

// Deployment Type
//
// DeploymentType is the type of deployment to bring up CRM services
type DeploymentType int32

const (
	// CRM services deployed as docker container
	DeploymentType_DEPLOYMENT_TYPE_DOCKER DeploymentType = 0
	// CRM services deployed as part of kubernetes cluster
	DeploymentType_DEPLOYMENT_TYPE_K8S DeploymentType = 1
)

var DeploymentType_name = map[int32]string{
	0: "DEPLOYMENT_TYPE_DOCKER",
	1: "DEPLOYMENT_TYPE_K8S",
}
var DeploymentType_value = map[string]int32{
	"DEPLOYMENT_TYPE_DOCKER": 0,
	"DEPLOYMENT_TYPE_K8S":    1,
}

func (x DeploymentType) String() string {
	return proto.EnumName(DeploymentType_name, int32(x))
}
func (DeploymentType) EnumDescriptor() ([]byte, []int) { return fileDescriptorCloudlet, []int{3} }
...
func (CloudletState) EnumDescriptor() ([]byte, []int) { return fileDescriptorCloudlet, []int{4} }
...
type PlatformConfig struct {
	...
	// Path to Chef Server
	ChefServerPath string `protobuf:"bytes,16,opt,name=chef_server_path,json=chefServerPath,proto3" json:"chef_server_path,omitempty"`
...
type Cloudlet struct {
	...
	InfraAccessType InfraAccessType `protobuf:"varint,26,opt,name=infra_access_type,json=infraAccessType,proto3,enum=edgeproto.InfraAccessType" json:"infra_access_type,omitempty"`
	// Type of deployment to bring up CRM services
	DeploymentType DeploymentType `protobuf:"varint,27,opt,name=deployment_type,json=deploymentType,proto3,enum=edgeproto.DeploymentType" json:"deployment_type,omitempty"`
	// External network name on infra
	InfraExternalNetwork string `protobuf:"bytes,28,opt,name=infra_external_network,json=infraExternalNetwork,proto3" json:"infra_external_network,omitempty"`
	// Flavor name on infra
	InfraFlavorName string `protobuf:"bytes,29,opt,name=infra_flavor_name,json=infraFlavorName,proto3" json:"infra_flavor_name,omitempty"`
	// Chef client key
	ChefClientKey string `protobuf:"bytes,30,opt,name=chef_client_key,json=chefClientKey,proto3" json:"chef_client_key,omitempty"`
}
...
func (*CloudletManifest) Descriptor() ([]byte, []int) { return fileDescriptorCloudlet, []int{6} }
...
func (*OSAZone) Descriptor() ([]byte, []int) { return fileDescriptorCloudlet, []int{8} }
...
func (*OSImage) Descriptor() ([]byte, []int) { return fileDescriptorCloudlet, []int{9} }
...
func init() {
	...
	proto.RegisterEnum("edgeproto.InfraAccessType", InfraAccessType_name, InfraAccessType_value)
...
type CloudletApiClient interface {
	...
	ShowCloudletManifest(ctx context.Context, in *Cloudlet, opts ...grpc.CallOption) (*CloudletManifest, error)
...
func (c *cloudletApiClient) ShowCloudletManifest(ctx context.Context, in *Cloudlet, opts ...grpc.CallOption) (*CloudletManifest, error) {
	out := new(CloudletManifest)
	err := grpc.Invoke(ctx, "/edgeproto.CloudletApi/ShowCloudletManifest", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CloudletApiServer interface {
	...
	// Get Cloudlet Manifest. Shows deployment manifest required to setup cloudlet
	ShowCloudletManifest(context.Context, *Cloudlet) (*CloudletManifest, error)
	// Add Optional Resource tag table
...
func _CloudletApi_ShowCloudletManifest_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Cloudlet)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CloudletApiServer).ShowCloudletManifest(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/edgeproto.CloudletApi/ShowCloudletManifest",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CloudletApiServer).ShowCloudletManifest(ctx, req.(*Cloudlet))
	}
...
var _CloudletApi_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "ShowCloudletManifest",
			Handler:    _CloudletApi_ShowCloudletManifest_Handler,
		},
		{
...
func (m *Cloudlet) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.InfraAccessType != 0 {
		dAtA[i] = 0xd0
		i++
		dAtA[i] = 0x1
		i++
		i = encodeVarintCloudlet(dAtA, i, uint64(m.InfraAccessType))
	}
	if m.DeploymentType != 0 {
		...
		dAtA[i] = 0x1
		i++
		i = encodeVarintCloudlet(dAtA, i, uint64(m.DeploymentType))
	}
	if len(m.InfraExternalNetwork) > 0 {
		dAtA[i] = 0xe2
		i++
		dAtA[i] = 0x1
		i++
		i = encodeVarintCloudlet(dAtA, i, uint64(len(m.InfraExternalNetwork)))
		i += copy(dAtA[i:], m.InfraExternalNetwork)
	}
	if len(m.InfraFlavorName) > 0 {
		dAtA[i] = 0xea
		i++
		dAtA[i] = 0x1
		i++
		i = encodeVarintCloudlet(dAtA, i, uint64(len(m.InfraFlavorName)))
		i += copy(dAtA[i:], m.InfraFlavorName)
	}
	if len(m.ChefClientKey) > 0 {
		...
		dAtA[i] = 0x1
		i++
		i = encodeVarintCloudlet(dAtA, i, uint64(len(m.ChefClientKey)))
		i += copy(dAtA[i:], m.ChefClientKey)
	}
	return i, nil
}
...
func (m *Cloudlet) Matches(o *Cloudlet, fopts ...MatchOpt) bool {
	...
	if !opts.Filter || o.InfraAccessType != 0 {
		if o.InfraAccessType != m.InfraAccessType {
			return false
		}
	}
	if !opts.Filter || o.DeploymentType != 0 {
		if o.DeploymentType != m.DeploymentType {
			return false
		}
	}
	if !opts.Filter || o.InfraExternalNetwork != "" {
		if o.InfraExternalNetwork != m.InfraExternalNetwork {
			return false
		}
	}
	if !opts.Filter || o.InfraFlavorName != "" {
		if o.InfraFlavorName != m.InfraFlavorName {
			return false
		}
	}
	if !opts.IgnoreBackend {
		if !opts.Filter || o.ChefClientKey != "" {
			if o.ChefClientKey != m.ChefClientKey {
				return false
			}
		}
	}
...
const CloudletFieldConfigChefServerPath = "21.16"
const CloudletFieldConfigChefClientInterval = "21.17"
...
const CloudletFieldInfraAccessType = "26"
const CloudletFieldDeploymentType = "27"
const CloudletFieldInfraExternalNetwork = "28"
const CloudletFieldInfraFlavorName = "29"
const CloudletFieldChefClientKey = "30"
...
var CloudletAllFields = []string{
	...
	CloudletFieldInfraAccessType,
	CloudletFieldDeploymentType,
	CloudletFieldInfraExternalNetwork,
	CloudletFieldInfraFlavorName,
	CloudletFieldChefClientKey,
}
...
var CloudletAllFieldsMap = map[string]struct{}{
	...
	CloudletFieldInfraAccessType:                    struct{}{},
	CloudletFieldDeploymentType:                     struct{}{},
	CloudletFieldInfraExternalNetwork:               struct{}{},
	CloudletFieldInfraFlavorName:                    struct{}{},
	CloudletFieldChefClientKey:                      struct{}{},
}
...
var CloudletAllFieldsStringMap = map[string]string{
	...
	CloudletFieldInfraAccessType:                    "Infra Access Type",
	CloudletFieldDeploymentType:                     "Deployment Type",
	CloudletFieldInfraExternalNetwork:               "Infra External Network",
	CloudletFieldInfraFlavorName:                    "Infra Flavor Name",
	CloudletFieldChefClientKey:                      "Chef Client Key",
}
...
func (m *Cloudlet) DiffFields(o *Cloudlet, fields map[string]struct{}) {
	...
	if m.InfraAccessType != o.InfraAccessType {
		fields[CloudletFieldInfraAccessType] = struct{}{}
	}
	if m.DeploymentType != o.DeploymentType {
		fields[CloudletFieldDeploymentType] = struct{}{}
	}
	if m.InfraExternalNetwork != o.InfraExternalNetwork {
		fields[CloudletFieldInfraExternalNetwork] = struct{}{}
	}
	if m.InfraFlavorName != o.InfraFlavorName {
		fields[CloudletFieldInfraFlavorName] = struct{}{}
	}
	if m.ChefClientKey != o.ChefClientKey {
...
func (m *Cloudlet) CopyInFields(src *Cloudlet) int {
	...
	if _, set := fmap["26"]; set {
		if m.InfraAccessType != src.InfraAccessType {
			m.InfraAccessType = src.InfraAccessType
			changed++
		}
	}
	if _, set := fmap["27"]; set {
		if m.DeploymentType != src.DeploymentType {
			m.DeploymentType = src.DeploymentType
			changed++
		}
	}
	if _, set := fmap["28"]; set {
		if m.InfraExternalNetwork != src.InfraExternalNetwork {
			m.InfraExternalNetwork = src.InfraExternalNetwork
			changed++
		}
	}
	if _, set := fmap["29"]; set {
		if m.InfraFlavorName != src.InfraFlavorName {
			m.InfraFlavorName = src.InfraFlavorName
			changed++
		}
	}
	if _, set := fmap["30"]; set {
		if m.ChefClientKey != src.ChefClientKey {
			m.ChefClientKey = src.ChefClientKey
			changed++
		}
	}
	return changed
...
func (m *Cloudlet) ValidateEnums() error {
	...
	if _, ok := InfraAccessType_name[int32(m.InfraAccessType)]; !ok {
		return errors.New("invalid InfraAccessType")
	}
	if _, ok := DeploymentType_name[int32(m.DeploymentType)]; !ok {
		return errors.New("invalid DeploymentType")
	}
	return nil
}
...
var InfraAccessTypeStrings = []string{
	"ACCESS_TYPE_PUBLIC",
	"ACCESS_TYPE_PRIVATE",
}

const (
	InfraAccessTypeACCESS_TYPE_PUBLIC  uint64 = 1 << 0
	InfraAccessTypeACCESS_TYPE_PRIVATE uint64 = 1 << 1
)

var InfraAccessType_CamelName = map[int32]string{
	// ACCESS_TYPE_PUBLIC -> AccessTypePublic
	0: "AccessTypePublic",
	// ACCESS_TYPE_PRIVATE -> AccessTypePrivate
	1: "AccessTypePrivate",
}
var InfraAccessType_CamelValue = map[string]int32{
	"AccessTypePublic":  0,
	"AccessTypePrivate": 1,
}

func (e *InfraAccessType) UnmarshalYAML(unmarshal func(interface{}) error) error {
	var str string
	err := unmarshal(&str)
	if err != nil {
		return err
	}
	val, ok := InfraAccessType_CamelValue[util.CamelCase(str)]
	if !ok {
		// may be enum value instead of string
		ival, err := strconv.Atoi(str)
		val = int32(ival)
		if err == nil {
			_, ok = InfraAccessType_CamelName[val]
		}
	}
	if !ok {
		return errors.New(fmt.Sprintf("No enum value for %s", str))
	}
	*e = InfraAccessType(val)
	return nil
}

func (e InfraAccessType) MarshalYAML() (interface{}, error) {
	return proto.EnumName(InfraAccessType_CamelName, int32(e)), nil
}

// custom JSON encoding/decoding
func (e *InfraAccessType) UnmarshalJSON(b []byte) error {
	var str string
	err := json.Unmarshal(b, &str)
	if err == nil {
		val, ok := InfraAccessType_CamelValue[util.CamelCase(str)]
...
var DeploymentTypeStrings = []string{
	"DEPLOYMENT_TYPE_DOCKER",
	"DEPLOYMENT_TYPE_K8S",
}

const (
	DeploymentTypeDEPLOYMENT_TYPE_DOCKER uint64 = 1 << 0
	DeploymentTypeDEPLOYMENT_TYPE_K8S    uint64 = 1 << 1
)

var DeploymentType_CamelName = map[int32]string{
	// DEPLOYMENT_TYPE_DOCKER -> DeploymentTypeDocker
	0: "DeploymentTypeDocker",
	// DEPLOYMENT_TYPE_K8S -> DeploymentTypeK8S
	1: "DeploymentTypeK8S",
}
var DeploymentType_CamelValue = map[string]int32{
	"DeploymentTypeDocker": 0,
	"DeploymentTypeK8S":    1,
}
...
func (m *Cloudlet) Size() (n int) {
	...
	if m.InfraAccessType != 0 {
		n += 2 + sovCloudlet(uint64(m.InfraAccessType))
	}
	if m.DeploymentType != 0 {
		n += 2 + sovCloudlet(uint64(m.DeploymentType))
	}
	l = len(m.InfraExternalNetwork)
	if l > 0 {
		n += 2 + l + sovCloudlet(uint64(l))
	}
	l = len(m.InfraFlavorName)
	if l > 0 {
		n += 2 + l + sovCloudlet(uint64(l))
	}
	l = len(m.ChefClientKey)
	if l > 0 {
		n += 2 + l + sovCloudlet(uint64(l))
	}
	return n
...
func (m *Cloudlet) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 26:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field InfraAccessType", wireType)
			}
			m.InfraAccessType = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.InfraAccessType |= (InfraAccessType(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		...
		case 28:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field InfraExternalNetwork", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.InfraExternalNetwork = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 29:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field InfraFlavorName", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.InfraFlavorName = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 30:
			if wireType != 2 {
			...
			m.ChefClientKey = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipCloudlet(dAtA[iNdEx:])
...
var fileDescriptorCloudlet = []byte{
	...
	,
}
