...
type GPUDriverBuild struct {
	...
	OperatingSystem OSType `protobuf:"varint,3,opt,name=operating_system,json=operatingSystem,proto3,enum=edgeproto.OSType" json:"operating_system,omitempty"`
	...
	// Hypervisor supported by vGPU driver
...
type GPUConfig struct {
	...
	GpuType GPUType `protobuf:"varint,1,opt,name=gpu_type,json=gpuType,proto3,enum=edgeproto.GPUType" json:"gpu_type,omitempty"`
	// GPU driver to be used
...
type Cloudlet struct {
	...
	GpuConfig GPUConfig `protobuf:"bytes,42,opt,name=gpu_config,json=gpuConfig,proto3" json:"gpu_config"`
}
...
var fileDescriptor_3aea31a648a25d86 = []byte{
	...
	,
}
...
type GPUDriverApiClient interface {
	...
	CreateGPUDriver(ctx context.Context, in *GPUDriver, opts ...grpc.CallOption) (*Result, error)
	// Delete GPU Driver. Deletes GPU driver given that it is not
	// used by any cloudlet.
	DeleteGPUDriver(ctx context.Context, in *GPUDriver, opts ...grpc.CallOption) (*Result, error)
	// Update GPU Driver. Updates GPU driver config.
	UpdateGPUDriver(ctx context.Context, in *GPUDriver, opts ...grpc.CallOption) (*Result, error)
	...
	AddGPUDriverBuild(ctx context.Context, in *GPUDriverBuildMember, opts ...grpc.CallOption) (*Result, error)
	// Remove GPU Driver Build. Removes build from GPU driver.
	RemoveGPUDriverBuild(ctx context.Context, in *GPUDriverBuildMember, opts ...grpc.CallOption) (*Result, error)
	// Get GPU Driver Build URL. Returns a time-limited signed URL to download GPU driver.
	GetGPUDriverBuildURL(ctx context.Context, in *GPUDriverBuildMember, opts ...grpc.CallOption) (*Result, error)
}
...
func (c *gPUDriverApiClient) CreateGPUDriver(ctx context.Context, in *GPUDriver, opts ...grpc.CallOption) (*Result, error) {
	out := new(Result)
	err := c.cc.Invoke(ctx, "/edgeproto.GPUDriverApi/CreateGPUDriver", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gPUDriverApiClient) DeleteGPUDriver(ctx context.Context, in *GPUDriver, opts ...grpc.CallOption) (*Result, error) {
	out := new(Result)
	err := c.cc.Invoke(ctx, "/edgeproto.GPUDriverApi/DeleteGPUDriver", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gPUDriverApiClient) UpdateGPUDriver(ctx context.Context, in *GPUDriver, opts ...grpc.CallOption) (*Result, error) {
	out := new(Result)
	err := c.cc.Invoke(ctx, "/edgeproto.GPUDriverApi/UpdateGPUDriver", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gPUDriverApiClient) ShowGPUDriver(ctx context.Context, in *GPUDriver, opts ...grpc.CallOption) (GPUDriverApi_ShowGPUDriverClient, error) {
	stream, err := c.cc.NewStream(ctx, &_GPUDriverApi_serviceDesc.Streams[0], "/edgeproto.GPUDriverApi/ShowGPUDriver", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *gPUDriverApiClient) AddGPUDriverBuild(ctx context.Context, in *GPUDriverBuildMember, opts ...grpc.CallOption) (*Result, error) {
	out := new(Result)
	err := c.cc.Invoke(ctx, "/edgeproto.GPUDriverApi/AddGPUDriverBuild", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gPUDriverApiClient) RemoveGPUDriverBuild(ctx context.Context, in *GPUDriverBuildMember, opts ...grpc.CallOption) (*Result, error) {
	out := new(Result)
	err := c.cc.Invoke(ctx, "/edgeproto.GPUDriverApi/RemoveGPUDriverBuild", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gPUDriverApiClient) GetGPUDriverBuildURL(ctx context.Context, in *GPUDriverBuildMember, opts ...grpc.CallOption) (*Result, error) {
	out := new(Result)
...
type GPUDriverApiServer interface {
	// Create GPU Driver. Creates GPU driver with all the config
	// required to install it.
	CreateGPUDriver(context.Context, *GPUDriver) (*Result, error)
	// Delete GPU Driver. Deletes GPU driver given that it is not
	// used by any cloudlet.
	DeleteGPUDriver(context.Context, *GPUDriver) (*Result, error)
	// Update GPU Driver. Updates GPU driver config.
	UpdateGPUDriver(context.Context, *GPUDriver) (*Result, error)
	// Show GPU Drivers. Lists all the MobiledgeX created GPU drivers and operator
	// created GPU drivers.
	ShowGPUDriver(*GPUDriver, GPUDriverApi_ShowGPUDriverServer) error
	// Add GPU Driver Build. Adds new build to GPU driver.
	AddGPUDriverBuild(context.Context, *GPUDriverBuildMember) (*Result, error)
	// Remove GPU Driver Build. Removes build from GPU driver.
	RemoveGPUDriverBuild(context.Context, *GPUDriverBuildMember) (*Result, error)
	// Get GPU Driver Build URL. Returns a time-limited signed URL to download GPU driver.
	GetGPUDriverBuildURL(context.Context, *GPUDriverBuildMember) (*Result, error)
}
...
func (*UnimplementedGPUDriverApiServer) CreateGPUDriver(ctx context.Context, req *GPUDriver) (*Result, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateGPUDriver not implemented")
}
func (*UnimplementedGPUDriverApiServer) DeleteGPUDriver(ctx context.Context, req *GPUDriver) (*Result, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeleteGPUDriver not implemented")
}
func (*UnimplementedGPUDriverApiServer) UpdateGPUDriver(ctx context.Context, req *GPUDriver) (*Result, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateGPUDriver not implemented")
}
...
func (*UnimplementedGPUDriverApiServer) AddGPUDriverBuild(ctx context.Context, req *GPUDriverBuildMember) (*Result, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AddGPUDriverBuild not implemented")
}
func (*UnimplementedGPUDriverApiServer) RemoveGPUDriverBuild(ctx context.Context, req *GPUDriverBuildMember) (*Result, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RemoveGPUDriverBuild not implemented")
}
func (*UnimplementedGPUDriverApiServer) GetGPUDriverBuildURL(ctx context.Context, req *GPUDriverBuildMember) (*Result, error) {
...
func _GPUDriverApi_CreateGPUDriver_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GPUDriver)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GPUDriverApiServer).CreateGPUDriver(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/edgeproto.GPUDriverApi/CreateGPUDriver",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GPUDriverApiServer).CreateGPUDriver(ctx, req.(*GPUDriver))
	}
	return interceptor(ctx, in, info, handler)
}

func _GPUDriverApi_DeleteGPUDriver_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GPUDriver)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GPUDriverApiServer).DeleteGPUDriver(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/edgeproto.GPUDriverApi/DeleteGPUDriver",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GPUDriverApiServer).DeleteGPUDriver(ctx, req.(*GPUDriver))
	}
	return interceptor(ctx, in, info, handler)
}

func _GPUDriverApi_UpdateGPUDriver_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GPUDriver)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GPUDriverApiServer).UpdateGPUDriver(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/edgeproto.GPUDriverApi/UpdateGPUDriver",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GPUDriverApiServer).UpdateGPUDriver(ctx, req.(*GPUDriver))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _GPUDriverApi_AddGPUDriverBuild_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GPUDriverBuildMember)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GPUDriverApiServer).AddGPUDriverBuild(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/edgeproto.GPUDriverApi/AddGPUDriverBuild",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GPUDriverApiServer).AddGPUDriverBuild(ctx, req.(*GPUDriverBuildMember))
	}
	return interceptor(ctx, in, info, handler)
}

func _GPUDriverApi_RemoveGPUDriverBuild_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GPUDriverBuildMember)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GPUDriverApiServer).RemoveGPUDriverBuild(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/edgeproto.GPUDriverApi/RemoveGPUDriverBuild",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GPUDriverApiServer).RemoveGPUDriverBuild(ctx, req.(*GPUDriverBuildMember))
	}
	return interceptor(ctx, in, info, handler)
}
...
func (m *GPUDriverBuild) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Hypervisor) > 0 {
		...
		i = encodeVarintCloudlet(dAtA, i, uint64(len(m.Hypervisor)))
		i--
		dAtA[i] = 0x2a
	}
...
func (m *GPUConfig) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.DriverName) > 0 {
		...
		i = encodeVarintCloudlet(dAtA, i, uint64(len(m.DriverName)))
		i--
		dAtA[i] = 0x12
	}
	if m.GpuType != 0 {
...
func (m *GPUDriverBuild) CopyInFields(src *GPUDriverBuild) int {
	...
	if m.Hypervisor != src.Hypervisor {
		m.Hypervisor = src.Hypervisor
		changed++
	}
	return changed
}
...
func (m *GPUDriverBuildMember) CopyInFields(src *GPUDriverBuildMember) int {
	...
	if m.Build.Hypervisor != src.Build.Hypervisor {
		m.Build.Hypervisor = src.Build.Hypervisor
		changed++
	}
	return changed
}
...
const GPUDriverFieldKeyType = "2.3"
const GPUDriverFieldBuilds = "3"
const GPUDriverFieldBuildsName = "3.1"
const GPUDriverFieldBuildsDriverPath = "3.2"
const GPUDriverFieldBuildsOperatingSystem = "3.3"
const GPUDriverFieldBuildsKernelVersion = "3.4"
const GPUDriverFieldBuildsHypervisor = "3.5"
const GPUDriverFieldLicenseConfig = "4"
const GPUDriverFieldProperties = "5"
const GPUDriverFieldPropertiesKey = "5.1"
const GPUDriverFieldPropertiesValue = "5.2"

var GPUDriverAllFields = []string{
	GPUDriverFieldKeyName,
	GPUDriverFieldKeyOrganization,
	GPUDriverFieldKeyType,
	...
	GPUDriverFieldBuildsHypervisor,
...
var GPUDriverAllFieldsMap = map[string]struct{}{
	...
	GPUDriverFieldBuildsHypervisor:      struct{}{},
...
var GPUDriverAllFieldsStringMap = map[string]string{
	...
	GPUDriverFieldKeyType:               "Key Type",
	...
	GPUDriverFieldBuildsHypervisor:      "Builds Hypervisor",
...
func (m *GPUDriver) DiffFields(o *GPUDriver, fields map[string]struct{}) {
	...
	if m.Key.Type != o.Key.Type {
		fields[GPUDriverFieldKeyType] = struct{}{}
		fields[GPUDriverFieldKey] = struct{}{}
	}
	if len(m.Builds) != len(o.Builds) {
		...
		for i0 := 0; i0 < len(m.Builds); i0++ {
			...
			if m.Builds[i0].Hypervisor != o.Builds[i0].Hypervisor {
				fields[GPUDriverFieldBuildsHypervisor] = struct{}{}
				fields[GPUDriverFieldBuilds] = struct{}{}
			}
		}
	}
...
func (m *GPUConfig) CopyInFields(src *GPUConfig) int {
	...
	if m.DriverName != src.DriverName {
		m.DriverName = src.DriverName
		changed++
	}
	if src.Properties != nil {
		m.Properties = make(map[string]string)
...
const CloudletFieldGpuConfig = "42"
const CloudletFieldGpuConfigGpuType = "42.1"
const CloudletFieldGpuConfigDriverName = "42.2"
const CloudletFieldGpuConfigProperties = "42.3"
const CloudletFieldGpuConfigPropertiesKey = "42.3.1"
const CloudletFieldGpuConfigPropertiesValue = "42.3.2"
...
func (m *Cloudlet) DiffFields(o *Cloudlet, fields map[string]struct{}) {
	...
	if m.GpuConfig.DriverName != o.GpuConfig.DriverName {
...
func (m *Cloudlet) CopyInFields(src *Cloudlet) int {
	...
	if _, set := fmap["42"]; set {
		if _, set := fmap["42.1"]; set {
			if m.GpuConfig.GpuType != src.GpuConfig.GpuType {
				m.GpuConfig.GpuType = src.GpuConfig.GpuType
				changed++
			}
		}
		if _, set := fmap["42.2"]; set {
			if m.GpuConfig.DriverName != src.GpuConfig.DriverName {
				m.GpuConfig.DriverName = src.GpuConfig.DriverName
				changed++
			}
		}
		if _, set := fmap["42.3"]; set {
...
func (m *GPUDriverBuildMember) IsValidArgsForRemoveGPUDriverBuild() error {
	...
	if m.Build.Hypervisor != "" {
		return fmt.Errorf("Invalid field specified: Build.Hypervisor, this field is only for internal use")
	}
	return nil
}
