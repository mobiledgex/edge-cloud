...
type Cloudlet struct {
	...
	// Comma separated list of env variables i.e. key1=val1,key2=val2
	EnvVars map[string]string `protobuf:"bytes,19,rep,name=env_vars,json=envVars" json:"env_vars,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (m *Cloudlet) Matches(o *Cloudlet, fopts ...MatchOpt) bool {
	...
	if !opts.Filter || o.EnvVars != nil {
		if m.EnvVars == nil && o.EnvVars != nil || m.EnvVars != nil && o.EnvVars == nil {
			return false
...
const CloudletFieldEnvVars = "19"
const CloudletFieldEnvVarsKey = "19.1"
const CloudletFieldEnvVarsValue = "19.2"
...
var CloudletAllFields = []string{
	...
	CloudletFieldEnvVarsKey,
	CloudletFieldEnvVarsValue,
}
...
var CloudletAllFieldsMap = map[string]struct{}{
	...
	CloudletFieldEnvVarsKey:                         struct{}{},
	CloudletFieldEnvVarsValue:                       struct{}{},
}
...
var CloudletAllFieldsStringMap = map[string]string{
	...
	CloudletFieldEnvVarsKey:                         "Cloudlet Field Env Vars Key",
	CloudletFieldEnvVarsValue:                       "Cloudlet Field Env Vars Value",
}
...
func (m *Cloudlet) DiffFields(o *Cloudlet, fields map[string]struct{}) {
	...
	if m.EnvVars != nil && o.EnvVars != nil {
		if len(m.EnvVars) != len(o.EnvVars) {
			fields[CloudletFieldEnvVars] = struct{}{}
		} else {
...
func (m *Cloudlet) CopyInFields(src *Cloudlet) {
	...
	if _, set := fmap["19"]; set && src.EnvVars != nil {
		m.EnvVars = make(map[string]string)
		for k0, _ := range src.EnvVars {
			m.EnvVars[k0] = src.EnvVars[k0]
		}
	}
}
...
var fileDescriptorCloudlet = []byte{
	...
	,
}
