...
type Cloudlet struct {
	...
	// Over container version from policy
	PolicyOverride bool `protobuf:"varint,31,opt,name=policy_override,json=policyOverride,proto3" json:"policy_override,omitempty"`
}
...
func (m *Cloudlet) Matches(o *Cloudlet, fopts ...MatchOpt) bool {
	...
	if !opts.Filter || o.PolicyOverride != false {
		if o.PolicyOverride != m.PolicyOverride {
			return false
		}
	}
	return true
...
const CloudletFieldPolicyOverride = "31"
...
var CloudletAllFieldsMap = map[string]struct{}{
	...
	CloudletFieldPolicyOverride:                     struct{}{},
}
...
var CloudletAllFieldsStringMap = map[string]string{
	...
	CloudletFieldPolicyOverride:                     "Policy Override",
}
...
func (m *Cloudlet) DiffFields(o *Cloudlet, fields map[string]struct{}) {
	...
	if m.PolicyOverride != o.PolicyOverride {
		fields[CloudletFieldPolicyOverride] = struct{}{}
	}
}
...
func (m *Cloudlet) CopyInFields(src *Cloudlet) int {
	...
	if _, set := fmap["31"]; set {
		if m.PolicyOverride != src.PolicyOverride {
			m.PolicyOverride = src.PolicyOverride
			changed++
		}
	}
	return changed
...
func (m *Cloudlet) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 31:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field PolicyOverride", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
var fileDescriptorCloudlet = []byte{
	...
	,
}
