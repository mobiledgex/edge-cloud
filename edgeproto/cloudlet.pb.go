...
type Cloudlet struct {
	...
	// Number of k8s masters (Only valid for k8s deployment)
	NumMasters uint32 `protobuf:"varint,28,opt,name=num_masters,json=numMasters,proto3" json:"num_masters,omitempty"`
	// Number of k8s nodes (Only valid for k8s deployment)
	NumNodes uint32 `protobuf:"varint,29,opt,name=num_nodes,json=numNodes,proto3" json:"num_nodes,omitempty"`
	// External network name on infra
	InfraExternalNetwork string `protobuf:"bytes,30,opt,name=infra_external_network,json=infraExternalNetwork,proto3" json:"infra_external_network,omitempty"`
	// Flavor name on infra
	InfraFlavorName string `protobuf:"bytes,31,opt,name=infra_flavor_name,json=infraFlavorName,proto3" json:"infra_flavor_name,omitempty"`
}
...
type CloudletApiClient interface {
	...
	ShowCloudletManifest(ctx context.Context, in *Cloudlet, opts ...grpc.CallOption) (*Result, error)
...
func (c *cloudletApiClient) ShowCloudletManifest(ctx context.Context, in *Cloudlet, opts ...grpc.CallOption) (*Result, error) {
	out := new(Result)
...
type CloudletApiServer interface {
	...
	// Get Cloudlet Manifest. Shows deployment manifest required to setup cloudlet
	ShowCloudletManifest(context.Context, *Cloudlet) (*Result, error)
	// Add Optional Resource tag table
...
func (m *Cloudlet) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.NumMasters != 0 {
		...
		dAtA[i] = 0x1
		i++
		i = encodeVarintCloudlet(dAtA, i, uint64(m.NumMasters))
	}
	if m.NumNodes != 0 {
		dAtA[i] = 0xe8
		i++
		dAtA[i] = 0x1
		i++
		i = encodeVarintCloudlet(dAtA, i, uint64(m.NumNodes))
	}
...
const CloudletFieldNumMasters = "28"
const CloudletFieldNumNodes = "29"
const CloudletFieldInfraExternalNetwork = "30"
const CloudletFieldInfraFlavorName = "31"
...
var CloudletAllFields = []string{
	...
	CloudletFieldNumMasters,
	CloudletFieldNumNodes,
...
var CloudletAllFieldsMap = map[string]struct{}{
	...
	CloudletFieldNumMasters:                         struct{}{},
	CloudletFieldNumNodes:                           struct{}{},
...
var CloudletAllFieldsStringMap = map[string]string{
	...
	CloudletFieldNumMasters:                         "Num Masters",
	CloudletFieldNumNodes:                           "Num Nodes",
...
func (m *Cloudlet) DiffFields(o *Cloudlet, fields map[string]struct{}) {
	...
	if m.NumMasters != o.NumMasters {
		fields[CloudletFieldNumMasters] = struct{}{}
	}
	if m.NumNodes != o.NumNodes {
		fields[CloudletFieldNumNodes] = struct{}{}
	}
...
func (m *Cloudlet) Size() (n int) {
	...
	if m.NumMasters != 0 {
		n += 2 + sovCloudlet(uint64(m.NumMasters))
	}
	if m.NumNodes != 0 {
		n += 2 + sovCloudlet(uint64(m.NumNodes))
	}
...
var fileDescriptorCloudlet = []byte{
	...
	,
}
