...
type OpenStackProperties struct {
	...
	OSNetworkScheme string `protobuf:"bytes,5,opt,name=OS_network_scheme,json=OSNetworkScheme,proto3" json:"OS_network_scheme,omitempty"`
	// openrc env vars
	OpenRcVars map[string]string `protobuf:"bytes,6,rep,name=open_rc_vars,json=openRcVars" json:"open_rc_vars,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
var fileDescriptorCloudlet = []byte{
	...
	,
}
