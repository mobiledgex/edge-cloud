...
// SSH Key Pair
//
// Authentication key pair to SSH into Cloudlet VMs
...
func (m *AuthKeyPair) Reset()                    { *m = AuthKeyPair{} }
func (m *AuthKeyPair) String() string            { return proto.CompactTextString(m) }
func (*AuthKeyPair) ProtoMessage()               {}
func (*AuthKeyPair) Descriptor() ([]byte, []int) { return fileDescriptorCloudlet, []int{9} }
...
type Cloudlet struct {
	...
	// Cloudlet VM Auth Public Key
	AuthKey *AuthKeyPair `protobuf:"bytes,26,opt,name=auth_key,json=authKey" json:"auth_key,omitempty"`
}

func (m *Cloudlet) Reset()                    { *m = Cloudlet{} }
func (m *Cloudlet) String() string            { return proto.CompactTextString(m) }
func (*Cloudlet) ProtoMessage()               {}
func (*Cloudlet) Descriptor() ([]byte, []int) { return fileDescriptorCloudlet, []int{10} }
...
func (*FlavorMatch) Descriptor() ([]byte, []int) { return fileDescriptorCloudlet, []int{11} }
...
func (*FlavorInfo) Descriptor() ([]byte, []int) { return fileDescriptorCloudlet, []int{12} }
...
func (*OSAZone) Descriptor() ([]byte, []int) { return fileDescriptorCloudlet, []int{13} }
...
func (*OSImage) Descriptor() ([]byte, []int) { return fileDescriptorCloudlet, []int{14} }
...
func (*CloudletInfo) Descriptor() ([]byte, []int) { return fileDescriptorCloudlet, []int{15} }
...
func (*CloudletMetrics) Descriptor() ([]byte, []int) { return fileDescriptorCloudlet, []int{16} }
...
func init() {
	...
	proto.RegisterType((*AuthKeyPair)(nil), "edgeproto.AuthKeyPair")
...
func (m *CloudletInfraProperties) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.OpenstackProperties != nil {
		...
		n1, err := m.OpenstackProperties.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n1
	...
	if m.AzureProperties != nil {
		...
		n2, err := m.AzureProperties.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n2
	...
	if m.GcpProperties != nil {
		...
		n3, err := m.GcpProperties.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n3
...
func (m *AuthKeyPair) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *AuthKeyPair) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if len(m.PublicKey) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintCloudlet(dAtA, i, uint64(len(m.PublicKey)))
		i += copy(dAtA[i:], m.PublicKey)
	}
	if len(m.PrivateKey) > 0 {
		dAtA[i] = 0x12
		i++
		i = encodeVarintCloudlet(dAtA, i, uint64(len(m.PrivateKey)))
...
func (m *Cloudlet) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.AuthKey != nil {
		...
		dAtA[i] = 0x1
		i++
		i = encodeVarintCloudlet(dAtA, i, uint64(m.AuthKey.Size()))
		n12, err := m.AuthKey.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n12
...
func (m *AuthKeyPair) CopyInFields(src *AuthKeyPair) int {
	changed := 0
	if m.PublicKey != src.PublicKey {
		m.PublicKey = src.PublicKey
		changed++
	}
	if m.PrivateKey != src.PrivateKey {
		m.PrivateKey = src.PrivateKey
		changed++
	}
	return changed
}
...
// Helper method to check that enums have valid values
func (m *AuthKeyPair) ValidateEnums() error {
	return nil
}
...
func (m *Cloudlet) Matches(o *Cloudlet, fopts ...MatchOpt) bool {
	...
	if !opts.IgnoreBackend {
		if !opts.Filter || o.AuthKey != nil {
			if m.AuthKey == nil && o.AuthKey != nil || m.AuthKey != nil && o.AuthKey == nil {
				return false
			} else if m.AuthKey != nil && o.AuthKey != nil {
			}
		}
	}
	return true
...
const CloudletFieldAuthKey = "26"
const CloudletFieldAuthKeyPublicKey = "26.1"
const CloudletFieldAuthKeyPrivateKey = "26.2"
...
var CloudletAllFields = []string{
	...
	CloudletFieldAuthKeyPublicKey,
	CloudletFieldAuthKeyPrivateKey,
}
...
var CloudletAllFieldsMap = map[string]struct{}{
	...
	CloudletFieldAuthKeyPublicKey:                   struct{}{},
	CloudletFieldAuthKeyPrivateKey:                  struct{}{},
}
...
var CloudletAllFieldsStringMap = map[string]string{
	...
	CloudletFieldAuthKeyPublicKey:                   "Auth Key Public Key",
	CloudletFieldAuthKeyPrivateKey:                  "Auth Key Private Key",
}
...
func (m *Cloudlet) DiffFields(o *Cloudlet, fields map[string]struct{}) {
	...
	if m.AuthKey != nil && o.AuthKey != nil {
		if m.AuthKey.PublicKey != o.AuthKey.PublicKey {
			fields[CloudletFieldAuthKeyPublicKey] = struct{}{}
			fields[CloudletFieldAuthKey] = struct{}{}
		}
		if m.AuthKey.PrivateKey != o.AuthKey.PrivateKey {
			fields[CloudletFieldAuthKeyPrivateKey] = struct{}{}
			fields[CloudletFieldAuthKey] = struct{}{}
		}
	} else if (m.AuthKey != nil && o.AuthKey == nil) || (m.AuthKey == nil && o.AuthKey != nil) {
		fields[CloudletFieldAuthKey] = struct{}{}
	}
}
...
func (m *Cloudlet) CopyInFields(src *Cloudlet) int {
	...
	if _, set := fmap["26"]; set {
		if src.AuthKey != nil {
			m.AuthKey = &AuthKeyPair{}
			if _, set := fmap["26.1"]; set {
				if m.AuthKey.PublicKey != src.AuthKey.PublicKey {
					m.AuthKey.PublicKey = src.AuthKey.PublicKey
					changed++
				}
			}
			if _, set := fmap["26.2"]; set {
				if m.AuthKey.PrivateKey != src.AuthKey.PrivateKey {
					m.AuthKey.PrivateKey = src.AuthKey.PrivateKey
					changed++
				}
			}
		} else if m.AuthKey != nil {
			m.AuthKey = nil
			changed++
		}
	}
...
func (m *Cloudlet) ValidateEnums() error {
	...
	if err := m.AuthKey.ValidateEnums(); err != nil {
		return err
	}
	return nil
}
...
func (m *AuthKeyPair) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AuthKeyPair: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AuthKeyPair: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
var fileDescriptorCloudlet = []byte{
	...
	,
}
