...
type CloudletAccess struct {
	// Variables required to access cloudlet
	Vars string `protobuf:"bytes,1,opt,name=vars,proto3" json:"vars,omitempty"`
	// Optional CA Cert for HTTPs based verifications
	CaCert string `protobuf:"bytes,2,opt,name=ca_cert,json=caCert,proto3" json:"ca_cert,omitempty"`
}

func (m *CloudletAccess) Reset()                    { *m = CloudletAccess{} }
func (m *CloudletAccess) String() string            { return proto.CompactTextString(m) }
func (*CloudletAccess) ProtoMessage()               {}
func (*CloudletAccess) Descriptor() ([]byte, []int) { return fileDescriptorCloudlet, []int{9} }
...
type Cloudlet struct {
	...
	// Details required to access cloudlet
	AccessInfo *CloudletAccess `protobuf:"bytes,23,opt,name=access_info,json=accessInfo" json:"access_info,omitempty"`
}
...
func init() {
	...
	proto.RegisterType((*CloudletAccess)(nil), "edgeproto.CloudletAccess")
...
func (m *CloudletAccess) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *CloudletAccess) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if len(m.Vars) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintCloudlet(dAtA, i, uint64(len(m.Vars)))
		i += copy(dAtA[i:], m.Vars)
	}
	if len(m.CaCert) > 0 {
		dAtA[i] = 0x12
		i++
		i = encodeVarintCloudlet(dAtA, i, uint64(len(m.CaCert)))
...
func (m *Cloudlet) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.AccessInfo != nil {
		...
		dAtA[i] = 0x1
		i++
		i = encodeVarintCloudlet(dAtA, i, uint64(m.AccessInfo.Size()))
		n13, err := m.AccessInfo.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n13
...
func (m *CloudletAccess) CopyInFields(src *CloudletAccess) int {
	changed := 0
	if m.Vars != src.Vars {
		m.Vars = src.Vars
		changed++
	}
	if m.CaCert != src.CaCert {
		m.CaCert = src.CaCert
		changed++
	}
	return changed
...
// Helper method to check that enums have valid values
func (m *CloudletAccess) ValidateEnums() error {
	return nil
}
...
func (m *Cloudlet) Matches(o *Cloudlet, fopts ...MatchOpt) bool {
	...
	if !opts.Filter || o.AccessInfo != nil {
		if m.AccessInfo == nil && o.AccessInfo != nil || m.AccessInfo != nil && o.AccessInfo == nil {
			return false
		} else if m.AccessInfo != nil && o.AccessInfo != nil {
		}
	}
	return true
}
...
const CloudletFieldAccessInfo = "23"
const CloudletFieldAccessInfoVars = "23.1"
const CloudletFieldAccessInfoCaCert = "23.2"
...
var CloudletAllFields = []string{
	...
	CloudletFieldAccessInfoVars,
	CloudletFieldAccessInfoCaCert,
}
...
var CloudletAllFieldsMap = map[string]struct{}{
	...
	CloudletFieldAccessInfoVars:                     struct{}{},
	CloudletFieldAccessInfoCaCert:                   struct{}{},
}
...
var CloudletAllFieldsStringMap = map[string]string{
	...
	CloudletFieldAccessInfoVars:                     "Cloudlet Field Access Info Vars",
	CloudletFieldAccessInfoCaCert:                   "Cloudlet Field Access Info Ca Cert",
}
...
func (m *Cloudlet) DiffFields(o *Cloudlet, fields map[string]struct{}) {
	...
	if m.AccessInfo != nil && o.AccessInfo != nil {
		if m.AccessInfo.Vars != o.AccessInfo.Vars {
			fields[CloudletFieldAccessInfoVars] = struct{}{}
			fields[CloudletFieldAccessInfo] = struct{}{}
		}
		if m.AccessInfo.CaCert != o.AccessInfo.CaCert {
			fields[CloudletFieldAccessInfoCaCert] = struct{}{}
			fields[CloudletFieldAccessInfo] = struct{}{}
		}
	} else if (m.AccessInfo != nil && o.AccessInfo == nil) || (m.AccessInfo == nil && o.AccessInfo != nil) {
		fields[CloudletFieldAccessInfo] = struct{}{}
	}
}
...
func (m *Cloudlet) CopyInFields(src *Cloudlet) int {
	...
	if _, set := fmap["23"]; set {
		if src.AccessInfo != nil {
			m.AccessInfo = &CloudletAccess{}
			if _, set := fmap["23.1"]; set {
				if m.AccessInfo.Vars != src.AccessInfo.Vars {
					m.AccessInfo.Vars = src.AccessInfo.Vars
					changed++
				}
			}
			if _, set := fmap["23.2"]; set {
				if m.AccessInfo.CaCert != src.AccessInfo.CaCert {
					m.AccessInfo.CaCert = src.AccessInfo.CaCert
					changed++
				}
			}
		} else if m.AccessInfo != nil {
			m.AccessInfo = nil
			changed++
		}
	}
...
func (m *Cloudlet) ValidateEnums() error {
	...
	if err := m.AccessInfo.ValidateEnums(); err != nil {
		return err
	}
	return nil
}
...
func (m *CloudletAccess) Size() (n int) {
	var l int
	_ = l
	l = len(m.Vars)
	if l > 0 {
...
func (m *CloudletAccess) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CloudletAccess: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CloudletAccess: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.Vars = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
...
var fileDescriptorCloudlet = []byte{
	...
	,
}
