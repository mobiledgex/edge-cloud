...
// Flavor Type
//
// FlavorType is the type of flavor
//
// 0: `FLAVOR_TYPE_GENERAL`
// 1: `FLAVOR_TYPE_GPU`
...
type Flavor struct {
	...
	// Type of flavor
	Type FlavorType `protobuf:"varint,7,opt,name=type,proto3,enum=edgeproto.FlavorType" json:"type,omitempty"`
	// GPU Type of flavor
	GpuType GPUType `protobuf:"varint,8,opt,name=gpu_type,json=gpuType,proto3,enum=edgeproto.GPUType" json:"gpu_type,omitempty"`
...
func init() {
	proto.RegisterEnum("edgeproto.FlavorType", FlavorType_name, FlavorType_value)
...
var fileDescriptor_827a674ddbd1f38f = []byte{
	...
	,
}
...
func (m *Flavor) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.GpuType != 0 {
		i = encodeVarintFlavor(dAtA, i, uint64(m.GpuType))
		i--
		dAtA[i] = 0x40
	}
	if m.Type != 0 {
		i = encodeVarintFlavor(dAtA, i, uint64(m.Type))
		i--
		dAtA[i] = 0x38
	}
...
func (m *Flavor) Matches(o *Flavor, fopts ...MatchOpt) bool {
	...
	if !opts.Filter || o.GpuType != 0 {
		if o.GpuType != m.GpuType {
			return false
		}
	}
	return true
...
const FlavorFieldType = "7"
const FlavorFieldGpuType = "8"
...
var FlavorAllFieldsMap = map[string]struct{}{
	...
	FlavorFieldType:           struct{}{},
	FlavorFieldGpuType:        struct{}{},
}
...
var FlavorAllFieldsStringMap = map[string]string{
	...
	FlavorFieldType:           "Type",
	FlavorFieldGpuType:        "Gpu Type",
}
...
func (m *Flavor) DiffFields(o *Flavor, fields map[string]struct{}) {
	...
	if m.Type != o.Type {
		fields[FlavorFieldType] = struct{}{}
	}
	if m.GpuType != o.GpuType {
		fields[FlavorFieldGpuType] = struct{}{}
	}
}
...
func (m *Flavor) ValidateEnums() error {
	...
	if _, ok := FlavorType_name[int32(m.Type)]; !ok {
...
var FlavorTypeStrings = []string{
	"FLAVOR_TYPE_GENERAL",
	"FLAVOR_TYPE_GPU",
}

const (
	FlavorTypeFLAVOR_TYPE_GENERAL uint64 = 1 << 0
	FlavorTypeFLAVOR_TYPE_GPU     uint64 = 1 << 1
)

var FlavorType_CamelName = map[int32]string{
	// FLAVOR_TYPE_GENERAL -> FlavorTypeGeneral
	0: "FlavorTypeGeneral",
	// FLAVOR_TYPE_GPU -> FlavorTypeGpu
	1: "FlavorTypeGpu",
}
var FlavorType_CamelValue = map[string]int32{
	"FlavorTypeGeneral": 0,
	"FlavorTypeGpu":     1,
}

func (e *FlavorType) UnmarshalYAML(unmarshal func(interface{}) error) error {
	var str string
	err := unmarshal(&str)
	if err != nil {
		return err
	}
	val, ok := FlavorType_CamelValue[util.CamelCase(str)]
	if !ok {
		// may be enum value instead of string
		ival, err := strconv.Atoi(str)
		val = int32(ival)
		if err == nil {
			_, ok = FlavorType_CamelName[val]
		}
	}
	if !ok {
...
func (e FlavorType) MarshalYAML() (interface{}, error) {
	return proto.EnumName(FlavorType_CamelName, int32(e)), nil
}

// custom JSON encoding/decoding
func (e *FlavorType) UnmarshalJSON(b []byte) error {
	var str string
...
func (m *Flavor) Size() (n int) {
	...
	if m.Type != 0 {
		n += 1 + sovFlavor(uint64(m.Type))
	}
	if m.GpuType != 0 {
		n += 1 + sovFlavor(uint64(m.GpuType))
	}
	return n
}
	...
	for iNdEx < l {
		...
		case 7:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Type |= FlavorType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
