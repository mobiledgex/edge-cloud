...
type Settings struct {
	...
	// Disable rate limiting for DME APIs (default is false)
	DisableDmeRateLimit bool `protobuf:"varint,34,opt,name=disable_dme_rate_limit,json=disableDmeRateLimit,proto3" json:"disable_dme_rate_limit,omitempty"`
	// Disable rate limiting for Controller APIs (default is true)
	DisableCtrlRateLimit bool `protobuf:"varint,35,opt,name=disable_ctrl_rate_limit,json=disableCtrlRateLimit,proto3" json:"disable_ctrl_rate_limit,omitempty"`
	// Maximum number of limiters... TODO...
	MaxNumRateLimiters int64 `protobuf:"varint,36,opt,name=max_num_rate_limiters,json=maxNumRateLimiters,proto3" json:"max_num_rate_limiters,omitempty"`
}
...
var fileDescriptor_6c7cab62fa432213 = []byte{
	...
	,
}
...
func (m *Settings) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.MaxNumRateLimiters != 0 {
		i = encodeVarintSettings(dAtA, i, uint64(m.MaxNumRateLimiters))
		i--
		dAtA[i] = 0x2
		i--
		dAtA[i] = 0xa0
	}
	if m.DisableCtrlRateLimit {
		i--
		if m.DisableCtrlRateLimit {
			dAtA[i] = 1
		} else {
...
func (m *Settings) Matches(o *Settings, fopts ...MatchOpt) bool {
	...
	if !opts.Filter || o.DisableDmeRateLimit != false {
		if o.DisableDmeRateLimit != m.DisableDmeRateLimit {
			return false
		}
	}
	if !opts.Filter || o.DisableCtrlRateLimit != false {
		if o.DisableCtrlRateLimit != m.DisableCtrlRateLimit {
			return false
		}
	}
	if !opts.Filter || o.MaxNumRateLimiters != 0 {
		if o.MaxNumRateLimiters != m.MaxNumRateLimiters {
			return false
		}
	}
	return true
...
const SettingsFieldDisableDmeRateLimit = "34"
const SettingsFieldDisableCtrlRateLimit = "35"
const SettingsFieldMaxNumRateLimiters = "36"
...
var SettingsAllFields = []string{
	...
	SettingsFieldDisableDmeRateLimit,
	SettingsFieldDisableCtrlRateLimit,
	SettingsFieldMaxNumRateLimiters,
}
...
var SettingsAllFieldsMap = map[string]struct{}{
	...
	SettingsFieldDisableDmeRateLimit:                                           struct{}{},
	SettingsFieldDisableCtrlRateLimit:                                          struct{}{},
	SettingsFieldMaxNumRateLimiters:                                            struct{}{},
}
...
var SettingsAllFieldsStringMap = map[string]string{
	...
	SettingsFieldDisableDmeRateLimit:                                           "Disable Dme Rate Limit",
	SettingsFieldDisableCtrlRateLimit:                                          "Disable Ctrl Rate Limit",
	SettingsFieldMaxNumRateLimiters:                                            "Max Num Rate Limiters",
}
...
func (m *Settings) DiffFields(o *Settings, fields map[string]struct{}) {
	...
	if m.DisableDmeRateLimit != o.DisableDmeRateLimit {
		fields[SettingsFieldDisableDmeRateLimit] = struct{}{}
	}
	if m.DisableCtrlRateLimit != o.DisableCtrlRateLimit {
		fields[SettingsFieldDisableCtrlRateLimit] = struct{}{}
	}
	if m.MaxNumRateLimiters != o.MaxNumRateLimiters {
		fields[SettingsFieldMaxNumRateLimiters] = struct{}{}
	}
}
...
func (m *Settings) CopyInFields(src *Settings) int {
	...
	if _, set := fmap["34"]; set {
		if m.DisableDmeRateLimit != src.DisableDmeRateLimit {
			m.DisableDmeRateLimit = src.DisableDmeRateLimit
			changed++
		}
	}
	if _, set := fmap["35"]; set {
		if m.DisableCtrlRateLimit != src.DisableCtrlRateLimit {
			m.DisableCtrlRateLimit = src.DisableCtrlRateLimit
			changed++
		}
	}
	if _, set := fmap["36"]; set {
		if m.MaxNumRateLimiters != src.MaxNumRateLimiters {
			m.MaxNumRateLimiters = src.MaxNumRateLimiters
			changed++
		}
	}
	return changed
...
func (m *Settings) Size() (n int) {
	...
	if m.MaxNumRateLimiters != 0 {
		n += 2 + sovSettings(uint64(m.MaxNumRateLimiters))
	}
	return n
}
...
func (m *Settings) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 34:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field DisableDmeRateLimit", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.DisableDmeRateLimit = bool(v != 0)
		case 35:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field DisableCtrlRateLimit", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.DisableCtrlRateLimit = bool(v != 0)
		case 36:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field MaxNumRateLimiters", wireType)
			}
			m.MaxNumRateLimiters = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowSettings
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MaxNumRateLimiters |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
