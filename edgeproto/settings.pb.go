...
type Settings struct {
	...
	// Cloudlet resource info sync interval
	CloudletResourceSyncInterval Duration `protobuf:"varint,25,opt,name=cloudlet_resource_sync_interval,json=cloudletResourceSyncInterval,proto3,casttype=Duration" json:"cloudlet_resource_sync_interval,omitempty"`
	// Cloudlet resource alert threshold percentage
	CloudletResourceAlertThresholdPercentage int32 `protobuf:"varint,26,opt,name=cloudlet_resource_alert_threshold_percentage,json=cloudletResourceAlertThresholdPercentage,proto3" json:"cloudlet_resource_alert_threshold_percentage,omitempty"`
}
...
var fileDescriptor_6c7cab62fa432213 = []byte{
	...
	,
}
...
func (m *Settings) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.CloudletResourceAlertThresholdPercentage != 0 {
		i = encodeVarintSettings(dAtA, i, uint64(m.CloudletResourceAlertThresholdPercentage))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xd0
	}
	if m.CloudletResourceSyncInterval != 0 {
		i = encodeVarintSettings(dAtA, i, uint64(m.CloudletResourceSyncInterval))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xc8
...
func (m *Settings) Matches(o *Settings, fopts ...MatchOpt) bool {
	...
	if !opts.Filter || o.CloudletResourceSyncInterval != 0 {
		if o.CloudletResourceSyncInterval != m.CloudletResourceSyncInterval {
			return false
		}
	}
	if !opts.Filter || o.CloudletResourceAlertThresholdPercentage != 0 {
		if o.CloudletResourceAlertThresholdPercentage != m.CloudletResourceAlertThresholdPercentage {
			return false
		}
	}
	return true
...
const SettingsFieldCloudletResourceSyncInterval = "25"
const SettingsFieldCloudletResourceAlertThresholdPercentage = "26"
...
var SettingsAllFields = []string{
	...
	SettingsFieldCloudletResourceSyncInterval,
	SettingsFieldCloudletResourceAlertThresholdPercentage,
}
...
var SettingsAllFieldsMap = map[string]struct{}{
	...
	SettingsFieldCloudletResourceSyncInterval:                  struct{}{},
	SettingsFieldCloudletResourceAlertThresholdPercentage:      struct{}{},
}
...
var SettingsAllFieldsStringMap = map[string]string{
	...
	SettingsFieldCloudletResourceSyncInterval:                  "Cloudlet Resource Sync Interval",
	SettingsFieldCloudletResourceAlertThresholdPercentage:      "Cloudlet Resource Alert Threshold Percentage",
}
...
func (m *Settings) DiffFields(o *Settings, fields map[string]struct{}) {
	...
	if m.CloudletResourceSyncInterval != o.CloudletResourceSyncInterval {
		fields[SettingsFieldCloudletResourceSyncInterval] = struct{}{}
	}
	if m.CloudletResourceAlertThresholdPercentage != o.CloudletResourceAlertThresholdPercentage {
		fields[SettingsFieldCloudletResourceAlertThresholdPercentage] = struct{}{}
	}
}
...
func (m *Settings) CopyInFields(src *Settings) int {
	...
	if _, set := fmap["25"]; set {
		if m.CloudletResourceSyncInterval != src.CloudletResourceSyncInterval {
			m.CloudletResourceSyncInterval = src.CloudletResourceSyncInterval
			changed++
		}
	}
	if _, set := fmap["26"]; set {
		if m.CloudletResourceAlertThresholdPercentage != src.CloudletResourceAlertThresholdPercentage {
			m.CloudletResourceAlertThresholdPercentage = src.CloudletResourceAlertThresholdPercentage
			changed++
		}
	}
	return changed
...
func (m *Settings) Size() (n int) {
	...
	if m.CloudletResourceSyncInterval != 0 {
		n += 2 + sovSettings(uint64(m.CloudletResourceSyncInterval))
	}
	if m.CloudletResourceAlertThresholdPercentage != 0 {
		n += 2 + sovSettings(uint64(m.CloudletResourceAlertThresholdPercentage))
	}
	return n
}
...
func (m *Settings) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 25:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field CloudletResourceSyncInterval", wireType)
			}
			m.CloudletResourceSyncInterval = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowSettings
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.CloudletResourceSyncInterval |= Duration(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 26:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field CloudletResourceAlertThresholdPercentage", wireType)
			}
			m.CloudletResourceAlertThresholdPercentage = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowSettings
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.CloudletResourceAlertThresholdPercentage |= int32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
