...
type Settings struct {
	...
	// Maximum number of perip rate limiters for an endpoint (ie. number of ips stored to rate limit)
	MaxNumPerIpRateLimiters int64 `protobuf:"varint,39,opt,name=max_num_per_ip_rate_limiters,json=maxNumPerIpRateLimiters,proto3" json:"max_num_per_ip_rate_limiters,omitempty"`
	// ResourceSnapshot Refresh thread run interval
	ResourceSnapshotThreadRefreshInterval Duration `protobuf:"varint,41,opt,name=resource_snapshot_thread_refresh_interval,json=resourceSnapshotThreadRefreshInterval,proto3,casttype=Duration" json:"resource_snapshot_thread_refresh_interval,omitempty"`
	// ResourceSnapshot Refresh Max update interval
	ResourceSnapshotMaxUpdateInterval Duration `protobuf:"varint,42,opt,name=resource_snapshot_max_update_interval,json=resourceSnapshotMaxUpdateInterval,proto3,casttype=Duration" json:"resource_snapshot_max_update_interval,omitempty"`
}
...
var fileDescriptor_6c7cab62fa432213 = []byte{
	...
	,
}
...
func (m *Settings) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.ResourceSnapshotMaxUpdateInterval != 0 {
		i = encodeVarintSettings(dAtA, i, uint64(m.ResourceSnapshotMaxUpdateInterval))
		i--
		dAtA[i] = 0x2
		i--
		dAtA[i] = 0xd0
	}
	if m.ResourceSnapshotThreadRefreshInterval != 0 {
		i = encodeVarintSettings(dAtA, i, uint64(m.ResourceSnapshotThreadRefreshInterval))
		i--
		dAtA[i] = 0x2
		i--
		dAtA[i] = 0xc8
	...
	if m.MaxNumPerIpRateLimiters != 0 {
		i = encodeVarintSettings(dAtA, i, uint64(m.MaxNumPerIpRateLimiters))
		i--
		dAtA[i] = 0x2
		i--
		dAtA[i] = 0xb8
...
func (m *Settings) Matches(o *Settings, fopts ...MatchOpt) bool {
	...
	if !opts.Filter || o.MaxNumPerIpRateLimiters != 0 {
		if o.MaxNumPerIpRateLimiters != m.MaxNumPerIpRateLimiters {
			return false
		}
	}
	...
	if !opts.Filter || o.ResourceSnapshotThreadRefreshInterval != 0 {
		if o.ResourceSnapshotThreadRefreshInterval != m.ResourceSnapshotThreadRefreshInterval {
			return false
		}
	}
	if !opts.Filter || o.ResourceSnapshotMaxUpdateInterval != 0 {
		if o.ResourceSnapshotMaxUpdateInterval != m.ResourceSnapshotMaxUpdateInterval {
			return false
		}
	}
	return true
...
const SettingsFieldMaxNumPerIpRateLimiters = "39"
const SettingsFieldShepherdMetricsScrapeInterval = "40"
const SettingsFieldResourceSnapshotThreadRefreshInterval = "41"
const SettingsFieldResourceSnapshotMaxUpdateInterval = "42"
...
var SettingsAllFields = []string{
	...
	SettingsFieldMaxNumPerIpRateLimiters,
	SettingsFieldShepherdMetricsScrapeInterval,
	SettingsFieldResourceSnapshotThreadRefreshInterval,
	SettingsFieldResourceSnapshotMaxUpdateInterval,
}
...
var SettingsAllFieldsMap = map[string]struct{}{
	...
	SettingsFieldMaxNumPerIpRateLimiters:                                       struct{}{},
	SettingsFieldShepherdMetricsScrapeInterval:                                 struct{}{},
	SettingsFieldResourceSnapshotThreadRefreshInterval:                         struct{}{},
	SettingsFieldResourceSnapshotMaxUpdateInterval:                             struct{}{},
}
...
var SettingsAllFieldsStringMap = map[string]string{
	...
	SettingsFieldMaxNumPerIpRateLimiters:                                       "Max Num Per Ip Rate Limiters",
	SettingsFieldShepherdMetricsScrapeInterval:                                 "Shepherd Metrics Scrape Interval",
	SettingsFieldResourceSnapshotThreadRefreshInterval:                         "Resource Snapshot Thread Refresh Interval",
	SettingsFieldResourceSnapshotMaxUpdateInterval:                             "Resource Snapshot Max Update Interval",
}
...
func (m *Settings) DiffFields(o *Settings, fields map[string]struct{}) {
	...
	if m.MaxNumPerIpRateLimiters != o.MaxNumPerIpRateLimiters {
		fields[SettingsFieldMaxNumPerIpRateLimiters] = struct{}{}
	}
	...
	if m.ResourceSnapshotThreadRefreshInterval != o.ResourceSnapshotThreadRefreshInterval {
		fields[SettingsFieldResourceSnapshotThreadRefreshInterval] = struct{}{}
	}
	if m.ResourceSnapshotMaxUpdateInterval != o.ResourceSnapshotMaxUpdateInterval {
		fields[SettingsFieldResourceSnapshotMaxUpdateInterval] = struct{}{}
	}
}
...
func (m *Settings) CopyInFields(src *Settings) int {
	...
	if _, set := fmap["39"]; set {
		if m.MaxNumPerIpRateLimiters != src.MaxNumPerIpRateLimiters {
			m.MaxNumPerIpRateLimiters = src.MaxNumPerIpRateLimiters
			changed++
		}
	}
	...
	if _, set := fmap["41"]; set {
		if m.ResourceSnapshotThreadRefreshInterval != src.ResourceSnapshotThreadRefreshInterval {
			m.ResourceSnapshotThreadRefreshInterval = src.ResourceSnapshotThreadRefreshInterval
			changed++
		}
	}
	if _, set := fmap["42"]; set {
		if m.ResourceSnapshotMaxUpdateInterval != src.ResourceSnapshotMaxUpdateInterval {
			m.ResourceSnapshotMaxUpdateInterval = src.ResourceSnapshotMaxUpdateInterval
			changed++
		}
	}
	return changed
...
func (m *Settings) Size() (n int) {
	...
	if m.MaxNumPerIpRateLimiters != 0 {
		n += 2 + sovSettings(uint64(m.MaxNumPerIpRateLimiters))
	}
	if m.ShepherdMetricsScrapeInterval != 0 {
		n += 2 + sovSettings(uint64(m.ShepherdMetricsScrapeInterval))
	}
	if m.ResourceSnapshotThreadRefreshInterval != 0 {
		n += 2 + sovSettings(uint64(m.ResourceSnapshotThreadRefreshInterval))
	}
	if m.ResourceSnapshotMaxUpdateInterval != 0 {
		n += 2 + sovSettings(uint64(m.ResourceSnapshotMaxUpdateInterval))
	}
	return n
}
...
func (m *Settings) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 39:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field MaxNumPerIpRateLimiters", wireType)
			}
			m.MaxNumPerIpRateLimiters = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowSettings
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MaxNumPerIpRateLimiters |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		...
		case 41:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ResourceSnapshotThreadRefreshInterval", wireType)
			}
			m.ResourceSnapshotThreadRefreshInterval = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowSettings
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ResourceSnapshotThreadRefreshInterval |= Duration(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 42:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ResourceSnapshotMaxUpdateInterval", wireType)
			}
			m.ResourceSnapshotMaxUpdateInterval = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowSettings
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ResourceSnapshotMaxUpdateInterval |= Duration(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
