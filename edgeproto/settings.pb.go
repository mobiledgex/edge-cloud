...
type Settings struct {
	...
	DmeApiMetricsCollectionInterval Duration `protobuf:"varint,22,opt,name=dme_api_metrics_collection_interval,json=dmeApiMetricsCollectionInterval,proto3,casttype=Duration" json:"dme_api_metrics_collection_interval,omitempty"`
	// Metrics collection interval for persistent connection (appinstlatency and gps locations) (duration)
	PersistentConnectionMetricsCollectionInterval Duration `protobuf:"varint,23,opt,name=persistent_connection_metrics_collection_interval,json=persistentConnectionMetricsCollectionInterval,proto3,casttype=Duration" json:"persistent_connection_metrics_collection_interval,omitempty"`
}
...
var fileDescriptor_6c7cab62fa432213 = []byte{
	...
	,
}
...
const SettingsFieldDmeApiMetricsCollectionInterval = "22"
const SettingsFieldPersistentConnectionMetricsCollectionInterval = "23"
