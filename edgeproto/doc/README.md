...
- [app.proto](#app.proto)
    ...
    - [DnsEntryType](#edgeproto.DnsEntryType)
...
| dns_entry_type | [DnsEntryType](#edgeproto.DnsEntryType) |  | DNS rec type |
...
<a name="edgeproto.DnsEntryType"></a>
...
| Name | Number | Description |
| ---- | ------ | ----------- |
| DnsEntryTypeUnknown | 0 | Invalid - default to TypeA |
| DnsEntryTypeARec | 1 | Host |
| DnsEntryTypeNone | 2 | None |
