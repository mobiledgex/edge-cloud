...
// Describes the type of port is being used, for rootLbPorts
type CloudletRefsPortProto int32

const (
	// Unknown protocol using this port number
	CloudletRefs_Proto_Unknown CloudletRefsPortProto = 0
	// TCP port
	CloudletRefs_Proto_TCP CloudletRefsPortProto = 1
	// UDP port
	CloudletRefs_Proto_UDP CloudletRefsPortProto = 2
	// Both TCP and UDP ports of this number are in use
	CloudletRefs_Proto_TCP_UDP CloudletRefsPortProto = 3
)

var CloudletRefsPortProto_name = map[int32]string{
	0: "Proto_Unknown",
	1: "Proto_TCP",
	2: "Proto_UDP",
	3: "Proto_TCP_UDP",
}
var CloudletRefsPortProto_value = map[string]int32{
	"Proto_Unknown": 0,
	"Proto_TCP":     1,
	"Proto_UDP":     2,
	"Proto_TCP_UDP": 3,
...
func (x CloudletRefsPortProto) String() string {
	return proto.EnumName(CloudletRefsPortProto_name, int32(x))
}
func (CloudletRefsPortProto) EnumDescriptor() ([]byte, []int) { return fileDescriptorRefs, []int{0, 0} }
...
type CloudletRefs struct {
	...
	// Used ports on root load balancer. Map key is public port, value is the protocol of the port.
	RootLbPorts map[int32]CloudletRefsPortProto `protobuf:"bytes,8,rep,name=root_lb_ports,json=rootLbPorts" json:"root_lb_ports,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3,enum=edgeproto.CloudletRefsPortProto"`
	// Used dynamic IPs
...
func init() {
	...
	proto.RegisterEnum("edgeproto.CloudletRefsPortProto", CloudletRefsPortProto_name, CloudletRefsPortProto_value)
}
...
func (m *CloudletRefs) CopyInFields(src *CloudletRefs) {
	...
	if src.RootLbPorts != nil {
		m.RootLbPorts = make(map[int32]CloudletRefsPortProto)
...
const (
	port_protoProto_Unknown uint64 = 1 << 0
	port_protoProto_TCP     uint64 = 1 << 1
	port_protoProto_UDP     uint64 = 1 << 2
	port_protoProto_TCP_UDP uint64 = 1 << 3
)

func (e *CloudletRefsPortProto) UnmarshalYAML(unmarshal func(interface{}) error) error {
	var str string
	err := unmarshal(&str)
	if err != nil {
		return err
	}
	val, ok := CloudletRefsPortProto_value[str]
	if !ok {
		// may be enum value instead of string
		ival, err := strconv.Atoi(str)
		val = int32(ival)
		if err == nil {
			_, ok = CloudletRefsPortProto_name[val]
		}
	}
	if !ok {
		return errors.New(fmt.Sprintf("No enum value for %s", str))
	}
	*e = CloudletRefsPortProto(val)
	return nil
}

func (e CloudletRefsPortProto) MarshalYAML() (interface{}, error) {
	return e.String(), nil
}
...
func (m *CloudletRefs) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			...
			var mapkey int32
			var mapvalue CloudletRefsPortProto
			for iNdEx < postIndex {
				entryPreIndex := iNdEx
				var wire uint64
				for shift := uint(0); ; shift += 7 {
				...
				if fieldNum == 1 {
					...
					for shift := uint(0); ; shift += 7 {
						...
						b := dAtA[iNdEx]
						iNdEx++
						mapvalue |= (CloudletRefsPortProto(b) & 0x7F) << shift
						if b < 0x80 {
							break
						}
					}
...
var fileDescriptorRefs = []byte{
	...
	,
}
