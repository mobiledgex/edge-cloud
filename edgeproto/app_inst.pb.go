...
type AppInst struct {
	...
	// status
	Status *StatusInfo `protobuf:"bytes,23,opt,name=status" json:"status,omitempty"`
}
...
type AppInstInfo struct {
	...
	Status *StatusInfo `protobuf:"bytes,7,opt,name=status" json:"status,omitempty"`
}
...
func (m *AppInst) Matches(o *AppInst, fopts ...MatchOpt) bool {
	...
	if !opts.IgnoreBackend {
		if !opts.Filter || o.Status != nil {
			if m.Status == nil && o.Status != nil || m.Status != nil && o.Status == nil {
				return false
			} else if m.Status != nil && o.Status != nil {
			}
		}
	}
	return true
...
func (m *AppInst) CopyInFields(src *AppInst) {
	...
	if _, set := fmap["23"]; set && src.Status != nil {
		m.Status = &StatusInfo{}
...
func (m *AppInstInfo) CopyInFields(src *AppInstInfo) {
	...
	if _, set := fmap["7"]; set && src.Status != nil {
		m.Status = &StatusInfo{}
...
var fileDescriptorAppInst = []byte{
	...
	,
}
