...
type AppInst struct {
	...
	// Force Appinst upgrade when UpdateAppInst is done if revision matches
	ForceUpgrade bool `protobuf:"varint,25,opt,name=force_upgrade,json=forceUpgrade,proto3" json:"force_upgrade,omitempty"`
}
...
func (m *AppInstRuntime) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.ConsoleUrl) > 0 {
		dAtA[i] = 0x12
		i++
		i = encodeVarintAppInst(dAtA, i, uint64(len(m.ConsoleUrl)))
...
func (m *AppInst) Matches(o *AppInst, fopts ...MatchOpt) bool {
	...
	if !opts.Filter || o.ForceUpgrade != false {
		if o.ForceUpgrade != m.ForceUpgrade {
			return false
		}
	}
	return true
...
const AppInstFieldRuntimeInfoConsoleUrl = "17.2"
...
const AppInstFieldForceUpgrade = "25"
...
var AppInstAllFields = []string{
	...
	AppInstFieldRuntimeInfoConsoleUrl,
...
var AppInstAllFieldsMap = map[string]struct{}{
	...
	AppInstFieldRuntimeInfoConsoleUrl:                       struct{}{},
	...
	AppInstFieldForceUpgrade:                                struct{}{},
}
...
var AppInstAllFieldsStringMap = map[string]string{
	...
	AppInstFieldForceUpgrade:                                "App Inst Field Force Upgrade",
}
...
func (m *AppInst) DiffFields(o *AppInst, fields map[string]struct{}) {
	...
	if m.RuntimeInfo.ConsoleUrl != o.RuntimeInfo.ConsoleUrl {
		fields[AppInstFieldRuntimeInfoConsoleUrl] = struct{}{}
		fields[AppInstFieldRuntimeInfo] = struct{}{}
	}
	...
	if m.ForceUpgrade != o.ForceUpgrade {
		fields[AppInstFieldForceUpgrade] = struct{}{}
	}
}
...
func (m *AppInst) CopyInFields(src *AppInst) {
	...
	if _, set := fmap["17"]; set {
		...
		if _, set := fmap["17.2"]; set {
			m.RuntimeInfo.ConsoleUrl = src.RuntimeInfo.ConsoleUrl
		}
	}
	...
	if _, set := fmap["25"]; set {
		m.ForceUpgrade = src.ForceUpgrade
	}
}
...
func IgnoreAppInstFields(taglist string) cmp.Option {
	...
	if _, found := tags["nocmp"]; found {
		names = append(names, "RuntimeInfo.ConsoleUrl")
	}
	if _, found := tags["timestamp"]; found {
		names = append(names, "CreatedAt")
	}
	if _, found := tags["nocmp"]; found {
		names = append(names, "ForceUpgrade")
	}
...
const AppInstInfoFieldRuntimeInfoConsoleUrl = "6.2"
...
var AppInstInfoAllFields = []string{
	...
	AppInstInfoFieldRuntimeInfoConsoleUrl,
...
var AppInstInfoAllFieldsMap = map[string]struct{}{
	...
	AppInstInfoFieldRuntimeInfoConsoleUrl:                       struct{}{},
...
func (m *AppInstInfo) DiffFields(o *AppInstInfo, fields map[string]struct{}) {
	...
	if m.RuntimeInfo.ConsoleUrl != o.RuntimeInfo.ConsoleUrl {
		fields[AppInstInfoFieldRuntimeInfoConsoleUrl] = struct{}{}
		fields[AppInstInfoFieldRuntimeInfo] = struct{}{}
	}
	if m.Status.TaskNumber != o.Status.TaskNumber {
...
func (m *AppInst) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 25:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ForceUpgrade", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
var fileDescriptorAppInst = []byte{
	...
	,
}
