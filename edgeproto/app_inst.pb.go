...
const (
	// Power On
	PowerState_POWER_ON PowerState = 0
	// Power Off
	PowerState_POWER_OFF PowerState = 1
	// Reboot
	PowerState_REBOOT PowerState = 2
)
...
type AppInstApiClient interface {
	...
	// Set Application Instance Power State. Sets power state of the Application Instance
	SetAppInstPowerState(ctx context.Context, in *AppInst, opts ...grpc.CallOption) (*Result, error)
}
...
func (c *appInstApiClient) SetAppInstPowerState(ctx context.Context, in *AppInst, opts ...grpc.CallOption) (*Result, error) {
	out := new(Result)
	err := grpc.Invoke(ctx, "/edgeproto.AppInstApi/SetAppInstPowerState", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AppInstApiServer interface {
	...
	// Set Application Instance Power State. Sets power state of the Application Instance
	SetAppInstPowerState(context.Context, *AppInst) (*Result, error)
}
...
func _AppInstApi_SetAppInstPowerState_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AppInst)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AppInstApiServer).SetAppInstPowerState(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/edgeproto.AppInstApi/SetAppInstPowerState",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AppInstApiServer).SetAppInstPowerState(ctx, req.(*AppInst))
	}
...
var _AppInstApi_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "SetAppInstPowerState",
			Handler:    _AppInstApi_SetAppInstPowerState_Handler,
		},
	},
...
const (
	PowerStatePOWER_ON  uint64 = 1 << 0
	PowerStatePOWER_OFF uint64 = 1 << 1
	PowerStateREBOOT    uint64 = 1 << 2
)
...
var fileDescriptorAppInst = []byte{
	...
	,
}
