...
// Power Action
//
// Power Action on the AppInst
type PowerAction int32

const (
	// None
	PowerAction_POWER_NONE PowerAction = 0
	// Power On
	PowerAction_POWER_ON PowerAction = 1
	// Power Off
	PowerAction_POWER_OFF PowerAction = 2
	// Reboot
	PowerAction_REBOOT PowerAction = 3
)

var PowerAction_name = map[int32]string{
	0: "POWER_NONE",
	1: "POWER_ON",
	2: "POWER_OFF",
	3: "REBOOT",
}
var PowerAction_value = map[string]int32{
	"POWER_NONE": 0,
	"POWER_ON":   1,
	"POWER_OFF":  2,
	"REBOOT":     3,
...
func (x PowerAction) String() string {
	return proto.EnumName(PowerAction_name, int32(x))
}
func (PowerAction) EnumDescriptor() ([]byte, []int) { return fileDescriptorAppInst, []int{1} }
...
type AppInst struct {
	...
	// Power Action on AppInst
	PowerAction PowerAction `protobuf:"varint,31,opt,name=power_action,json=powerAction,proto3,enum=edgeproto.PowerAction" json:"power_action,omitempty"`
}
...
func init() {
	...
	proto.RegisterEnum("edgeproto.PowerAction", PowerAction_name, PowerAction_value)
}
...
type AppInstApiClient interface {
	...
	// Set Application Instance. Performs action on Application Instance
	SetAppInst(ctx context.Context, in *AppInst, opts ...grpc.CallOption) (AppInstApi_SetAppInstClient, error)
}
...
func (c *appInstApiClient) SetAppInst(ctx context.Context, in *AppInst, opts ...grpc.CallOption) (AppInstApi_SetAppInstClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_AppInstApi_serviceDesc.Streams[5], c.cc, "/edgeproto.AppInstApi/SetAppInst", opts...)
	if err != nil {
		return nil, err
	}
	x := &appInstApiSetAppInstClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type AppInstApi_SetAppInstClient interface {
	Recv() (*Result, error)
	grpc.ClientStream
}

type appInstApiSetAppInstClient struct {
	grpc.ClientStream
}

func (x *appInstApiSetAppInstClient) Recv() (*Result, error) {
	m := new(Result)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
type AppInstApiServer interface {
	...
	// Set Application Instance. Performs action on Application Instance
	SetAppInst(*AppInst, AppInstApi_SetAppInstServer) error
}
...
func _AppInstApi_SetAppInst_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(AppInst)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(AppInstApiServer).SetAppInst(m, &appInstApiSetAppInstServer{stream})
}

type AppInstApi_SetAppInstServer interface {
	Send(*Result) error
	grpc.ServerStream
}

type appInstApiSetAppInstServer struct {
	grpc.ServerStream
}

func (x *appInstApiSetAppInstServer) Send(m *Result) error {
	return x.ServerStream.SendMsg(m)
}
...
var _AppInstApi_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "SetAppInst",
			Handler:       _AppInstApi_SetAppInst_Handler,
			ServerStreams: true,
		},
	},
...
func (m *AppInst) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.PowerAction != 0 {
		...
		dAtA[i] = 0x1
		i++
		i = encodeVarintAppInst(dAtA, i, uint64(m.PowerAction))
	}
	return i, nil
}
...
func (m *AppInst) Matches(o *AppInst, fopts ...MatchOpt) bool {
	...
	if !opts.Filter || o.PowerAction != 0 {
		if o.PowerAction != m.PowerAction {
			return false
		}
	}
	return true
...
const AppInstFieldPowerAction = "31"
...
var AppInstAllFieldsMap = map[string]struct{}{
	...
	AppInstFieldPowerAction:                                 struct{}{},
}
...
var AppInstAllFieldsStringMap = map[string]string{
	...
	AppInstFieldPowerAction:                                 "Power Action",
}
...
func (m *AppInst) DiffFields(o *AppInst, fields map[string]struct{}) {
	...
	if m.PowerAction != o.PowerAction {
		fields[AppInstFieldPowerAction] = struct{}{}
	}
}
...
func (m *AppInst) CopyInFields(src *AppInst) int {
	...
	if _, set := fmap["31"]; set {
		if m.PowerAction != src.PowerAction {
			m.PowerAction = src.PowerAction
			changed++
		}
	}
	return changed
...
func (m *AppInst) ValidateEnums() error {
	...
	if _, ok := PowerAction_name[int32(m.PowerAction)]; !ok {
		return errors.New("invalid PowerAction")
	}
	return nil
}
...
const (
	PowerActionPOWER_NONE uint64 = 1 << 0
	PowerActionPOWER_ON   uint64 = 1 << 1
	PowerActionPOWER_OFF  uint64 = 1 << 2
	PowerActionREBOOT     uint64 = 1 << 3
)

var PowerAction_CamelName = map[int32]string{
	// POWER_NONE -> PowerNone
	0: "PowerNone",
	// POWER_ON -> PowerOn
	1: "PowerOn",
	// POWER_OFF -> PowerOff
...
var PowerAction_CamelValue = map[string]int32{
	"PowerNone": 0,
	"PowerOn":   1,
	"PowerOff":  2,
	"Reboot":    3,
...
func (e *PowerAction) UnmarshalYAML(unmarshal func(interface{}) error) error {
	var str string
	err := unmarshal(&str)
	if err != nil {
		return err
	}
	val, ok := PowerAction_CamelValue[util.CamelCase(str)]
	if !ok {
		// may be enum value instead of string
		ival, err := strconv.Atoi(str)
		val = int32(ival)
		if err == nil {
			_, ok = PowerAction_CamelName[val]
		}
	}
	if !ok {
		return errors.New(fmt.Sprintf("No enum value for %s", str))
...
func (e PowerAction) MarshalYAML() (interface{}, error) {
	return proto.EnumName(PowerAction_CamelName, int32(e)), nil
}

// custom JSON encoding/decoding
func (e *PowerAction) UnmarshalJSON(b []byte) error {
	var str string
	err := json.Unmarshal(b, &str)
	if err == nil {
		val, ok := PowerAction_CamelValue[util.CamelCase(str)]
...
func (m *AppInst) Size() (n int) {
	...
	if m.PowerAction != 0 {
		n += 2 + sovAppInst(uint64(m.PowerAction))
	}
	return n
}
...
func (m *AppInst) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 31:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field PowerAction", wireType)
			}
			m.PowerAction = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.PowerAction |= (PowerAction(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorAppInst = []byte{
	...
	,
}
