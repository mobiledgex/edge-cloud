...
type AppInst struct {
	...
	AppTemplate string `protobuf:"bytes,18,opt,name=app_template,json=appTemplate,proto3" json:"app_template,omitempty"`
	// public key used in authentication
	AuthPublicKey string `protobuf:"bytes,19,opt,name=auth_public_key,json=authPublicKey,proto3" json:"auth_public_key,omitempty"`
}
...
func (m *AppInst) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.AppTemplate) > 0 {
		...
		dAtA[i] = 0x1
		i++
		i = encodeVarintAppInst(dAtA, i, uint64(len(m.AppTemplate)))
	...
	if len(m.AuthPublicKey) > 0 {
		...
		dAtA[i] = 0x1
		i++
		i = encodeVarintAppInst(dAtA, i, uint64(len(m.AuthPublicKey)))
...
const AppInstFieldAppTemplate = "18"
const AppInstFieldAuthPublicKey = "19"
...
var AppInstAllFields = []string{
	...
	AppInstFieldAppTemplate,
	AppInstFieldAuthPublicKey,
}
...
var AppInstAllFieldsMap = map[string]struct{}{
	...
	AppInstFieldAppTemplate:                              struct{}{},
	AppInstFieldAuthPublicKey:                            struct{}{},
}
...
func (m *AppInst) DiffFields(o *AppInst, fields map[string]struct{}) {
	...
	if m.AppTemplate != o.AppTemplate {
		fields[AppInstFieldAppTemplate] = struct{}{}
	}
	if m.AuthPublicKey != o.AuthPublicKey {
		fields[AppInstFieldAuthPublicKey] = struct{}{}
	}
}
...
var fileDescriptorAppInst = []byte{
	...
	,
}
