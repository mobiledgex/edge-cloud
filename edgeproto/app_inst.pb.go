...
const (
	...
	// Health Check is ok
	HealthCheck_HEALTH_CHECK_OK HealthCheck = 1
	// Health Check failure due to RootLB being offline
	HealthCheck_HEALTH_CHECK_FAIL_ROOTLB_OFFLINE HealthCheck = 2
	// Health Check failure due to Backend server being unavailable
	HealthCheck_HEALTH_CHECK_FAIL_SERVER_FAIL HealthCheck = 3
)

var HealthCheck_name = map[int32]string{
	0: "HEALTH_CHECK_UNKNOWN",
	1: "HEALTH_CHECK_OK",
	2: "HEALTH_CHECK_FAIL_ROOTLB_OFFLINE",
	3: "HEALTH_CHECK_FAIL_SERVER_FAIL",
}
var HealthCheck_value = map[string]int32{
	"HEALTH_CHECK_UNKNOWN":             0,
	"HEALTH_CHECK_OK":                  1,
	"HEALTH_CHECK_FAIL_ROOTLB_OFFLINE": 2,
	"HEALTH_CHECK_FAIL_SERVER_FAIL":    3,
}
...
const (
	...
	HealthCheckHEALTH_CHECK_OK                  uint64 = 1 << 1
	HealthCheckHEALTH_CHECK_FAIL_ROOTLB_OFFLINE uint64 = 1 << 2
	HealthCheckHEALTH_CHECK_FAIL_SERVER_FAIL    uint64 = 1 << 3
)
...
var fileDescriptorAppInst = []byte{
	...
	,
}
