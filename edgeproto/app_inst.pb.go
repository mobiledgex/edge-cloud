...
func (c *AppInstCache) Prune(validKeys map[AppInstKey]struct{}) {
	notify := make(map[AppInstKey]struct{})
	c.Mux.Lock()
	for key, _ := range c.Objs {
...
func (c *AppInstInfoCache) WaitForState(key *AppInstKey, targetState AppState, timeout time.Duration, send func(*Result) error) error {
	...
	case <-time.After(timeout):
		if c.Get(key, &info) && info.State == AppState_AppStateErrors {
...
var fileDescriptorAppInst = []byte{
	...
	,
}
