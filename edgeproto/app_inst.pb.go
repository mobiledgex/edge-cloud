...
type AppInstKey struct {
	...
	ClusterInstKey ClusterInstKey `protobuf:"bytes,2,opt,name=cluster_inst_key,json=clusterInstKey" json:"cluster_inst_key"`
}
...
func (m *AppInst) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Version != 0 {
		...
		dAtA[i] = 0x6
		i++
		i = encodeVarintAppInst(dAtA, i, uint64(m.Version))
	}
	return i, nil
}
...
const AppInstFieldKeyClusterInstKey = "2.2"
const AppInstFieldKeyClusterInstKeyClusterKey = "2.2.1"
const AppInstFieldKeyClusterInstKeyClusterKeyName = "2.2.1.1"
const AppInstFieldKeyClusterInstKeyCloudletKey = "2.2.2"
const AppInstFieldKeyClusterInstKeyCloudletKeyOperatorKey = "2.2.2.1"
const AppInstFieldKeyClusterInstKeyCloudletKeyOperatorKeyName = "2.2.2.1.1"
const AppInstFieldKeyClusterInstKeyCloudletKeyName = "2.2.2.2"
const AppInstFieldKeyClusterInstKeyDeveloper = "2.2.3"
...
func (m *AppInst) DiffFields(o *AppInst, fields map[string]struct{}) {
	...
	if m.Version != o.Version {
		fields[AppInstFieldVersion] = struct{}{}
	}
}
...
const AppInstInfoFieldKeyClusterInstKey = "2.2"
const AppInstInfoFieldKeyClusterInstKeyClusterKey = "2.2.1"
const AppInstInfoFieldKeyClusterInstKeyClusterKeyName = "2.2.1.1"
const AppInstInfoFieldKeyClusterInstKeyCloudletKey = "2.2.2"
const AppInstInfoFieldKeyClusterInstKeyCloudletKeyOperatorKey = "2.2.2.1"
const AppInstInfoFieldKeyClusterInstKeyCloudletKeyOperatorKeyName = "2.2.2.1.1"
const AppInstInfoFieldKeyClusterInstKeyCloudletKeyName = "2.2.2.2"
const AppInstInfoFieldKeyClusterInstKeyDeveloper = "2.2.3"
...
func (m *AppInst) Size() (n int) {
	...
	if m.Version != 0 {
		n += 2 + sovAppInst(uint64(m.Version))
	}
	return n
}
...
var fileDescriptorAppInst = []byte{
	...
	,
}
