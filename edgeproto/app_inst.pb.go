...
type AppInst struct {
	...
	// Prevent automatic creation of ClusterInst
	PreventAutoClusterInst bool `protobuf:"varint,19,opt,name=prevent_auto_cluster_inst,json=preventAutoClusterInst,proto3" json:"prevent_auto_cluster_inst,omitempty"`
}
...
func (m *AppInstStatus) Reset()                    { *m = AppInstStatus{} }
func (m *AppInstStatus) String() string            { return proto.CompactTextString(m) }
func (*AppInstStatus) ProtoMessage()               {}
func (*AppInstStatus) Descriptor() ([]byte, []int) { return fileDescriptorAppInst, []int{4} }
...
func init() {
	...
	proto.RegisterType((*AppInstStatus)(nil), "edgeproto.AppInstStatus")
}
...
func (m *AppInst) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Status) > 0 {
		...
		dAtA[i] = 0x1
		i++
		i = encodeVarintAppInst(dAtA, i, uint64(len(m.Status)))
		i += copy(dAtA[i:], m.Status)
	}
	if m.PreventAutoClusterInst {
		dAtA[i] = 0x98
		i++
		dAtA[i] = 0x1
		i++
...
func (m *AppInstStatus) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *AppInstStatus) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *AppInst) Matches(o *AppInst, fopts ...MatchOpt) bool {
	...
	if !opts.Filter || o.PreventAutoClusterInst != false {
		if o.PreventAutoClusterInst != m.PreventAutoClusterInst {
			return false
		}
	}
	return true
...
const AppInstFieldStatus = "18"
const AppInstFieldPreventAutoClusterInst = "19"
...
var AppInstAllFields = []string{
	...
	AppInstFieldStatus,
	AppInstFieldPreventAutoClusterInst,
}
...
var AppInstAllFieldsMap = map[string]struct{}{
	...
	AppInstFieldStatus:                                   struct{}{},
	AppInstFieldPreventAutoClusterInst:                   struct{}{},
}
...
func (m *AppInst) DiffFields(o *AppInst, fields map[string]struct{}) {
	...
	if m.PreventAutoClusterInst != o.PreventAutoClusterInst {
		fields[AppInstFieldPreventAutoClusterInst] = struct{}{}
	}
}
...
func (m *AppInst) CopyInFields(src *AppInst) {
	...
	if _, set := fmap["19"]; set {
		m.PreventAutoClusterInst = src.PreventAutoClusterInst
	}
}
...
const AppInstStatusFieldKey = "2"
const AppInstStatusFieldKeyAppKey = "2.1"
const AppInstStatusFieldKeyAppKeyDeveloperKey = "2.1.1"
const AppInstStatusFieldKeyAppKeyDeveloperKeyName = "2.1.1.2"
const AppInstStatusFieldKeyAppKeyName = "2.1.2"
const AppInstStatusFieldKeyAppKeyVersion = "2.1.3"
const AppInstStatusFieldKeyCloudletKey = "2.2"
const AppInstStatusFieldKeyCloudletKeyOperatorKey = "2.2.1"
const AppInstStatusFieldKeyCloudletKeyOperatorKeyName = "2.2.1.1"
const AppInstStatusFieldKeyCloudletKeyName = "2.2.2"
const AppInstStatusFieldKeyId = "2.3"
const AppInstStatusFieldStatus = "3"

var AppInstStatusAllFields = []string{
	AppInstStatusFieldKeyAppKeyDeveloperKeyName,
	AppInstStatusFieldKeyAppKeyName,
	AppInstStatusFieldKeyAppKeyVersion,
	AppInstStatusFieldKeyCloudletKeyOperatorKeyName,
	AppInstStatusFieldKeyCloudletKeyName,
	AppInstStatusFieldKeyId,
	AppInstStatusFieldStatus,
}

var AppInstStatusAllFieldsMap = map[string]struct{}{
	AppInstStatusFieldKeyAppKeyDeveloperKeyName:     struct{}{},
	AppInstStatusFieldKeyAppKeyName:                 struct{}{},
	AppInstStatusFieldKeyAppKeyVersion:              struct{}{},
	AppInstStatusFieldKeyCloudletKeyOperatorKeyName: struct{}{},
	AppInstStatusFieldKeyCloudletKeyName:            struct{}{},
	AppInstStatusFieldKeyId:                         struct{}{},
	AppInstStatusFieldStatus:                        struct{}{},
}

func (m *AppInstStatus) DiffFields(o *AppInstStatus, fields map[string]struct{}) {
	if m.Key.AppKey.DeveloperKey.Name != o.Key.AppKey.DeveloperKey.Name {
		fields[AppInstStatusFieldKeyAppKeyDeveloperKeyName] = struct{}{}
		fields[AppInstStatusFieldKeyAppKeyDeveloperKey] = struct{}{}
		fields[AppInstStatusFieldKeyAppKey] = struct{}{}
		fields[AppInstStatusFieldKey] = struct{}{}
	}
	if m.Key.AppKey.Name != o.Key.AppKey.Name {
		fields[AppInstStatusFieldKeyAppKeyName] = struct{}{}
		fields[AppInstStatusFieldKeyAppKey] = struct{}{}
		fields[AppInstStatusFieldKey] = struct{}{}
	}
	if m.Key.AppKey.Version != o.Key.AppKey.Version {
		fields[AppInstStatusFieldKeyAppKeyVersion] = struct{}{}
		fields[AppInstStatusFieldKeyAppKey] = struct{}{}
		fields[AppInstStatusFieldKey] = struct{}{}
	}
	if m.Key.CloudletKey.OperatorKey.Name != o.Key.CloudletKey.OperatorKey.Name {
		fields[AppInstStatusFieldKeyCloudletKeyOperatorKeyName] = struct{}{}
		fields[AppInstStatusFieldKeyCloudletKeyOperatorKey] = struct{}{}
		fields[AppInstStatusFieldKeyCloudletKey] = struct{}{}
		fields[AppInstStatusFieldKey] = struct{}{}
	}
	if m.Key.CloudletKey.Name != o.Key.CloudletKey.Name {
		fields[AppInstStatusFieldKeyCloudletKeyName] = struct{}{}
		fields[AppInstStatusFieldKeyCloudletKey] = struct{}{}
		fields[AppInstStatusFieldKey] = struct{}{}
	}
	if m.Key.Id != o.Key.Id {
		fields[AppInstStatusFieldKeyId] = struct{}{}
		fields[AppInstStatusFieldKey] = struct{}{}
	}
	if m.Status != o.Status {
		fields[AppInstStatusFieldStatus] = struct{}{}
	}
}

func (m *AppInstStatus) CopyInFields(src *AppInstStatus) {
	fmap := MakeFieldMap(src.Fields)
	if _, set := fmap["2"]; set {
		if _, set := fmap["2.1"]; set {
			if _, set := fmap["2.1.1"]; set {
...
type AppInstStatusMsgQueue struct {
	Objs []*AppInstStatus
	Mux  util.Mutex
}

func NewAppInstStatusMsgQueue() *AppInstStatusMsgQueue {
	q := AppInstStatusMsgQueue{}
	q.Init()
	return &q
}

func (s *AppInstStatusMsgQueue) Init() {
	s.Objs = make([]*AppInstStatus, 0)
}

func (s *AppInstStatusMsgQueue) Recv(msg *AppInstStatus) {
	s.Mux.Lock()
	defer s.Mux.Unlock()
	s.Objs = append(s.Objs, msg)
}

func (c *AppInstStatusMsgQueue) GetCount() int {
	c.Mux.Lock()
	defer c.Mux.Unlock()
	return len(c.Objs)
}

func (m *AppInstStatus) GetKey() objstore.ObjKey {
	return &m.Key
}

// Helper method to check that enums have valid values
// NOTE: ValidateEnums checks all Fields even if some are not set
func (m *AppInstStatus) ValidateEnums() error {
	if err := m.Key.ValidateEnums(); err != nil {
		return err
	}
	return nil
...
func (m *AppInstStatus) Size() (n int) {
	var l int
	_ = l
	if len(m.Fields) > 0 {
		for _, s := range m.Fields {
...
func (m *AppInst) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 19:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field PreventAutoClusterInst", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.PreventAutoClusterInst = bool(v != 0)
		default:
			iNdEx = preIndex
			skippy, err := skipAppInst(dAtA[iNdEx:])
			if err != nil {
...
func (m *AppInstStatus) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AppInstStatus: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AppInstStatus: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
var fileDescriptorAppInst = []byte{
	...
	,
}
