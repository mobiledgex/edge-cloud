...
type AppInst struct {
	...
	KubeTemplate string `protobuf:"bytes,18,opt,name=kube_template,json=kubeTemplate,proto3" json:"kube_template,omitempty"`
}
...
func (m *AppInst) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.KubeTemplate) > 0 {
		dAtA[i] = 0x92
		i++
		dAtA[i] = 0x1
		i++
		i = encodeVarintAppInst(dAtA, i, uint64(len(m.KubeTemplate)))
		i += copy(dAtA[i:], m.KubeTemplate)
	}
	return i, nil
}
...
func (m *AppInst) Matches(o *AppInst, fopts ...MatchOpt) bool {
	...
	if !opts.IgnoreBackend {
		if !opts.Filter || o.KubeTemplate != "" {
			if o.KubeTemplate != m.KubeTemplate {
				return false
			}
		}
	}
...
const AppInstFieldKubeTemplate = "18"
...
var AppInstAllFieldsMap = map[string]struct{}{
	...
	AppInstFieldKubeTemplate:                             struct{}{},
}
...
func (m *AppInst) DiffFields(o *AppInst, fields map[string]struct{}) {
	...
	if m.KubeTemplate != o.KubeTemplate {
		fields[AppInstFieldKubeTemplate] = struct{}{}
	}
}
...
func (m *AppInst) CopyInFields(src *AppInst) {
	...
	if _, set := fmap["18"]; set {
		m.KubeTemplate = src.KubeTemplate
	}
}
...
func (m *AppInst) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 18:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field KubeTemplate", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.KubeTemplate = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipAppInst(dAtA[iNdEx:])
...
var fileDescriptorAppInst = []byte{
	...
	,
}
