...
// RegisterFlavorApiHandler registers the http handlers for service FlavorApi to "mux".
// The handlers forward requests to the grpc endpoint over the given implementation of "FlavorApiClient".
...
var (
	pattern_FlavorApi_CreateFlavor_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"create", "flavor"}, ""))

	pattern_FlavorApi_DeleteFlavor_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"delete", "flavor"}, ""))

	pattern_FlavorApi_UpdateFlavor_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"update", "flavor"}, ""))

	pattern_FlavorApi_ShowFlavor_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"show", "flavor"}, ""))
)
