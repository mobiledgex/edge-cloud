...
type AppInstClient struct {
	...
	Timestamp google_protobuf1.Timestamp `protobuf:"bytes,4,opt,name=timestamp" json:"timestamp"`
...
const AppInstClientFieldTimestamp = "4"
const AppInstClientFieldTimestampSeconds = "4.1"
const AppInstClientFieldTimestampNanos = "4.2"
...
var AppInstClientAllFields = []string{
	...
	AppInstClientFieldTimestampSeconds,
	AppInstClientFieldTimestampNanos,
...
var AppInstClientAllFieldsMap = map[string]struct{}{
	...
	AppInstClientFieldTimestampSeconds:                                     struct{}{},
	AppInstClientFieldTimestampNanos:                                       struct{}{},
...
var AppInstClientAllFieldsStringMap = map[string]string{
	...
	AppInstClientFieldTimestampSeconds:                                     "Timestamp Seconds",
	AppInstClientFieldTimestampNanos:                                       "Timestamp Nanos",
...
func (m *AppInstClient) DiffFields(o *AppInstClient, fields map[string]struct{}) {
	...
	if m.Timestamp.Seconds != o.Timestamp.Seconds {
		fields[AppInstClientFieldTimestampSeconds] = struct{}{}
		fields[AppInstClientFieldTimestamp] = struct{}{}
	}
	if m.Timestamp.Nanos != o.Timestamp.Nanos {
		fields[AppInstClientFieldTimestampNanos] = struct{}{}
		fields[AppInstClientFieldTimestamp] = struct{}{}
	}
...
var fileDescriptorClient = []byte{
	...
	,
}
