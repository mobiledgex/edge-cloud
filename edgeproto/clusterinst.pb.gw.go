...
func request_ClusterInstApi_GetClusterInstGPUDriverLicenseConfig_0(ctx context.Context, marshaler runtime.Marshaler, client ClusterInstApiClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	msg, err := client.GetClusterInstGPUDriverLicenseConfig(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_ClusterInstApi_GetClusterInstGPUDriverLicenseConfig_0(ctx context.Context, marshaler runtime.Marshaler, server ClusterInstApiServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ClusterInstKey
	var metadata runtime.ServerMetadata
	...
	msg, err := server.GetClusterInstGPUDriverLicenseConfig(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterClusterInstApiHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ClusterInstApiServer) error {
	...
	mux.Handle("POST", pattern_ClusterInstApi_GetClusterInstGPUDriverLicenseConfig_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req)
		...
		resp, md, err := local_request_ClusterInstApi_GetClusterInstGPUDriverLicenseConfig_0(rctx, inboundMarshaler, server, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_ClusterInstApi_GetClusterInstGPUDriverLicenseConfig_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterClusterInstApiHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ClusterInstApiClient) error {
	...
	mux.Handle("POST", pattern_ClusterInstApi_GetClusterInstGPUDriverLicenseConfig_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_ClusterInstApi_GetClusterInstGPUDriverLicenseConfig_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_ClusterInstApi_GetClusterInstGPUDriverLicenseConfig_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"get", "clusterinst", "gpudriverlicenseconfig"}, "", runtime.AssumeColonVerbOpt(true)))
)
...
var (
	...
	forward_ClusterInstApi_GetClusterInstGPUDriverLicenseConfig_0 = runtime.ForwardResponseMessage
)
