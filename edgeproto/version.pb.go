...
const (
	...
	VersionHash_HASH_99349a696d0b5872542f81b4b0b4788e VersionHash = 31
)
...
var VersionHash_name = map[int32]string{
	...
	31: "HASH_99349a696d0b5872542f81b4b0b4788e",
}
...
var VersionHash_value = map[string]int32{
	...
	"HASH_99349a696d0b5872542f81b4b0b4788e": 31,
}
...
var fileDescriptor_7d2c07d79758f814 = []byte{
	...
	,
}
...
const (
	...
	VersionHashHASH_99349A696D0B5872542F81B4B0B4788E uint64 = 1 << 23
)
...
var VersionHash_CamelName = map[int32]string{
	...
	31: "Hash99349A696D0B5872542F81B4B0B4788E",
}
var VersionHash_CamelValue = map[string]int32{
	...
	"Hash99349A696D0B5872542F81B4B0B4788E": 31,
}
...
var versionHashString = "99349a696d0b5872542f81b4b0b4788e"
