...
const (
	...
	VersionHash_HASH_8ba148e0fa88ab06ce2885cb742791a6 VersionHash = 27
)
...
var VersionHash_name = map[int32]string{
	...
	27: "HASH_8ba148e0fa88ab06ce2885cb742791a6",
}
...
var VersionHash_value = map[string]int32{
	...
	"HASH_8ba148e0fa88ab06ce2885cb742791a6": 27,
}
...
var fileDescriptor_7d2c07d79758f814 = []byte{
	...
	,
}
var VersionHashStrings = []string{
	...
	"HASH_8ba148e0fa88ab06ce2885cb742791a6",
}
...
const (
	...
	VersionHashHASH_8Ba148E0Fa88Ab06Ce2885Cb742791A6 uint64 = 1 << 19
)
...
var VersionHash_CamelName = map[int32]string{
	...
	// HASH_8ba148e0fa88ab06ce2885cb742791a6 -> Hash8Ba148E0Fa88Ab06Ce2885Cb742791A6
	27: "Hash8Ba148E0Fa88Ab06Ce2885Cb742791A6",
}
var VersionHash_CamelValue = map[string]int32{
	...
	"Hash8Ba148E0Fa88Ab06Ce2885Cb742791A6": 27,
}
...
var versionHashString = "8ba148e0fa88ab06ce2885cb742791a6"
