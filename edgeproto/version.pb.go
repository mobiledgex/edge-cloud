...
const (
	...
	VersionHash_HASH_d4ca5418a77d22d968ce7a2afc549dfe VersionHash = 10
)
...
var VersionHash_name = map[int32]string{
	...
	10: "HASH_d4ca5418a77d22d968ce7a2afc549dfe",
}
var VersionHash_value = map[string]int32{
	...
	"HASH_d4ca5418a77d22d968ce7a2afc549dfe": 10,
}
...
const (
	...
	VersionHashHASHD4Ca5418A77D22D968Ce7A2Afc549Dfe  uint64 = 1 << 10
)
...
var VersionHash_CamelName = map[int32]string{
	...
	10: "HashD4Ca5418A77D22D968Ce7A2Afc549Dfe",
}
var VersionHash_CamelValue = map[string]int32{
	...
	"HashD4Ca5418A77D22D968Ce7A2Afc549Dfe": 10,
}
...
var fileDescriptorVersion = []byte{
	...
	,
}
