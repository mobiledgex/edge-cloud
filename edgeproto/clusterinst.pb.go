...
func (c *ClusterInstInfoCache) WaitForState(ctx context.Context, key *ClusterInstKey, targetState ClusterState, transitionStates map[ClusterState]struct{}, timeout time.Duration, successMsg string, send func(*Result) error) error {
	...
	case <-ctx.Done():
		log.DebugLog(log.DebugLevelApi, "Watch for ClusterInstInfo cancelled by user", "key", key)
	...
	case <-time.After(timeout):
		...
		if hasInfo && info.State == ClusterState_ClusterStateErrors {
			...
			msg := fmt.Sprintf("Timed out while work still in progress state %s. Please use ShowClusterInstInfoInfo to check current status", ClusterState_name[int32(info.State)])
			send(&Result{Message: msg})
			err = nil
		} else {
...
var fileDescriptorClusterinst = []byte{
	...
	,
}
