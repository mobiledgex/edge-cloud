...
type ClusterInst struct {
	...
	// Cloudlet specific master flavor
...
func (m *ClusterInst) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.MasterFlavor) > 0 {
		dAtA[i] = 0x62
		i++
		i = encodeVarintClusterinst(dAtA, i, uint64(len(m.MasterFlavor)))
		i += copy(dAtA[i:], m.MasterFlavor)
	}
	if m.NumMasters != 0 {
		dAtA[i] = 0x68
		i++
...
func (m *ClusterInst) Matches(o *ClusterInst, fopts ...MatchOpt) bool {
	...
	if !opts.IgnoreBackend {
		if !opts.Filter || o.MasterFlavor != "" {
			if o.MasterFlavor != m.MasterFlavor {
				return false
			}
		}
	}
...
const ClusterInstFieldMasterFlavor = "12"
...
var ClusterInstAllFieldsMap = map[string]struct{}{
	...
	ClusterInstFieldMasterFlavor:                  struct{}{},
...
func (m *ClusterInst) DiffFields(o *ClusterInst, fields map[string]struct{}) {
	...
	if m.MasterFlavor != o.MasterFlavor {
		fields[ClusterInstFieldMasterFlavor] = struct{}{}
	}
...
func (m *ClusterInst) CopyInFields(src *ClusterInst) {
	...
	if _, set := fmap["12"]; set {
		m.MasterFlavor = src.MasterFlavor
	}
...
func IgnoreClusterInstFields(taglist string) cmp.Option {
	...
	if _, found := tags["nocmp"]; found {
		names = append(names, "MasterFlavor")
	}
...
var fileDescriptorClusterinst = []byte{
	...
	,
}
