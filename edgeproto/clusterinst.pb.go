...
type ClusterInst struct {
	...
	// Chef client key
	ChefClientKey map[string]string `protobuf:"bytes,27,rep,name=chef_client_key,json=chefClientKey" json:"chef_client_key,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
type ClusterInstInfo struct {
	...
	// Chef client key
	ChefClientKey map[string]string `protobuf:"bytes,7,rep,name=chef_client_key,json=chefClientKey" json:"chef_client_key,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (m *ClusterInst) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.ChefClientKey) > 0 {
		for k, _ := range m.ChefClientKey {
			...
			i++
			v := m.ChefClientKey[k]
			mapSize := 1 + len(k) + sovClusterinst(uint64(len(k))) + 1 + len(v) + sovClusterinst(uint64(len(v)))
			i = encodeVarintClusterinst(dAtA, i, uint64(mapSize))
			dAtA[i] = 0xa
			i++
...
const ClusterInstFieldPrivacyPolicy = "24"
const ClusterInstFieldMasterNodeFlavor = "25"
const ClusterInstFieldSkipCrmCleanupOnFailure = "26"
const ClusterInstFieldChefClientKey = "27"
const ClusterInstFieldChefClientKeyKey = "27.1"
const ClusterInstFieldChefClientKeyValue = "27.2"
...
var ClusterInstAllFields = []string{
	...
	ClusterInstFieldPrivacyPolicy,
	ClusterInstFieldMasterNodeFlavor,
	ClusterInstFieldSkipCrmCleanupOnFailure,
	ClusterInstFieldChefClientKeyKey,
	ClusterInstFieldChefClientKeyValue,
}
...
var ClusterInstAllFieldsMap = map[string]struct{}{
	...
	ClusterInstFieldPrivacyPolicy:              struct{}{},
	ClusterInstFieldMasterNodeFlavor:           struct{}{},
	ClusterInstFieldSkipCrmCleanupOnFailure:    struct{}{},
	ClusterInstFieldChefClientKeyKey:           struct{}{},
	ClusterInstFieldChefClientKeyValue:         struct{}{},
}
...
var ClusterInstAllFieldsStringMap = map[string]string{
	...
	ClusterInstFieldChefClientKeyKey:           "Chef Client Key Key",
	ClusterInstFieldChefClientKeyValue:         "Chef Client Key Value",
}
...
func (m *ClusterInst) DiffFields(o *ClusterInst, fields map[string]struct{}) {
	...
	if m.PrivacyPolicy != o.PrivacyPolicy {
		fields[ClusterInstFieldPrivacyPolicy] = struct{}{}
	}
	...
	if m.ChefClientKey != nil && o.ChefClientKey != nil {
		if len(m.ChefClientKey) != len(o.ChefClientKey) {
			fields[ClusterInstFieldChefClientKey] = struct{}{}
		} else {
...
const ClusterInstInfoFieldChefClientKey = "7"
const ClusterInstInfoFieldChefClientKeyKey = "7.1"
const ClusterInstInfoFieldChefClientKeyValue = "7.2"
...
var ClusterInstInfoAllFields = []string{
	...
	ClusterInstInfoFieldChefClientKeyKey,
	ClusterInstInfoFieldChefClientKeyValue,
}
...
var ClusterInstInfoAllFieldsMap = map[string]struct{}{
	...
	ClusterInstInfoFieldChefClientKeyKey:           struct{}{},
	ClusterInstInfoFieldChefClientKeyValue:         struct{}{},
}
...
var ClusterInstInfoAllFieldsStringMap = map[string]string{
	...
	ClusterInstInfoFieldChefClientKeyKey:           "Chef Client Key Key",
	ClusterInstInfoFieldChefClientKeyValue:         "Chef Client Key Value",
}
...
func (m *ClusterInstInfo) DiffFields(o *ClusterInstInfo, fields map[string]struct{}) {
	...
	if m.ChefClientKey != nil && o.ChefClientKey != nil {
		if len(m.ChefClientKey) != len(o.ChefClientKey) {
			fields[ClusterInstInfoFieldChefClientKey] = struct{}{}
		} else {
			for k0, _ := range m.ChefClientKey {
				_, vok0 := o.ChefClientKey[k0]
				if !vok0 {
...
func (m *ClusterInstInfo) Size() (n int) {
	...
	if len(m.ChefClientKey) > 0 {
		for k, v := range m.ChefClientKey {
			...
			_ = v
			mapEntrySize := 1 + len(k) + sovClusterinst(uint64(len(k))) + 1 + len(v) + sovClusterinst(uint64(len(v)))
			n += mapEntrySize + 1 + sovClusterinst(uint64(mapEntrySize))
		}
	}
	return n
}
...
var fileDescriptorClusterinst = []byte{
	...
	,
}
