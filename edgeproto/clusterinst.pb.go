...
type ClusterInst struct {
	...
	// Prevents cleanup of resources on failure, used for diagnosis purposes
	SkipCleanupOnFailure bool `protobuf:"varint,26,opt,name=skip_cleanup_on_failure,json=skipCleanupOnFailure,proto3" json:"skip_cleanup_on_failure,omitempty"`
}
...
func (m *ClusterInst) Matches(o *ClusterInst, fopts ...MatchOpt) bool {
	...
	if !opts.Filter || o.SkipCleanupOnFailure != false {
		if o.SkipCleanupOnFailure != m.SkipCleanupOnFailure {
			return false
		}
	}
	return true
...
const ClusterInstFieldSkipCleanupOnFailure = "26"
...
var ClusterInstAllFields = []string{
	...
	ClusterInstFieldSkipCleanupOnFailure,
}
...
var ClusterInstAllFieldsMap = map[string]struct{}{
	...
	ClusterInstFieldSkipCleanupOnFailure:       struct{}{},
}
...
var ClusterInstAllFieldsStringMap = map[string]string{
	...
	ClusterInstFieldSkipCleanupOnFailure:       "Skip Cleanup On Failure",
}
...
func (m *ClusterInst) DiffFields(o *ClusterInst, fields map[string]struct{}) {
	...
	if m.SkipCleanupOnFailure != o.SkipCleanupOnFailure {
		fields[ClusterInstFieldSkipCleanupOnFailure] = struct{}{}
	}
}
...
func (m *ClusterInst) CopyInFields(src *ClusterInst) int {
	...
	if _, set := fmap["26"]; set {
		if m.SkipCleanupOnFailure != src.SkipCleanupOnFailure {
			m.SkipCleanupOnFailure = src.SkipCleanupOnFailure
			changed++
		}
	}
	return changed
...
type ClusterInstCache struct {
	...
	FlushAll     bool
	NotifyCb     func(ctx context.Context, obj *ClusterInstKey, old *ClusterInst, modRev int64)
...
func (c *ClusterInstCache) UpdateModFunc(ctx context.Context, key *ClusterInstKey, modRev int64, modFunc func(old *ClusterInst) (new *ClusterInst, changed bool)) {
	...
	log.DebugLog(log.DebugLevelApi, "SyncUpdate ClusterInst", "obj", new, "modRev", modRev)
	c.Mux.Unlock()
...
func (c *ClusterInstCache) Delete(ctx context.Context, in *ClusterInst, modRev int64) {
	...
	log.DebugLog(log.DebugLevelApi, "SyncDelete ClusterInst", "key", in.GetKey(), "modRev", modRev)
	c.Mux.Unlock()
	if c.NotifyCb != nil {
...
func IgnoreClusterInstFields(taglist string) cmp.Option {
	...
	if _, found := tags["nocmp"]; found {
		names = append(names, "SkipCleanupOnFailure")
	}
...
type ClusterInstInfoCache struct {
	...
	List         map[ClusterInstKey]struct{}
	FlushAll     bool
	NotifyCb     func(ctx context.Context, obj *ClusterInstKey, old *ClusterInstInfo, modRev int64)
...
func (c *ClusterInstInfoCache) UpdateModFunc(ctx context.Context, key *ClusterInstKey, modRev int64, modFunc func(old *ClusterInstInfo) (new *ClusterInstInfo, changed bool)) {
	...
	log.SpanLog(ctx, log.DebugLevelApi, "cache update", "new", new)
	log.DebugLog(log.DebugLevelApi, "SyncUpdate ClusterInstInfo", "obj", new, "modRev", modRev)
	c.Mux.Unlock()
	c.TriggerKeyWatchers(ctx, new.GetKey())
}
...
func (c *ClusterInstInfoCache) Delete(ctx context.Context, in *ClusterInstInfo, modRev int64) {
	...
	delete(c.Objs, in.GetKeyVal())
	log.SpanLog(ctx, log.DebugLevelApi, "cache delete")
	log.DebugLog(log.DebugLevelApi, "SyncDelete ClusterInstInfo", "key", in.GetKey(), "modRev", modRev)
	c.Mux.Unlock()
	if c.NotifyCb != nil {
		c.NotifyCb(ctx, in.GetKey(), old, modRev)
	}
...
func (m *ClusterInst) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 26:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field SkipCleanupOnFailure", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SkipCleanupOnFailure = bool(v != 0)
		default:
			iNdEx = preIndex
			skippy, err := skipClusterinst(dAtA[iNdEx:])
			if err != nil {
...
var fileDescriptorClusterinst = []byte{
	...
	,
}
