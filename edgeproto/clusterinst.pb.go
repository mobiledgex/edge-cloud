...
type ClusterInst struct {
	...
	// status is used to relflect progress of creation or other events
	Status *StatusInfo `protobuf:"bytes,16,opt,name=status" json:"status,omitempty"`
}
...
type ClusterInstInfo struct {
	...
	// State of the cluster instance
	State TrackedState `protobuf:"varint,4,opt,name=state,proto3,enum=edgeproto.TrackedState" json:"state,omitempty"`
	// status of current operat
	Status *StatusInfo `protobuf:"bytes,5,opt,name=status" json:"status,omitempty"`
	// Any errors trying to create, update, or delete the ClusterInst on the Cloudlet.
...
const ClusterInstFieldStatusTaskName = "16.2"
const ClusterInstFieldStatusStepName = "16.3"
...
func (m *ClusterInst) CopyInFields(src *ClusterInst) {
	...
	if _, set := fmap["16"]; set && src.Status != nil {
		m.Status = &StatusInfo{}
...
const ClusterInstInfoFieldStatus = "5"
const ClusterInstInfoFieldStatusTaskNumber = "5.1"
const ClusterInstInfoFieldStatusTaskName = "5.2"
const ClusterInstInfoFieldStatusStepName = "5.3"
const ClusterInstInfoFieldErrors = "6"
...
func (m *ClusterInstInfo) CopyInFields(src *ClusterInstInfo) {
	...
	if _, set := fmap["5"]; set && src.Status != nil {
		m.Status = &StatusInfo{}
...
var fileDescriptorClusterinst = []byte{
	...
	,
}
