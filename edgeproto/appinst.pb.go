...
type AppInst struct {
	...
	// Internal App or user created app
	Internal bool `protobuf:"varint,36,opt,name=internal,proto3" json:"internal,omitempty"`
}
...
func (m *AppInst) Matches(o *AppInst, fopts ...MatchOpt) bool {
	...
	if !opts.Filter || o.Internal != false {
		if o.Internal != m.Internal {
			return false
		}
	}
	return true
...
func (m *AppInst) DiffFields(o *AppInst, fields map[string]struct{}) {
	...
	if m.Internal != o.Internal {
		fields[AppInstFieldInternal] = struct{}{}
	}
}
...
var fileDescriptorAppinst = []byte{
	...
	,
}
