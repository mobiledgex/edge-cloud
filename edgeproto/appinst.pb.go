...
type AppInst struct {
	...
	NodeFlavor string `protobuf:"bytes,34,opt,name=node_flavor,json=nodeFlavor,proto3" json:"node_flavor,omitempty"`
}
...
func (m *AppInst) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.NodeFlavor) > 0 {
		...
		dAtA[i] = 0x2
		i++
		i = encodeVarintAppinst(dAtA, i, uint64(len(m.NodeFlavor)))
...
const AppInstFieldNodeFlavor = "34"
...
var AppInstAllFieldsStringMap = map[string]string{
	...
	AppInstFieldNodeFlavor:                                  "Node Flavor",
}
...
func (m *AppInst) DiffFields(o *AppInst, fields map[string]struct{}) {
	...
	if m.NodeFlavor != o.NodeFlavor {
		fields[AppInstFieldNodeFlavor] = struct{}{}
	}
}
...
var fileDescriptorAppinst = []byte{
	...
	,
}
