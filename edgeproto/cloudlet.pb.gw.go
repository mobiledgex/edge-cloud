...
var (
	...
	pattern_CloudletApi_GetCloudletResourceUsage_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"get", "cloudlet", "resources"}, "", runtime.AssumeColonVerbOpt(true)))
