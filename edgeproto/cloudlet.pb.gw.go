...
func request_PlatformApi_CreatePlatform_0(ctx context.Context, marshaler runtime.Marshaler, client PlatformApiClient, req *http.Request, pathParams map[string]string) (PlatformApi_CreatePlatformClient, runtime.ServerMetadata, error) {
	...
	stream, err := client.CreatePlatform(ctx, &protoReq)
	if err != nil {
...
func request_PlatformApi_DeletePlatform_0(ctx context.Context, marshaler runtime.Marshaler, client PlatformApiClient, req *http.Request, pathParams map[string]string) (PlatformApi_DeletePlatformClient, runtime.ServerMetadata, error) {
	var protoReq Platform
	var metadata runtime.ServerMetadata
	...
	stream, err := client.DeletePlatform(ctx, &protoReq)
	if err != nil {
		return nil, metadata, err
	}
	header, err := stream.Header()
...
func request_PlatformApi_UpdatePlatform_0(ctx context.Context, marshaler runtime.Marshaler, client PlatformApiClient, req *http.Request, pathParams map[string]string) (PlatformApi_UpdatePlatformClient, runtime.ServerMetadata, error) {
	var protoReq Platform
	var metadata runtime.ServerMetadata
	...
	stream, err := client.UpdatePlatform(ctx, &protoReq)
	if err != nil {
		return nil, metadata, err
	}
	header, err := stream.Header()
...
func request_PlatformApi_ShowPlatform_0(ctx context.Context, marshaler runtime.Marshaler, client PlatformApiClient, req *http.Request, pathParams map[string]string) (PlatformApi_ShowPlatformClient, runtime.ServerMetadata, error) {
	var protoReq Platform
	var metadata runtime.ServerMetadata
	...
	stream, err := client.ShowPlatform(ctx, &protoReq)
	if err != nil {
		return nil, metadata, err
	}
	header, err := stream.Header()
...
// RegisterPlatformApiHandlerFromEndpoint is same as RegisterPlatformApiHandler but
// automatically dials to "endpoint" and closes the connection when "ctx" gets done.
func RegisterPlatformApiHandlerFromEndpoint(ctx context.Context, mux *runtime.ServeMux, endpoint string, opts []grpc.DialOption) (err error) {
	...
	return RegisterPlatformApiHandler(ctx, mux, conn)
}

// RegisterPlatformApiHandler registers the http handlers for service PlatformApi to "mux".
// The handlers forward requests to the grpc endpoint over "conn".
func RegisterPlatformApiHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	return RegisterPlatformApiHandlerClient(ctx, mux, NewPlatformApiClient(conn))
}

// RegisterPlatformApiHandlerClient registers the http handlers for service PlatformApi
// to "mux". The handlers forward requests to the grpc endpoint over the given implementation of "PlatformApiClient".
// Note: the gRPC framework executes interceptors within the gRPC handler. If the passed in "PlatformApiClient"
// doesn't go through the normal gRPC flow (creating a gRPC client etc.) then it will be up to the passed in
// "PlatformApiClient" to call the correct interceptors.
func RegisterPlatformApiHandlerClient(ctx context.Context, mux *runtime.ServeMux, client PlatformApiClient) error {

	mux.Handle("POST", pattern_PlatformApi_CreatePlatform_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_PlatformApi_CreatePlatform_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_PlatformApi_CreatePlatform_0(ctx, mux, outboundMarshaler, w, req, func() (proto.Message, error) { return resp.Recv() }, mux.GetForwardResponseOptions()...)

	})

	mux.Handle("POST", pattern_PlatformApi_DeletePlatform_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req)
		...
		resp, md, err := request_PlatformApi_DeletePlatform_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_PlatformApi_DeletePlatform_0(ctx, mux, outboundMarshaler, w, req, func() (proto.Message, error) { return resp.Recv() }, mux.GetForwardResponseOptions()...)

	})

	mux.Handle("POST", pattern_PlatformApi_UpdatePlatform_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req)
		...
		resp, md, err := request_PlatformApi_UpdatePlatform_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_PlatformApi_UpdatePlatform_0(ctx, mux, outboundMarshaler, w, req, func() (proto.Message, error) { return resp.Recv() }, mux.GetForwardResponseOptions()...)

	})

	mux.Handle("POST", pattern_PlatformApi_ShowPlatform_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req)
		...
		resp, md, err := request_PlatformApi_ShowPlatform_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_PlatformApi_ShowPlatform_0(ctx, mux, outboundMarshaler, w, req, func() (proto.Message, error) { return resp.Recv() }, mux.GetForwardResponseOptions()...)
...
var (
	pattern_PlatformApi_CreatePlatform_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"create", "platform"}, ""))

	pattern_PlatformApi_DeletePlatform_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"delete", "platform"}, ""))

	pattern_PlatformApi_UpdatePlatform_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"update", "platform"}, ""))

	pattern_PlatformApi_ShowPlatform_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"show", "platform"}, ""))
)

var (
	forward_PlatformApi_CreatePlatform_0 = runtime.ForwardResponseStream

	forward_PlatformApi_DeletePlatform_0 = runtime.ForwardResponseStream

	forward_PlatformApi_UpdatePlatform_0 = runtime.ForwardResponseStream

	forward_PlatformApi_ShowPlatform_0 = runtime.ForwardResponseStream
)
