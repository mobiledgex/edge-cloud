...
type DnsEntryType int32

const (
	// Invalid - default to TypeA
	DnsEntryType_DnsEntryTypeUnknown DnsEntryType = 0
	// Host
	DnsEntryType_DnsEntryTypeARec DnsEntryType = 1
	// None
	DnsEntryType_DnsEntryTypeNone DnsEntryType = 2
)

var DnsEntryType_name = map[int32]string{
	0: "DnsEntryTypeUnknown",
	1: "DnsEntryTypeARec",
	2: "DnsEntryTypeNone",
}
var DnsEntryType_value = map[string]int32{
	"DnsEntryTypeUnknown": 0,
	"DnsEntryTypeARec":    1,
	"DnsEntryTypeNone":    2,
}

func (x DnsEntryType) String() string {
	return proto.EnumName(DnsEntryType_name, int32(x))
}
func (DnsEntryType) EnumDescriptor() ([]byte, []int) { return fileDescriptorApp, []int{2} }
...
type App struct {
	...
	// DNS rec type
	DnsEntryType DnsEntryType `protobuf:"varint,21,opt,name=dns_entry_type,json=dnsEntryType,proto3,enum=edgeproto.DnsEntryType" json:"dns_entry_type,omitempty"`
}
...
func init() {
	...
	proto.RegisterEnum("edgeproto.DnsEntryType", DnsEntryType_name, DnsEntryType_value)
}
...
func (m *App) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.DnsEntryType != 0 {
		...
		dAtA[i] = 0x1
		i++
		i = encodeVarintApp(dAtA, i, uint64(m.DnsEntryType))
	}
	return i, nil
}
...
func (m *App) Matches(o *App, fopts ...MatchOpt) bool {
	...
	if !opts.Filter || o.DnsEntryType != 0 {
		if o.DnsEntryType != m.DnsEntryType {
			return false
		}
	}
	return true
...
func (m *App) DiffFields(o *App, fields map[string]struct{}) {
	...
	if m.DnsEntryType != o.DnsEntryType {
		fields[AppFieldDnsEntryType] = struct{}{}
	}
}
...
func (m *App) CopyInFields(src *App) {
	...
	if _, set := fmap["21"]; set {
		m.DnsEntryType = src.DnsEntryType
	}
}
...
func (m *App) ValidateEnums() error {
	...
	if _, ok := DnsEntryType_name[int32(m.DnsEntryType)]; !ok {
		return errors.New("invalid DnsEntryType")
	}
	return nil
}
...
const (
	DnsEntryTypeDnsEntryTypeUnknown uint64 = 1 << 0
	DnsEntryTypeDnsEntryTypeARec    uint64 = 1 << 1
	DnsEntryTypeDnsEntryTypeNone    uint64 = 1 << 2
)

func (e *DnsEntryType) UnmarshalYAML(unmarshal func(interface{}) error) error {
	var str string
	err := unmarshal(&str)
	if err != nil {
		return err
	}
	val, ok := DnsEntryType_value[str]
	if !ok {
		// may be enum value instead of string
		ival, err := strconv.Atoi(str)
		val = int32(ival)
		if err == nil {
			_, ok = DnsEntryType_name[val]
		}
	}
	if !ok {
		return errors.New(fmt.Sprintf("No enum value for %s", str))
...
func (e DnsEntryType) MarshalYAML() (interface{}, error) {
	return e.String(), nil
}
...
func (m *App) Size() (n int) {
	...
	if m.DnsEntryType != 0 {
		n += 2 + sovApp(uint64(m.DnsEntryType))
	}
	return n
}
...
func (m *App) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 21:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field DnsEntryType", wireType)
			}
			m.DnsEntryType = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.DnsEntryType |= (DnsEntryType(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorApp = []byte{
	...
	,
}
