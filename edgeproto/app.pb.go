...
func (this *AppKey) GoString() string {
	...
	s = append(s, "Unsupported: "+fmt.Sprintf("%#v", this.Unsupported)+",\n")
	s = append(s, "}")
...
func (m *AppKey) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Unsupported) > 0 {
		dAtA[i] = 0x22
		i++
		i = encodeVarintApp(dAtA, i, uint64(len(m.Unsupported)))
		i += copy(dAtA[i:], m.Unsupported)
	}
	return i, nil
}
...
func (m *AppKey) Matches(o *AppKey, fopts ...MatchOpt) bool {
	...
	if !opts.Filter || o.Unsupported != "" {
		if o.Unsupported != m.Unsupported {
			return false
		}
	}
	return true
...
const AppFieldKeyUnsupported = "2.4"
...
func (m *App) DiffFields(o *App, fields map[string]struct{}) {
	...
	if m.Key.Unsupported != o.Key.Unsupported {
		fields[AppFieldKeyUnsupported] = struct{}{}
		fields[AppFieldKey] = struct{}{}
	}
...
func (m *App) CopyInFields(src *App) {
	...
	if _, set := fmap["2"]; set {
		...
		if _, set := fmap["2.4"]; set {
			m.Key.Unsupported = src.Key.Unsupported
		}
	}
	if _, set := fmap["4"]; set {
...
func (m *AppKey) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			m.Unsupported = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
...
var fileDescriptorApp = []byte{
	...
	,
}
