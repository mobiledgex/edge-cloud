...
const (
	// Best effort. Will be sent as LATENCY_DEFAULT
	QosSessionProfile_QOS_LATENCY_NO_PRIORITY QosSessionProfile = 0
	...
	QosSessionProfile_QOS_LATENCY_LOW QosSessionProfile = 1
	// Best effort. Will be sent as LATENCY_THROUGHPUT
	QosSessionProfile_QOS_THROUGHPUT_DOWN_NO_PRIORITY QosSessionProfile = 2
	// Downlink traffic from AppInst to client is prioritized up to 20Mbps
	QosSessionProfile_QOS_THROUGHPUT_DOWN_S QosSessionProfile = 3
	// Downlink traffic from AppInst to client is prioritized up to 50Mbps
	QosSessionProfile_QOS_THROUGHPUT_DOWN_M QosSessionProfile = 4
	// Downlink traffic from AppInst to client is prioritized up to 100Mbps
	QosSessionProfile_QOS_THROUGHPUT_DOWN_L QosSessionProfile = 5
)

var QosSessionProfile_name = map[int32]string{
	0: "QOS_LATENCY_NO_PRIORITY",
	1: "QOS_LATENCY_LOW",
	2: "QOS_THROUGHPUT_DOWN_NO_PRIORITY",
	3: "QOS_THROUGHPUT_DOWN_S",
	4: "QOS_THROUGHPUT_DOWN_M",
	5: "QOS_THROUGHPUT_DOWN_L",
}

var QosSessionProfile_value = map[string]int32{
	"QOS_LATENCY_NO_PRIORITY":         0,
	"QOS_LATENCY_LOW":                 1,
	"QOS_THROUGHPUT_DOWN_NO_PRIORITY": 2,
	"QOS_THROUGHPUT_DOWN_S":           3,
	"QOS_THROUGHPUT_DOWN_M":           4,
	"QOS_THROUGHPUT_DOWN_L":           5,
}
...
type App struct {
	...
	QosSessionDuration string `protobuf:"bytes,44,opt,name=qos_session_duration,json=qosSessionDuration,proto3" json:"qos_session_duration,omitempty"`
}
...
var fileDescriptor_e0f9056a14b86d47 = []byte{
	...
	,
}
...
func (m *App) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.QosSessionDuration) > 0 {
		i -= len(m.QosSessionDuration)
		copy(dAtA[i:], m.QosSessionDuration)
		i = encodeVarintApp(dAtA, i, uint64(len(m.QosSessionDuration)))
		i--
		dAtA[i] = 0x2
		i--
		dAtA[i] = 0xe2
...
func (m *App) Matches(o *App, fopts ...MatchOpt) bool {
	...
	if !opts.Filter || o.QosSessionDuration != "" {
...
var QosSessionProfileStrings = []string{
	"QOS_LATENCY_NO_PRIORITY",
	"QOS_LATENCY_LOW",
	"QOS_THROUGHPUT_DOWN_NO_PRIORITY",
...
const (
	QosSessionProfileQOS_LATENCY_NO_PRIORITY         uint64 = 1 << 0
	QosSessionProfileQOS_LATENCY_LOW                 uint64 = 1 << 1
	QosSessionProfileQOS_THROUGHPUT_DOWN_NO_PRIORITY uint64 = 1 << 2
	QosSessionProfileQOS_THROUGHPUT_DOWN_S           uint64 = 1 << 3
	QosSessionProfileQOS_THROUGHPUT_DOWN_M           uint64 = 1 << 4
	QosSessionProfileQOS_THROUGHPUT_DOWN_L           uint64 = 1 << 5
)

var QosSessionProfile_CamelName = map[int32]string{
	// QOS_LATENCY_NO_PRIORITY -> QosLatencyNoPriority
	0: "QosLatencyNoPriority",
	// QOS_LATENCY_LOW -> QosLatencyLow
	1: "QosLatencyLow",
	// QOS_THROUGHPUT_DOWN_NO_PRIORITY -> QosThroughputDownNoPriority
	2: "QosThroughputDownNoPriority",
	// QOS_THROUGHPUT_DOWN_S -> QosThroughputDownS
	3: "QosThroughputDownS",
	// QOS_THROUGHPUT_DOWN_M -> QosThroughputDownM
	4: "QosThroughputDownM",
	// QOS_THROUGHPUT_DOWN_L -> QosThroughputDownL
	5: "QosThroughputDownL",
}
var QosSessionProfile_CamelValue = map[string]int32{
	"QosLatencyNoPriority":        0,
	"QosLatencyLow":               1,
	"QosThroughputDownNoPriority": 2,
	"QosThroughputDownS":          3,
	"QosThroughputDownM":          4,
	"QosThroughputDownL":          5,
}
...
func (m *App) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 44:
			...
			m.QosSessionDuration = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipApp(dAtA[iNdEx:])
