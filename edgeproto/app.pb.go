...
type App struct {
	...
	KubeTemplate string `protobuf:"bytes,11,opt,name=kube_template,json=kubeTemplate,proto3" json:"kube_template,omitempty"`
}
...
func (m *App) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.KubeTemplate) > 0 {
		dAtA[i] = 0x5a
		i++
		i = encodeVarintApp(dAtA, i, uint64(len(m.KubeTemplate)))
...
func (m *App) DiffFields(o *App, fields map[string]struct{}) {
	...
	if m.KubeTemplate != o.KubeTemplate {
		fields[AppFieldKubeTemplate] = struct{}{}
	}
}
...
var fileDescriptorApp = []byte{
	...
	,
}
