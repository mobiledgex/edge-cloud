...
type App struct {
	...
	DelFlags DeleteType `protobuf:"varint,20,opt,name=del_flags,json=delFlags,proto3,enum=edgeproto.DeleteType" json:"del_flags,omitempty"`
}
...
func (m *App) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.DelFlags != 0 {
		...
		dAtA[i] = 0x1
		i++
		i = encodeVarintApp(dAtA, i, uint64(m.DelFlags))
	}
	return i, nil
}
...
func (m *App) Matches(o *App, fopts ...MatchOpt) bool {
	...
	if !opts.Filter || o.DelFlags != 0 {
		if o.DelFlags != m.DelFlags {
			return false
		}
	}
	return true
...
func (m *App) DiffFields(o *App, fields map[string]struct{}) {
	...
	if m.DelFlags != o.DelFlags {
		fields[AppFieldDelFlags] = struct{}{}
	}
}
...
func (m *App) ValidateEnums() error {
	...
	if _, ok := DeleteType_name[int32(m.DelFlags)]; !ok {
		return errors.New("invalid DelFlags")
	}
	return nil
}
...
func (m *App) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 20:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field DelFlags", wireType)
			}
			m.DelFlags = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.DelFlags |= (DeleteType(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorApp = []byte{
	...
	,
}
