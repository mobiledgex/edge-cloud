...
func request_PrivacyPolicyApi_ShowPrivacyPolicy_0(ctx context.Context, marshaler runtime.Marshaler, client PrivacyPolicyApiClient, req *http.Request, pathParams map[string]string) (PrivacyPolicyApi_ShowPrivacyPolicyClient, runtime.ServerMetadata, error) {
	var protoReq PrivacyPolicy
	var metadata runtime.ServerMetadata
	...
	stream, err := client.ShowPrivacyPolicy(ctx, &protoReq)
	if err != nil {
...
// UnaryRPC     :call PrivacyPolicyApiServer directly.
...
// RegisterPrivacyPolicyApiHandlerFromEndpoint is same as RegisterPrivacyPolicyApiHandler but
// automatically dials to "endpoint" and closes the connection when "ctx" gets done.
func RegisterPrivacyPolicyApiHandlerFromEndpoint(ctx context.Context, mux *runtime.ServeMux, endpoint string, opts []grpc.DialOption) (err error) {
	...
	return RegisterPrivacyPolicyApiHandler(ctx, mux, conn)
}

// RegisterPrivacyPolicyApiHandler registers the http handlers for service PrivacyPolicyApi to "mux".
// The handlers forward requests to the grpc endpoint over "conn".
func RegisterPrivacyPolicyApiHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	return RegisterPrivacyPolicyApiHandlerClient(ctx, mux, NewPrivacyPolicyApiClient(conn))
}

// RegisterPrivacyPolicyApiHandlerClient registers the http handlers for service PrivacyPolicyApi
// to "mux". The handlers forward requests to the grpc endpoint over the given implementation of "PrivacyPolicyApiClient".
// Note: the gRPC framework executes interceptors within the gRPC handler. If the passed in "PrivacyPolicyApiClient"
// doesn't go through the normal gRPC flow (creating a gRPC client etc.) then it will be up to the passed in
// "PrivacyPolicyApiClient" to call the correct interceptors.
func RegisterPrivacyPolicyApiHandlerClient(ctx context.Context, mux *runtime.ServeMux, client PrivacyPolicyApiClient) error {
	...
	mux.Handle("POST", pattern_PrivacyPolicyApi_CreatePrivacyPolicy_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_PrivacyPolicyApi_CreatePrivacyPolicy_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("POST", pattern_PrivacyPolicyApi_DeletePrivacyPolicy_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_PrivacyPolicyApi_DeletePrivacyPolicy_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("POST", pattern_PrivacyPolicyApi_UpdatePrivacyPolicy_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_PrivacyPolicyApi_UpdatePrivacyPolicy_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("POST", pattern_PrivacyPolicyApi_ShowPrivacyPolicy_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_PrivacyPolicyApi_ShowPrivacyPolicy_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_PrivacyPolicyApi_ShowPrivacyPolicy_0(ctx, mux, outboundMarshaler, w, req, func() (proto.Message, error) { return resp.Recv() }, mux.GetForwardResponseOptions()...)
...
var (
	pattern_PrivacyPolicyApi_CreatePrivacyPolicy_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"create", "privacypolicy"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_PrivacyPolicyApi_DeletePrivacyPolicy_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"delete", "privacypolicy"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_PrivacyPolicyApi_UpdatePrivacyPolicy_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"update", "privacypolicy"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_PrivacyPolicyApi_ShowPrivacyPolicy_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"show", "privacypolicy"}, "", runtime.AssumeColonVerbOpt(true)))
)
