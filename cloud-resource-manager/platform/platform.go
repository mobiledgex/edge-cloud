...
type ClusterSvc interface {
	...
	GetVersionProperties() map[string]string
	// Get AppInst Configs
	GetAppInstConfigs(ctx context.Context, clusterInst *edgeproto.ClusterInst, appInst *edgeproto.AppInst, autoScalePolicy *edgeproto.AutoScalePolicy, userAlerts []edgeproto.UserAlert) ([]*edgeproto.ConfigFile, error)
}
