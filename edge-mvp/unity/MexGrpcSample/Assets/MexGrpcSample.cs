...
public class MexGrpcSample : MonoBehaviour
{
    ...
    // Root CA:
    string caCrt = @"-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----";
    ...
    // Client Crt:
    string clientCrt = @"-----BEGIN CERTIFICATE-----
...
-----END RSA PRIVATE KEY-----";
    ...
    public void RunSampleFlow() {
        ...
        var clientKeyPair = new KeyCertificatePair(clientCrt, clientKey);
        var sslCredentials = new SslCredentials(caCrt, clientKeyPair);
