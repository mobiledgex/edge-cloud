...
require (
	...
	github.com/gophercloud/gophercloud v0.0.0-20180531020630-7112fcd50da4
	...
	github.com/mobiledgex/yaml/v2 v2.2.3
	...
	k8s.io/apimachinery v0.0.0-20180516022032-3492ef8dace1
