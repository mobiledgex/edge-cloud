...
edgectl controller CreateAppInst  --key-appkey-developerkey-name testdeveloper --key-appkey-name testapp --key-appkey-version testversion --key-cloudletkey-operatorkey-name mex-tdg --key-cloudletkey-name testcloudlet --key-id 1
