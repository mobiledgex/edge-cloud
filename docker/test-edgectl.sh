...
edgectl controller CreateOperator --key-name mex-tdg
edgectl controller CreateCloudlet --key-name testcloudlet --key-operatorkey-name mex-tdg --location-altitude 1.1 --location-long 1.1 --location-lat 1.1  --numdynamicips 1
...
edgectl controller CreateClusterInst --key-cloudletkey-operatorkey-name mex-tdg --key-cloudletkey-name testcloudlet --key-clusterkey-name testcluster 
...
edgectl controller CreateAppInst --accesslayer AccessLayerL7 --key-appkey-developerkey-name testdeveloper --key-appkey-name testapp --key-appkey-version testversion --key-cloudletkey-operatorkey-name mex-tdg --key-cloudletkey-name testcloudlet --key-id 1
