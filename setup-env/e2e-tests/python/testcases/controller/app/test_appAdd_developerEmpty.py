...
class tc(unittest.TestCase):
    ...
    def test_CreateAppDeveloperEmpty(self):
    ...
    def test_CreateAppDeveloperEmpty_2(self):
        # print the existing apps
        app_pre = self.controller.show_apps()
    ...
    def test_CreateAppDeveloperNotExist(self):
        # print the existing apps
        app_pre = self.controller.show_apps()
    ...
    def test_CreateAppDeveloperNotExist_2(self):
        # print the existing apps
        app_pre = self.controller.show_apps()
