...
func (m *TestGen) SetUpdateFields() {
	if m.Name != "" {
		m.Fields = append(m.Fields, TestGenFieldName)
	}
	if m.Db != 0 {
		m.Fields = append(m.Fields, TestGenFieldDb)
	}
	if m.Fl != 0 {
		m.Fields = append(m.Fields, TestGenFieldFl)
	}
	if m.I32 != 0 {
		m.Fields = append(m.Fields, TestGenFieldI32)
	}
	if m.I64 != 0 {
		m.Fields = append(m.Fields, TestGenFieldI64)
	}
	if m.U32 != 0 {
		m.Fields = append(m.Fields, TestGenFieldU32)
	}
	if m.U64 != 0 {
		m.Fields = append(m.Fields, TestGenFieldU64)
	}
	if m.S32 != 0 {
		m.Fields = append(m.Fields, TestGenFieldS32)
	}
	if m.S64 != 0 {
		m.Fields = append(m.Fields, TestGenFieldS64)
	}
	if m.F32 != 0 {
		m.Fields = append(m.Fields, TestGenFieldF32)
	}
	if m.F64 != 0 {
		m.Fields = append(m.Fields, TestGenFieldF64)
	}
	if m.Sf32 != 0 {
		m.Fields = append(m.Fields, TestGenFieldSf32)
	}
	if m.Sf64 != 0 {
		m.Fields = append(m.Fields, TestGenFieldSf64)
	}
	if m.Bb != false {
		m.Fields = append(m.Fields, TestGenFieldBb)
	}
	if m.OuterEn != 0 {
		m.Fields = append(m.Fields, TestGenFieldOuterEn)
	}
	if m.InnerEn != 0 {
		m.Fields = append(m.Fields, TestGenFieldInnerEn)
	}
	if m.InnerMsg != nil {
		if m.InnerMsg.Url != "" {
			m.Fields = append(m.Fields, TestGenFieldInnerMsgUrl)
		}
		if m.InnerMsg.Id != 0 {
			m.Fields = append(m.Fields, TestGenFieldInnerMsgId)
		}
	}
	if m.InnerMsgNonnull.Url != "" {
		m.Fields = append(m.Fields, TestGenFieldInnerMsgNonnullUrl)
	}
	if m.InnerMsgNonnull.Id != 0 {
		m.Fields = append(m.Fields, TestGenFieldInnerMsgNonnullId)
	}
	if m.IncludeMsg != nil {
		if m.IncludeMsg.Name != "" {
			m.Fields = append(m.Fields, TestGenFieldIncludeMsgName)
		}
		if m.IncludeMsg.Id != 0 {
			m.Fields = append(m.Fields, TestGenFieldIncludeMsgId)
		}
		if m.IncludeMsg.NestedMsg != nil {
			if m.IncludeMsg.NestedMsg.Name != "" {
				m.Fields = append(m.Fields, TestGenFieldIncludeMsgNestedMsgName)
			}
		}
	}
	if m.IncludeMsgNonnull.Name != "" {
		m.Fields = append(m.Fields, TestGenFieldIncludeMsgNonnullName)
	}
	if m.IncludeMsgNonnull.Id != 0 {
		m.Fields = append(m.Fields, TestGenFieldIncludeMsgNonnullId)
	}
	if m.IncludeMsgNonnull.NestedMsg != nil {
		if m.IncludeMsgNonnull.NestedMsg.Name != "" {
			m.Fields = append(m.Fields, TestGenFieldIncludeMsgNonnullNestedMsgName)
		}
	}
	if m.IncludeFields != nil {
		if m.IncludeFields.Name != "" {
			m.Fields = append(m.Fields, TestGenFieldIncludeFieldsName)
		}
	}
	if m.IncludeFieldsNonnull.Name != "" {
		m.Fields = append(m.Fields, TestGenFieldIncludeFieldsNonnullName)
	}
	if m.Loc != nil {
		if m.Loc.Latitude != 0 {
			m.Fields = append(m.Fields, TestGenFieldLocLatitude)
		}
		if m.Loc.Longitude != 0 {
			m.Fields = append(m.Fields, TestGenFieldLocLongitude)
		}
		if m.Loc.HorizontalAccuracy != 0 {
			m.Fields = append(m.Fields, TestGenFieldLocHorizontalAccuracy)
		}
		if m.Loc.VerticalAccuracy != 0 {
			m.Fields = append(m.Fields, TestGenFieldLocVerticalAccuracy)
		}
		if m.Loc.Altitude != 0 {
			m.Fields = append(m.Fields, TestGenFieldLocAltitude)
		}
		if m.Loc.Course != 0 {
			m.Fields = append(m.Fields, TestGenFieldLocCourse)
		}
		if m.Loc.Speed != 0 {
			m.Fields = append(m.Fields, TestGenFieldLocSpeed)
		}
		if m.Loc.Timestamp != nil {
			if m.Loc.Timestamp.Seconds != 0 {
				m.Fields = append(m.Fields, TestGenFieldLocTimestampSeconds)
			}
			if m.Loc.Timestamp.Nanos != 0 {
				m.Fields = append(m.Fields, TestGenFieldLocTimestampNanos)
			}
		}
	}
	if m.LocNonnull.Latitude != 0 {
		m.Fields = append(m.Fields, TestGenFieldLocNonnullLatitude)
	}
	if m.LocNonnull.Longitude != 0 {
		m.Fields = append(m.Fields, TestGenFieldLocNonnullLongitude)
	}
	if m.LocNonnull.HorizontalAccuracy != 0 {
		m.Fields = append(m.Fields, TestGenFieldLocNonnullHorizontalAccuracy)
	}
	if m.LocNonnull.VerticalAccuracy != 0 {
		m.Fields = append(m.Fields, TestGenFieldLocNonnullVerticalAccuracy)
	}
	if m.LocNonnull.Altitude != 0 {
		m.Fields = append(m.Fields, TestGenFieldLocNonnullAltitude)
	}
	if m.LocNonnull.Course != 0 {
		m.Fields = append(m.Fields, TestGenFieldLocNonnullCourse)
	}
	if m.LocNonnull.Speed != 0 {
		m.Fields = append(m.Fields, TestGenFieldLocNonnullSpeed)
	}
	if m.LocNonnull.Timestamp != nil {
		if m.LocNonnull.Timestamp.Seconds != 0 {
			m.Fields = append(m.Fields, TestGenFieldLocNonnullTimestampSeconds)
		}
		if m.LocNonnull.Timestamp.Nanos != 0 {
			m.Fields = append(m.Fields, TestGenFieldLocNonnullTimestampNanos)
		}
	}
	if m.RepeatedInt != nil {
		m.Fields = append(m.Fields, TestGenFieldRepeatedInt)
	}
	if m.Ip != nil {
		m.Fields = append(m.Fields, TestGenFieldIp)
	}
	if m.Names != nil {
		m.Fields = append(m.Fields, TestGenFieldNames)
	}
	if m.RepeatedMsg != nil {
		m.Fields = append(m.Fields, TestGenFieldRepeatedMsg)
	}
	if m.RepeatedMsgNonnull != nil {
		m.Fields = append(m.Fields, TestGenFieldRepeatedMsgNonnull)
	}
	if m.RepeatedFields != nil {
		m.Fields = append(m.Fields, TestGenFieldRepeatedFields)
	}
	if m.RepeatedFieldsNonnull != nil {
		m.Fields = append(m.Fields, TestGenFieldRepeatedFieldsNonnull)
	}
	if m.RepeatedInnerMsg != nil {
		m.Fields = append(m.Fields, TestGenFieldRepeatedInnerMsg)
	}
	if m.RepeatedInnerMsgNonnull != nil {
		m.Fields = append(m.Fields, TestGenFieldRepeatedInnerMsgNonnull)
	}
	if m.RepeatedLoc != nil {
		m.Fields = append(m.Fields, TestGenFieldRepeatedLoc)
	}
	if m.RepeatedLocNonnull != nil {
		m.Fields = append(m.Fields, TestGenFieldRepeatedLocNonnull)
	}
	if m.IntMap != nil {
		m.Fields = append(m.Fields, TestGenFieldIntMap)
	}
	if m.MsgMap != nil {
		m.Fields = append(m.Fields, TestGenFieldMsgMap)
	}
}
