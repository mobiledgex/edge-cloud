...
// Status of the reply
type AppFqdnReply_AFStatus int32

const (
	AppFqdnReply_AF_UNDEFINED AppFqdnReply_AFStatus = 0
	AppFqdnReply_AF_SUCCESS   AppFqdnReply_AFStatus = 1
	AppFqdnReply_AF_FAIL      AppFqdnReply_AFStatus = 2
)

var AppFqdnReply_AFStatus_name = map[int32]string{
	0: "AF_UNDEFINED",
	1: "AF_SUCCESS",
	2: "AF_FAIL",
}
var AppFqdnReply_AFStatus_value = map[string]int32{
	"AF_UNDEFINED": 0,
	"AF_SUCCESS":   1,
	"AF_FAIL":      2,
}

func (x AppFqdnReply_AFStatus) String() string {
	return proto.EnumName(AppFqdnReply_AFStatus_name, int32(x))
}
func (AppFqdnReply_AFStatus) EnumDescriptor() ([]byte, []int) {
	return fileDescriptorAppClient, []int{17, 0}
}
...
func (m *AppFqdnRequest) Reset()                    { *m = AppFqdnRequest{} }
func (m *AppFqdnRequest) String() string            { return proto.CompactTextString(m) }
func (*AppFqdnRequest) ProtoMessage()               {}
func (*AppFqdnRequest) Descriptor() ([]byte, []int) { return fileDescriptorAppClient, []int{16} }

type AppFqdnReply struct {
	// API version
	Ver     uint32                `protobuf:"varint,1,opt,name=ver,proto3" json:"ver,omitempty"`
	AppFqdn string                `protobuf:"bytes,2,opt,name=app_fqdn,json=appFqdn,proto3" json:"app_fqdn,omitempty"`
	Status  AppFqdnReply_AFStatus `protobuf:"varint,4,opt,name=status,proto3,enum=distributed_match_engine.AppFqdnReply_AFStatus" json:"status,omitempty"`
	// _(optional)_ Vendor specific data
	Tags []*Tag `protobuf:"bytes,99,rep,name=tags" json:"tags,omitempty"`
}

func (m *AppFqdnReply) Reset()                    { *m = AppFqdnReply{} }
func (m *AppFqdnReply) String() string            { return proto.CompactTextString(m) }
func (*AppFqdnReply) ProtoMessage()               {}
func (*AppFqdnReply) Descriptor() ([]byte, []int) { return fileDescriptorAppClient, []int{17} }
...
func (*DynamicLocGroupRequest) Descriptor() ([]byte, []int) { return fileDescriptorAppClient, []int{18} }
...
func (*DynamicLocGroupReply) Descriptor() ([]byte, []int) { return fileDescriptorAppClient, []int{19} }
...
func (*QosPosition) Descriptor() ([]byte, []int) { return fileDescriptorAppClient, []int{20} }
...
func (*BandSelection) Descriptor() ([]byte, []int) { return fileDescriptorAppClient, []int{21} }
...
func (*QosPositionRequest) Descriptor() ([]byte, []int) { return fileDescriptorAppClient, []int{22} }
...
func (*QosPositionKpiResult) Descriptor() ([]byte, []int) { return fileDescriptorAppClient, []int{23} }
...
func (*QosPositionKpiReply) Descriptor() ([]byte, []int) { return fileDescriptorAppClient, []int{24} }
...
func init() {
	...
	proto.RegisterType((*AppFqdnRequest)(nil), "distributed_match_engine.AppFqdnRequest")
	proto.RegisterType((*AppFqdnReply)(nil), "distributed_match_engine.AppFqdnReply")
	...
	proto.RegisterEnum("distributed_match_engine.AppFqdnReply_AFStatus", AppFqdnReply_AFStatus_name, AppFqdnReply_AFStatus_value)
...
type MatchEngineApiClient interface {
	...
	GetAppFqdn(ctx context.Context, in *AppFqdnRequest, opts ...grpc.CallOption) (*AppFqdnReply, error)
...
func (c *matchEngineApiClient) GetAppFqdn(ctx context.Context, in *AppFqdnRequest, opts ...grpc.CallOption) (*AppFqdnReply, error) {
	out := new(AppFqdnReply)
	err := grpc.Invoke(ctx, "/distributed_match_engine.MatchEngineApi/GetAppFqdn", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MatchEngineApiServer interface {
	...
	GetAppFqdn(context.Context, *AppFqdnRequest) (*AppFqdnReply, error)
...
func _MatchEngineApi_GetAppFqdn_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AppFqdnRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MatchEngineApiServer).GetAppFqdn(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/distributed_match_engine.MatchEngineApi/GetAppFqdn",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MatchEngineApiServer).GetAppFqdn(ctx, req.(*AppFqdnRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _MatchEngineApi_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetAppFqdn",
			Handler:    _MatchEngineApi_GetAppFqdn_Handler,
		},
	},
...
func (m *AppFqdnRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *AppFqdnRequest) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *AppFqdnReply) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *AppFqdnReply) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	if len(m.AppFqdn) > 0 {
		dAtA[i] = 0x12
		i++
		i = encodeVarintAppClient(dAtA, i, uint64(len(m.AppFqdn)))
		i += copy(dAtA[i:], m.AppFqdn)
	}
	if m.Status != 0 {
		dAtA[i] = 0x20
		i++
...
func (m *AppFqdnRequest) CopyInFields(src *AppFqdnRequest) int {
	changed := 0
	if m.Ver != src.Ver {
		m.Ver = src.Ver
		changed++
...
// Helper method to check that enums have valid values
func (m *AppFqdnRequest) ValidateEnums() error {
	for _, e := range m.Tags {
		if err := e.ValidateEnums(); err != nil {
			return err
		}
...
func (m *AppFqdnReply) CopyInFields(src *AppFqdnReply) int {
	changed := 0
	if m.Ver != src.Ver {
		m.Ver = src.Ver
		changed++
	}
	if m.AppFqdn != src.AppFqdn {
		m.AppFqdn = src.AppFqdn
		changed++
	}
	if m.Status != src.Status {
		m.Status = src.Status
...
// Helper method to check that enums have valid values
func (m *AppFqdnReply) ValidateEnums() error {
	if _, ok := AppFqdnReply_AFStatus_name[int32(m.Status)]; !ok {
		return errors.New("invalid Status")
	}
	for _, e := range m.Tags {
		if err := e.ValidateEnums(); err != nil {
...
const (
	AFStatusAF_UNDEFINED uint64 = 1 << 0
	AFStatusAF_SUCCESS   uint64 = 1 << 1
	AFStatusAF_FAIL      uint64 = 1 << 2
)

var AppFqdnReply_AFStatus_CamelName = map[int32]string{
	// AF_UNDEFINED -> AfUndefined
	0: "AfUndefined",
	// AF_SUCCESS -> AfSuccess
	1: "AfSuccess",
	// AF_FAIL -> AfFail
	2: "AfFail",
}
var AppFqdnReply_AFStatus_CamelValue = map[string]int32{
	"AfUndefined": 0,
	"AfSuccess":   1,
	"AfFail":      2,
}

func (e *AppFqdnReply_AFStatus) UnmarshalYAML(unmarshal func(interface{}) error) error {
	var str string
	err := unmarshal(&str)
	if err != nil {
		return err
	}
	val, ok := AppFqdnReply_AFStatus_CamelValue[util.CamelCase(str)]
	if !ok {
		// may be enum value instead of string
		ival, err := strconv.Atoi(str)
		val = int32(ival)
		if err == nil {
			_, ok = AppFqdnReply_AFStatus_CamelName[val]
		}
	}
	if !ok {
		return errors.New(fmt.Sprintf("No enum value for %s", str))
	}
	*e = AppFqdnReply_AFStatus(val)
	return nil
}

func (e AppFqdnReply_AFStatus) MarshalYAML() (interface{}, error) {
	return proto.EnumName(AppFqdnReply_AFStatus_CamelName, int32(e)), nil
}

// custom JSON encoding/decoding
func (e *AppFqdnReply_AFStatus) UnmarshalJSON(b []byte) error {
	var str string
	err := json.Unmarshal(b, &str)
	if err == nil {
		val, ok := AppFqdnReply_AFStatus_CamelValue[util.CamelCase(str)]
...
func (m *AppFqdnRequest) Size() (n int) {
	var l int
	_ = l
	if m.Ver != 0 {
		n += 1 + sovAppClient(uint64(m.Ver))
...
func (m *AppFqdnReply) Size() (n int) {
	var l int
	_ = l
	if m.Ver != 0 {
		n += 1 + sovAppClient(uint64(m.Ver))
...
func (m *AppFqdnRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AppFqdnRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AppFqdnRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *AppFqdnReply) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AppFqdnReply: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AppFqdnReply: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AppFqdn", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.AppFqdn = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field Status", wireType)
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Status |= (AppFqdnReply_AFStatus(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorAppClient = []byte{
	...
	,
}
