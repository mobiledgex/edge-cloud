...
// Congestion flag communication. This can be set by endpoints, as well as something between the endpoints, like a router.
type ECNBit int32

const (
	ECNBit_NON_ECT ECNBit = 0
	ECNBit_ECT_0   ECNBit = 2
	ECNBit_ECT_1   ECNBit = 1
	ECNBit_CE      ECNBit = 3
)

var ECNBit_name = map[int32]string{
	0: "NON_ECT",
	2: "ECT_0",
	1: "ECT_1",
	3: "CE",
...
var ECNBit_value = map[string]int32{
	"NON_ECT": 0,
	"ECT_0":   2,
	"ECT_1":   1,
	"CE":      3,
...
func (x ECNBit) String() string {
	return proto.EnumName(ECNBit_name, int32(x))
}

func (ECNBit) EnumDescriptor() ([]byte, []int) {
...
const (
	...
	ClientEdgeEvent_EVENT_ECN_STATUS           ClientEdgeEvent_ClientEventType = 6
)
...
func (ServerEdgeEvent_ServerEventType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_bb90079a337be67f, []int{31, 0}
}
...
// ECN status (for a protocol connection).
type ECNStatus struct {
	// Last seen ECN bit
	EcnBit ECNBit `protobuf:"varint,1,opt,name=ecn_bit,json=ecnBit,proto3,enum=distributed_match_engine.ECNBit" json:"ecn_bit,omitempty"`
	// Start of sample period
	SampleDurationMs uint64 `protobuf:"varint,2,opt,name=sample_duration_ms,json=sampleDurationMs,proto3" json:"sample_duration_ms,omitempty"`
	// Number of Congestion Encountered bits during sampling period
	NumCe uint64 `protobuf:"varint,3,opt,name=num_ce,json=numCe,proto3" json:"num_ce,omitempty"`
	// overall packets in sample
	NumPackets uint64 `protobuf:"varint,4,opt,name=num_packets,json=numPackets,proto3" json:"num_packets,omitempty"`
	// Inform current app or protocol strategy to determine sending bandwidth. App determined strategy as string name.
	Strategy string `protobuf:"bytes,5,opt,name=strategy,proto3" json:"strategy,omitempty"`
	// Bandwidth, as determined by ECN stragegy
...
func (m *ECNStatus) Reset()         { *m = ECNStatus{} }
func (m *ECNStatus) String() string { return proto.CompactTextString(m) }
func (*ECNStatus) ProtoMessage()    {}
func (*ECNStatus) Descriptor() ([]byte, []int) {
	return fileDescriptor_bb90079a337be67f, []int{29}
}
func (m *ECNStatus) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ECNStatus) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ECNStatus.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ECNStatus) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ECNStatus.Merge(m, src)
}
func (m *ECNStatus) XXX_Size() int {
	return m.Size()
}
func (m *ECNStatus) XXX_DiscardUnknown() {
	xxx_messageInfo_ECNStatus.DiscardUnknown(m)
}

var xxx_messageInfo_ECNStatus proto.InternalMessageInfo
...
type ClientEdgeEvent struct {
	...
	// _(optional)_ Explicit Congestion Network status, if supported by transport infrastructure.
	EcnStatus *ECNStatus `protobuf:"bytes,9,opt,name=ecn_status,json=ecnStatus,proto3" json:"ecn_status,omitempty"`
	// _(optional)_ Vendor specific data
	Tags                 map[string]string `protobuf:"bytes,100,rep,name=tags,proto3" json:"tags,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_unrecognized     []byte            `json:"-"`
...
type ServerEdgeEvent struct {
	...
	// _(optional)_ Explicit Congestion Network status, if supported by transport infrastructure
	EcnStatus *ECNStatus `protobuf:"bytes,8,opt,name=ecn_status,json=ecnStatus,proto3" json:"ecn_status,omitempty"`
	// _(optional)_ Vendor specific data
	Tags                 map[string]string `protobuf:"bytes,100,rep,name=tags,proto3" json:"tags,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_unrecognized     []byte            `json:"-"`
...
func (*ServerEdgeEvent) Descriptor() ([]byte, []int) {
	return fileDescriptor_bb90079a337be67f, []int{31}
}
...
func init() {
	...
	proto.RegisterEnum("distributed_match_engine.ECNBit", ECNBit_name, ECNBit_value)
	...
	proto.RegisterType((*ECNStatus)(nil), "distributed_match_engine.ECNStatus")
...
var fileDescriptor_bb90079a337be67f = []byte{
	...
	,
}
...
func (m *BandSelection) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Rat5G) > 0 {
		for iNdEx := len(m.Rat5G) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintAppClient(dAtA, i, uint64(len(m.Rat5G[iNdEx])))
			i--
			dAtA[i] = 0x22
		}
	}
	if len(m.Rat4G) > 0 {
		for iNdEx := len(m.Rat4G) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintAppClient(dAtA, i, uint64(len(m.Rat4G[iNdEx])))
			i--
			dAtA[i] = 0x1a
		}
	}
	if len(m.Rat3G) > 0 {
		for iNdEx := len(m.Rat3G) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintAppClient(dAtA, i, uint64(len(m.Rat3G[iNdEx])))
			i--
			dAtA[i] = 0x12
		}
	}
	if len(m.Rat2G) > 0 {
		for iNdEx := len(m.Rat2G) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintAppClient(dAtA, i, uint64(len(m.Rat2G[iNdEx])))
			i--
			dAtA[i] = 0xa
		}
	}
...
func (m *ECNStatus) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ECNStatus) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ECNStatus) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.Strategy) > 0 {
		...
		i = encodeVarintAppClient(dAtA, i, uint64(len(m.Strategy)))
		i--
		dAtA[i] = 0x2a
	}
	if m.NumPackets != 0 {
		i = encodeVarintAppClient(dAtA, i, uint64(m.NumPackets))
		i--
		dAtA[i] = 0x20
	}
	if m.NumCe != 0 {
		i = encodeVarintAppClient(dAtA, i, uint64(m.NumCe))
		i--
		dAtA[i] = 0x18
	}
	if m.SampleDurationMs != 0 {
		i = encodeVarintAppClient(dAtA, i, uint64(m.SampleDurationMs))
		i--
		dAtA[i] = 0x10
	}
	if m.EcnBit != 0 {
		i = encodeVarintAppClient(dAtA, i, uint64(m.EcnBit))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *ClientEdgeEvent) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.EcnStatus != nil {
		{
			size, err := m.EcnStatus.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *ECNStatus) CopyInFields(src *ECNStatus) int {
	changed := 0
	if m.EcnBit != src.EcnBit {
		m.EcnBit = src.EcnBit
		changed++
	}
	if m.SampleDurationMs != src.SampleDurationMs {
		m.SampleDurationMs = src.SampleDurationMs
		changed++
	}
	if m.NumCe != src.NumCe {
		m.NumCe = src.NumCe
		changed++
	}
	if m.NumPackets != src.NumPackets {
		m.NumPackets = src.NumPackets
		changed++
	}
	if m.Strategy != src.Strategy {
		m.Strategy = src.Strategy
		changed++
	}
	if m.Bandwidth != src.Bandwidth {
...
func (m *ECNStatus) DeepCopyIn(src *ECNStatus) {
	m.EcnBit = src.EcnBit
	m.SampleDurationMs = src.SampleDurationMs
	m.NumCe = src.NumCe
	m.NumPackets = src.NumPackets
...
// Helper method to check that enums have valid values
func (m *ECNStatus) ValidateEnums() error {
	if _, ok := ECNBit_name[int32(m.EcnBit)]; !ok {
		return errors.New("invalid EcnBit")
	}
	return nil
}

func (s *ECNStatus) ClearTagged(tags map[string]struct{}) {
}
...
func (m *ClientEdgeEvent) CopyInFields(src *ClientEdgeEvent) int {
	...
	if src.EcnStatus != nil {
		if m.EcnStatus == nil {
			m.EcnStatus = &ECNStatus{}
		}
		if m.EcnStatus.EcnBit != src.EcnStatus.EcnBit {
			m.EcnStatus.EcnBit = src.EcnStatus.EcnBit
			changed++
		}
		if m.EcnStatus.SampleDurationMs != src.EcnStatus.SampleDurationMs {
			m.EcnStatus.SampleDurationMs = src.EcnStatus.SampleDurationMs
			changed++
		}
		if m.EcnStatus.NumCe != src.EcnStatus.NumCe {
			m.EcnStatus.NumCe = src.EcnStatus.NumCe
			changed++
		}
		if m.EcnStatus.NumPackets != src.EcnStatus.NumPackets {
			m.EcnStatus.NumPackets = src.EcnStatus.NumPackets
			changed++
		}
		if m.EcnStatus.Strategy != src.EcnStatus.Strategy {
			m.EcnStatus.Strategy = src.EcnStatus.Strategy
			changed++
		}
		if m.EcnStatus.Bandwidth != src.EcnStatus.Bandwidth {
			m.EcnStatus.Bandwidth = src.EcnStatus.Bandwidth
			changed++
		}
	} else if m.EcnStatus != nil {
		m.EcnStatus = nil
		changed++
	}
	if src.Tags != nil {
...
func (m *ClientEdgeEvent) DeepCopyIn(src *ClientEdgeEvent) {
	...
	m.CustomEvent = src.CustomEvent
	if src.EcnStatus != nil {
		var tmp_EcnStatus ECNStatus
		tmp_EcnStatus.DeepCopyIn(src.EcnStatus)
		m.EcnStatus = &tmp_EcnStatus
	} else {
		m.EcnStatus = nil
	}
	if src.Tags != nil {
...
func (m *ClientEdgeEvent) ValidateEnums() error {
	...
	if m.EcnStatus != nil {
		if err := m.EcnStatus.ValidateEnums(); err != nil {
			return err
		}
	}
	return nil
...
const (
	ECNBitNON_ECT uint64 = 1 << 0
	ECNBitECT_0   uint64 = 1 << 1
	ECNBitECT_1   uint64 = 1 << 2
	ECNBitCE      uint64 = 1 << 3
)

var ECNBit_CamelName = map[int32]string{
	// NON_ECT -> NonEct
	0: "NonEct",
	// ECT_0 -> Ect0
	2: "Ect0",
...
var ECNBit_CamelValue = map[string]int32{
	"NonEct": 0,
	"Ect0":   2,
	"Ect1":   1,
	"Ce":     3,
...
func ParseECNBit(data interface{}) (ECNBit, error) {
	if val, ok := data.(ECNBit); ok {
		return val, nil
	} else if str, ok := data.(string); ok {
		val, ok := ECNBit_CamelValue[util.CamelCase(str)]
		if !ok {
			// may be int value instead of enum name
			ival, err := strconv.Atoi(str)
			val = int32(ival)
			if err == nil {
				_, ok = ECNBit_CamelName[val]
			}
		}
		if !ok {
			return ECNBit(0), fmt.Errorf("Invalid ECNBit value %q", str)
		}
		return ECNBit(val), nil
	} else if ival, ok := data.(int32); ok {
		if _, ok := ECNBit_CamelName[ival]; ok {
			return ECNBit(ival), nil
		} else {
			return ECNBit(0), fmt.Errorf("Invalid ECNBit value %d", ival)
		}
	}
	return ECNBit(0), fmt.Errorf("Invalid ECNBit value %v", data)
}

func (e *ECNBit) UnmarshalYAML(unmarshal func(interface{}) error) error {
	var str string
	err := unmarshal(&str)
	if err != nil {
		return err
	}
	val, err := ParseECNBit(str)
	if err != nil {
		return err
	}
	*e = val
...
func (e ECNBit) MarshalYAML() (interface{}, error) {
	str := proto.EnumName(ECNBit_CamelName, int32(e))
	return str, nil
}

// custom JSON encoding/decoding
func (e *ECNBit) UnmarshalJSON(b []byte) error {
	var str string
	err := json.Unmarshal(b, &str)
	if err == nil {
		val, err := ParseECNBit(str)
...
func (e ECNBit) MarshalJSON() ([]byte, error) {
	str := proto.EnumName(ECNBit_CamelName, int32(e))
	return json.Marshal(str)
}
...
const (
	...
	ClientEventTypeEVENT_ECN_STATUS           uint64 = 1 << 6
)
...
var ClientEdgeEvent_ClientEventType_CamelName = map[int32]string{
	...
	5: "EventCustomEvent",
	// EVENT_ECN_STATUS -> EventEcnStatus
	6: "EventEcnStatus",
}
...
func EnumDecodeHook(from, to reflect.Type, data interface{}) (interface{}, error) {
	...
	case reflect.TypeOf(ECNBit(0)):
		return ParseECNBit(data)
	}
	return data, nil
}
...
func GetEnumParseHelp(t reflect.Type) (string, string, bool) {
	...
	case reflect.TypeOf(ECNBit(0)):
		return "ECNBit", ", valid values are one of NonEct, Ect0, Ect1, Ce, or 0, 2, 1, 3", true
	}
	return "", "", false
}
...
func (m *ECNStatus) Size() (n int) {
	...
	_ = l
	if m.EcnBit != 0 {
		n += 1 + sovAppClient(uint64(m.EcnBit))
	}
	if m.SampleDurationMs != 0 {
		n += 1 + sovAppClient(uint64(m.SampleDurationMs))
	}
	if m.NumCe != 0 {
		n += 1 + sovAppClient(uint64(m.NumCe))
	}
	if m.NumPackets != 0 {
		n += 1 + sovAppClient(uint64(m.NumPackets))
	}
	l = len(m.Strategy)
	if l > 0 {
		n += 1 + l + sovAppClient(uint64(l))
...
func (m *ECNStatus) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ECNStatus: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ECNStatus: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field EcnBit", wireType)
			}
			m.EcnBit = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.SampleDurationMs |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field NumCe", wireType)
			}
			m.NumCe = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 4:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.NumPackets |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *ClientEdgeEvent) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field EcnStatus", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.EcnStatus.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 100:
