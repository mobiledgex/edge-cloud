...
/*
	...
	It has these top-level messages:
		...
		QosPositionKpiReply
		QosPositionClassifierResult
		QosPositionClassifierReply
		AppPort
		DlgMessage
		DlgReply
		Timestamp
...
// QosPositionRequest is used for both GetQosPositionKpi and GetQosPositionClassifier
...
type QosPositionClassifierResult struct {
	// as set by the client, must be unique within one QosPositionRequest
	Positionid int64 `protobuf:"varint,1,opt,name=positionid,proto3" json:"positionid,omitempty"`
	// the location which was requested
	GpsLocation           *Loc  `protobuf:"bytes,2,opt,name=gps_location,json=gpsLocation" json:"gps_location,omitempty"`
	...
	DluserthroughputClass int32 `protobuf:"varint,4,opt,name=dluserthroughput_class,json=dluserthroughputClass,proto3" json:"dluserthroughput_class,omitempty"`
	LatencyClass          int32 `protobuf:"varint,5,opt,name=latency_class,json=latencyClass,proto3" json:"latency_class,omitempty"`
}

func (m *QosPositionClassifierResult) Reset()         { *m = QosPositionClassifierResult{} }
func (m *QosPositionClassifierResult) String() string { return proto.CompactTextString(m) }
func (*QosPositionClassifierResult) ProtoMessage()    {}
func (*QosPositionClassifierResult) Descriptor() ([]byte, []int) {
	return fileDescriptorAppClient, []int{22}
}

type QosPositionClassifierReply struct {
	Ver uint32 `protobuf:"varint,1,opt,name=ver,proto3" json:"ver,omitempty"`
	// Status of the reply
	Status ReplyStatus `protobuf:"varint,2,opt,name=status,proto3,enum=distributed_match_engine.ReplyStatus" json:"status,omitempty"`
	// kpi details
	PositionResults []*QosPositionClassifierResult `protobuf:"bytes,3,rep,name=position_results,json=positionResults" json:"position_results,omitempty"`
}

func (m *QosPositionClassifierReply) Reset()         { *m = QosPositionClassifierReply{} }
func (m *QosPositionClassifierReply) String() string { return proto.CompactTextString(m) }
func (*QosPositionClassifierReply) ProtoMessage()    {}
func (*QosPositionClassifierReply) Descriptor() ([]byte, []int) {
	return fileDescriptorAppClient, []int{23}
}
...
func init() {
	...
	proto.RegisterType((*QosPositionClassifierResult)(nil), "distributed_match_engine.QosPositionClassifierResult")
	proto.RegisterType((*QosPositionClassifierReply)(nil), "distributed_match_engine.QosPositionClassifierReply")
...
type MatchEngineApiClient interface {
	...
	GetQosPositionClassifier(ctx context.Context, in *QosPositionRequest, opts ...grpc.CallOption) (MatchEngineApi_GetQosPositionClassifierClient, error)
}
...
func (c *matchEngineApiClient) GetQosPositionClassifier(ctx context.Context, in *QosPositionRequest, opts ...grpc.CallOption) (MatchEngineApi_GetQosPositionClassifierClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_MatchEngineApi_serviceDesc.Streams[1], c.cc, "/distributed_match_engine.MatchEngineApi/GetQosPositionClassifier", opts...)
	if err != nil {
		return nil, err
	}
	x := &matchEngineApiGetQosPositionClassifierClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type MatchEngineApi_GetQosPositionClassifierClient interface {
	Recv() (*QosPositionClassifierReply, error)
	grpc.ClientStream
}

type matchEngineApiGetQosPositionClassifierClient struct {
	grpc.ClientStream
}

func (x *matchEngineApiGetQosPositionClassifierClient) Recv() (*QosPositionClassifierReply, error) {
	m := new(QosPositionClassifierReply)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
type MatchEngineApiServer interface {
	...
	GetQosPositionClassifier(*QosPositionRequest, MatchEngineApi_GetQosPositionClassifierServer) error
}
...
func _MatchEngineApi_GetQosPositionClassifier_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(QosPositionRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(MatchEngineApiServer).GetQosPositionClassifier(m, &matchEngineApiGetQosPositionClassifierServer{stream})
}

type MatchEngineApi_GetQosPositionClassifierServer interface {
	Send(*QosPositionClassifierReply) error
	grpc.ServerStream
}

type matchEngineApiGetQosPositionClassifierServer struct {
	grpc.ServerStream
}

func (x *matchEngineApiGetQosPositionClassifierServer) Send(m *QosPositionClassifierReply) error {
	return x.ServerStream.SendMsg(m)
}
...
var _MatchEngineApi_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "GetQosPositionClassifier",
			Handler:       _MatchEngineApi_GetQosPositionClassifier_Handler,
			ServerStreams: true,
		},
	},
...
func (m *QosPositionClassifierResult) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *QosPositionClassifierResult) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	if m.UluserthroughputClass != 0 {
		dAtA[i] = 0x18
		i++
		i = encodeVarintAppClient(dAtA, i, uint64(m.UluserthroughputClass))
	}
	if m.DluserthroughputClass != 0 {
		dAtA[i] = 0x20
		i++
		i = encodeVarintAppClient(dAtA, i, uint64(m.DluserthroughputClass))
	}
	if m.LatencyClass != 0 {
		dAtA[i] = 0x28
		i++
		i = encodeVarintAppClient(dAtA, i, uint64(m.LatencyClass))
	}
	return i, nil
}

func (m *QosPositionClassifierReply) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *QosPositionClassifierReply) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *QosPositionClassifierResult) CopyInFields(src *QosPositionClassifierResult) {
	m.Positionid = src.Positionid
	if src.GpsLocation != nil {
		m.GpsLocation = &Loc{}
		m.GpsLocation.Latitude = src.GpsLocation.Latitude
...
// Helper method to check that enums have valid values
func (m *QosPositionClassifierResult) ValidateEnums() error {
	if err := m.GpsLocation.ValidateEnums(); err != nil {
		return err
	}
	return nil
...
func (m *QosPositionClassifierReply) CopyInFields(src *QosPositionClassifierReply) {
	m.Ver = src.Ver
	m.Status = src.Status
	if src.PositionResults != nil {
		if m.PositionResults == nil || len(m.PositionResults) != len(src.PositionResults) {
			m.PositionResults = make([]*QosPositionClassifierResult, len(src.PositionResults))
		}
		for i0 := 0; i0 < len(src.PositionResults); i0++ {
			m.PositionResults[i0] = &QosPositionClassifierResult{}
			m.PositionResults[i0].Positionid = src.PositionResults[i0].Positionid
			if src.PositionResults[i0].GpsLocation != nil {
				m.PositionResults[i0].GpsLocation = &Loc{}
				m.PositionResults[i0].GpsLocation.Latitude = src.PositionResults[i0].GpsLocation.Latitude
			...
			m.PositionResults[i0].UluserthroughputClass = src.PositionResults[i0].UluserthroughputClass
			m.PositionResults[i0].DluserthroughputClass = src.PositionResults[i0].DluserthroughputClass
			m.PositionResults[i0].LatencyClass = src.PositionResults[i0].LatencyClass
		}
	}
}

// Helper method to check that enums have valid values
func (m *QosPositionClassifierReply) ValidateEnums() error {
	if _, ok := ReplyStatus_name[int32(m.Status)]; !ok {
		return errors.New("invalid Status")
	}
	for _, e := range m.PositionResults {
...
func (m *QosPositionClassifierResult) Size() (n int) {
	var l int
	_ = l
	if m.Positionid != 0 {
		n += 1 + sovAppClient(uint64(m.Positionid))
	...
	if m.UluserthroughputClass != 0 {
		n += 1 + sovAppClient(uint64(m.UluserthroughputClass))
	}
	if m.DluserthroughputClass != 0 {
		n += 1 + sovAppClient(uint64(m.DluserthroughputClass))
	}
	if m.LatencyClass != 0 {
		n += 1 + sovAppClient(uint64(m.LatencyClass))
	}
	return n
}

func (m *QosPositionClassifierReply) Size() (n int) {
	var l int
	_ = l
	if m.Ver != 0 {
		n += 1 + sovAppClient(uint64(m.Ver))
...
func (m *QosPositionClassifierResult) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QosPositionClassifierResult: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QosPositionClassifierResult: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *QosPositionClassifierReply) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QosPositionClassifierReply: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QosPositionClassifierReply: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 3:
			...
			m.PositionResults = append(m.PositionResults, &QosPositionClassifierResult{})
			if err := m.PositionResults[len(m.PositionResults)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
...
var fileDescriptorAppClient = []byte{
	...
	,
}
