...
type QosPositionKpiRequest struct {
	...
	SessionCookie string `protobuf:"bytes,2,opt,name=session_cookie,json=sessionCookie,proto3" json:"session_cookie,omitempty"`
	// list of positions
	Positions *QosPosition `protobuf:"bytes,3,opt,name=positions" json:"positions,omitempty"`
}
...
type QosPositionKpiReply struct {
	...
	Status ReplyStatus `protobuf:"varint,2,opt,name=status,proto3,enum=distributed_match_engine.ReplyStatus" json:"status,omitempty"`
	// kpi details
	PositionResults []*PositionKpiResult `protobuf:"bytes,3,rep,name=position_results,json=positionResults" json:"position_results,omitempty"`
}
...
func (*QosPositionKpiReply) Descriptor() ([]byte, []int) { return fileDescriptorAppClient, []int{19} }
...
func (m *QosPositionKpiRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Positions != nil {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintAppClient(dAtA, i, uint64(m.Positions.Size()))
		n8, err := m.Positions.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n8
...
func (m *QosPositionKpiRequest) CopyInFields(src *QosPositionKpiRequest) {
	...
	if src.Positions != nil {
		m.Positions = &QosPosition{}
		m.Positions.Positionid = src.Positions.Positionid
		if src.Positions.GpsLocation != nil {
			m.Positions.GpsLocation = &Loc{}
			m.Positions.GpsLocation.Latitude = src.Positions.GpsLocation.Latitude
			m.Positions.GpsLocation.Longitude = src.Positions.GpsLocation.Longitude
			m.Positions.GpsLocation.HorizontalAccuracy = src.Positions.GpsLocation.HorizontalAccuracy
			m.Positions.GpsLocation.VerticalAccuracy = src.Positions.GpsLocation.VerticalAccuracy
			m.Positions.GpsLocation.Altitude = src.Positions.GpsLocation.Altitude
			m.Positions.GpsLocation.Course = src.Positions.GpsLocation.Course
			m.Positions.GpsLocation.Speed = src.Positions.GpsLocation.Speed
			if src.Positions.GpsLocation.Timestamp != nil {
				m.Positions.GpsLocation.Timestamp = &Timestamp{}
				m.Positions.GpsLocation.Timestamp.Seconds = src.Positions.GpsLocation.Timestamp.Seconds
				m.Positions.GpsLocation.Timestamp.Nanos = src.Positions.GpsLocation.Timestamp.Nanos
			}
		}
	}
}
...
func (m *QosPositionKpiRequest) ValidateEnums() error {
	if err := m.Positions.ValidateEnums(); err != nil {
		return err
	}
	return nil
}
...
func (m *QosPositionKpiReply) CopyInFields(src *QosPositionKpiReply) {
	...
	if src.PositionResults != nil {
		if m.PositionResults == nil || len(m.PositionResults) != len(src.PositionResults) {
			m.PositionResults = make([]*PositionKpiResult, len(src.PositionResults))
		}
		for i0 := 0; i0 < len(src.PositionResults); i0++ {
			m.PositionResults[i0] = &PositionKpiResult{}
...
func (m *QosPositionKpiReply) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.PositionResults = append(m.PositionResults, &PositionKpiResult{})
...
var fileDescriptorAppClient = []byte{
	...
	,
}
