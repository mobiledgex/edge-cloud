...
func (Match_Engine_Request_IDType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_app_client_e7c8a0eba265fc9c, []int{1, 0}
}
...
func (Match_Engine_Loc_Verify_Tower_Status) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_app_client_e7c8a0eba265fc9c, []int{3, 0}
}
...
func (Match_Engine_Loc_Verify_GPS_Location_Status) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_app_client_e7c8a0eba265fc9c, []int{3, 1}
}
...
func (*Loc) Descriptor() ([]byte, []int) {
	return fileDescriptor_app_client_e7c8a0eba265fc9c, []int{0}
}
...
func (*Match_Engine_Request) Descriptor() ([]byte, []int) {
	return fileDescriptor_app_client_e7c8a0eba265fc9c, []int{1}
}
func (m *Match_Engine_Request) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_Match_Engine_Request.Unmarshal(m, b)
}
func (m *Match_Engine_Request) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_Match_Engine_Request.Marshal(b, m, deterministic)
}
func (dst *Match_Engine_Request) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Match_Engine_Request.Merge(dst, src)
}
func (m *Match_Engine_Request) XXX_Size() int {
	return xxx_messageInfo_Match_Engine_Request.Size(m)
}
func (m *Match_Engine_Request) XXX_DiscardUnknown() {
	xxx_messageInfo_Match_Engine_Request.DiscardUnknown(m)
}

var xxx_messageInfo_Match_Engine_Request proto.InternalMessageInfo
...
func (*Match_Engine_Reply) Descriptor() ([]byte, []int) {
	return fileDescriptor_app_client_e7c8a0eba265fc9c, []int{2}
}
func (m *Match_Engine_Reply) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_Match_Engine_Reply.Unmarshal(m, b)
}
func (m *Match_Engine_Reply) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_Match_Engine_Reply.Marshal(b, m, deterministic)
}
func (dst *Match_Engine_Reply) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Match_Engine_Reply.Merge(dst, src)
}
func (m *Match_Engine_Reply) XXX_Size() int {
	return xxx_messageInfo_Match_Engine_Reply.Size(m)
}
func (m *Match_Engine_Reply) XXX_DiscardUnknown() {
	xxx_messageInfo_Match_Engine_Reply.DiscardUnknown(m)
}

var xxx_messageInfo_Match_Engine_Reply proto.InternalMessageInfo
...
func (*Match_Engine_Loc_Verify) Descriptor() ([]byte, []int) {
	return fileDescriptor_app_client_e7c8a0eba265fc9c, []int{3}
}
func (m *Match_Engine_Loc_Verify) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_Match_Engine_Loc_Verify.Unmarshal(m, b)
}
func (m *Match_Engine_Loc_Verify) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_Match_Engine_Loc_Verify.Marshal(b, m, deterministic)
}
func (dst *Match_Engine_Loc_Verify) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Match_Engine_Loc_Verify.Merge(dst, src)
}
func (m *Match_Engine_Loc_Verify) XXX_Size() int {
	return xxx_messageInfo_Match_Engine_Loc_Verify.Size(m)
}
func (m *Match_Engine_Loc_Verify) XXX_DiscardUnknown() {
	xxx_messageInfo_Match_Engine_Loc_Verify.DiscardUnknown(m)
}

var xxx_messageInfo_Match_Engine_Loc_Verify proto.InternalMessageInfo
...
func init() { proto.RegisterFile("app-client.proto", fileDescriptor_app_client_e7c8a0eba265fc9c) }

var fileDescriptor_app_client_e7c8a0eba265fc9c = []byte{
