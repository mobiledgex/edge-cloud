...
type ServerEdgeEvent_CloudletState int32

const (
	ServerEdgeEvent_CLOUDLET_STATE_UNKNOWN     ServerEdgeEvent_CloudletState = 0
	ServerEdgeEvent_CLOUDLET_STATE_READY       ServerEdgeEvent_CloudletState = 1
	ServerEdgeEvent_CLOUDLET_OFFLINE           ServerEdgeEvent_CloudletState = 2
	ServerEdgeEvent_CLOUDLET_STATE_NOT_PRESENT ServerEdgeEvent_CloudletState = 3
	ServerEdgeEvent_CLOUDLET_UPGRADE           ServerEdgeEvent_CloudletState = 4
	ServerEdgeEvent_CLOUDLET_STATE_ERRORS      ServerEdgeEvent_CloudletState = 5
	ServerEdgeEvent_CLOUDLET_STATE_INIT        ServerEdgeEvent_CloudletState = 6
)

var ServerEdgeEvent_CloudletState_name = map[int32]string{
	0: "CLOUDLET_STATE_UNKNOWN",
	1: "CLOUDLET_STATE_READY",
	2: "CLOUDLET_OFFLINE",
	3: "CLOUDLET_STATE_NOT_PRESENT",
	4: "CLOUDLET_UPGRADE",
	5: "CLOUDLET_STATE_ERRORS",
	6: "CLOUDLET_STATE_INIT",
}

var ServerEdgeEvent_CloudletState_value = map[string]int32{
	"CLOUDLET_STATE_UNKNOWN":     0,
	"CLOUDLET_STATE_READY":       1,
	"CLOUDLET_OFFLINE":           2,
	"CLOUDLET_STATE_NOT_PRESENT": 3,
	"CLOUDLET_UPGRADE":           4,
	"CLOUDLET_STATE_ERRORS":      5,
	"CLOUDLET_STATE_INIT":        6,
}

func (x ServerEdgeEvent_CloudletState) String() string {
	return proto.EnumName(ServerEdgeEvent_CloudletState_name, int32(x))
}

func (ServerEdgeEvent_CloudletState) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_bb90079a337be67f, []int{26, 1}
}

// Cloudlet maintenance state information
type ServerEdgeEvent_CloudletMaintenanceState int32

const (
	ServerEdgeEvent_MAINTENANCE_STATE_UNKNOWN            ServerEdgeEvent_CloudletMaintenanceState = 0
	ServerEdgeEvent_MAINTENANCE_STATE_NORMAL             ServerEdgeEvent_CloudletMaintenanceState = 1
	ServerEdgeEvent_MAINTENANCE_STATE_UNDER_MAINTENANCE  ServerEdgeEvent_CloudletMaintenanceState = 2
	ServerEdgeEvent_MAINTENANCE_STATE_MAINTENANCE_FAILED ServerEdgeEvent_CloudletMaintenanceState = 3
	ServerEdgeEvent_MAINTENANCE_STATE_FAILING_OVER       ServerEdgeEvent_CloudletMaintenanceState = 4
	ServerEdgeEvent_MAINTENANCE_STATE_FAILOVER_ERROR     ServerEdgeEvent_CloudletMaintenanceState = 5
	ServerEdgeEvent_MAINTENANCE_STATE_FAILOVER_DONE      ServerEdgeEvent_CloudletMaintenanceState = 6
)

var ServerEdgeEvent_CloudletMaintenanceState_name = map[int32]string{
	0: "MAINTENANCE_STATE_UNKNOWN",
	1: "MAINTENANCE_STATE_NORMAL",
	2: "MAINTENANCE_STATE_UNDER_MAINTENANCE",
	3: "MAINTENANCE_STATE_MAINTENANCE_FAILED",
	4: "MAINTENANCE_STATE_FAILING_OVER",
	5: "MAINTENANCE_STATE_FAILOVER_ERROR",
	6: "MAINTENANCE_STATE_FAILOVER_DONE",
}

var ServerEdgeEvent_CloudletMaintenanceState_value = map[string]int32{
	"MAINTENANCE_STATE_UNKNOWN":            0,
	"MAINTENANCE_STATE_NORMAL":             1,
	"MAINTENANCE_STATE_UNDER_MAINTENANCE":  2,
	"MAINTENANCE_STATE_MAINTENANCE_FAILED": 3,
	"MAINTENANCE_STATE_FAILING_OVER":       4,
	"MAINTENANCE_STATE_FAILOVER_ERROR":     5,
	"MAINTENANCE_STATE_FAILOVER_DONE":      6,
}

func (x ServerEdgeEvent_CloudletMaintenanceState) String() string {
	return proto.EnumName(ServerEdgeEvent_CloudletMaintenanceState_name, int32(x))
}

func (ServerEdgeEvent_CloudletMaintenanceState) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_bb90079a337be67f, []int{26, 2}
}

// AppInst health state information
type ServerEdgeEvent_AppInstHealthState int32

const (
	ServerEdgeEvent_HEALTH_CHECK_UNKNOWN ServerEdgeEvent_AppInstHealthState = 0
	ServerEdgeEvent_HEALTH_CHECK_OK      ServerEdgeEvent_AppInstHealthState = 1
	ServerEdgeEvent_HEALTH_CHECK_FAIL    ServerEdgeEvent_AppInstHealthState = 2
	ServerEdgeEvent_APPINST_DOWN         ServerEdgeEvent_AppInstHealthState = 3
)

var ServerEdgeEvent_AppInstHealthState_name = map[int32]string{
...
var ServerEdgeEvent_AppInstHealthState_value = map[string]int32{
...
func (x ServerEdgeEvent_AppInstHealthState) String() string {
	return proto.EnumName(ServerEdgeEvent_AppInstHealthState_name, int32(x))
}

func (ServerEdgeEvent_AppInstHealthState) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_bb90079a337be67f, []int{26, 3}
}
...
type FindCloudletReply struct {
	...
	DmeFqdn string `protobuf:"bytes,7,opt,name=dme_fqdn,json=dmeFqdn,proto3" json:"dme_fqdn,omitempty"`
	// _(optional)_ Vendor specific data
	Tags                 map[string]string `protobuf:"bytes,100,rep,name=tags,proto3" json:"tags,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_unrecognized     []byte            `json:"-"`
...
type ClientEdgeEvent struct {
	...
	Event            ClientEdgeEvent_ClientEventType `protobuf:"varint,3,opt,name=event,proto3,enum=distributed_match_engine.ClientEdgeEvent_ClientEventType" json:"event,omitempty"`
	// GPS Location info if EventType is EVENT_LOCATION_UPDATE
	GpsLocation *Loc `protobuf:"bytes,4,opt,name=gps_location,json=gpsLocation,proto3" json:"gps_location,omitempty"`
	// Latency Samples if EventType is EVENT_LATENCY_SAMPLES
	Samples []float64 `protobuf:"fixed64,5,rep,packed,name=samples,proto3" json:"samples,omitempty"`
	// _(optional)_ Vendor specific data
	Tags                 map[string]string `protobuf:"bytes,100,rep,name=tags,proto3" json:"tags,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_unrecognized     []byte            `json:"-"`
...
type ServerEdgeEvent struct {
	Event                    ServerEdgeEvent_ServerEventType          `protobuf:"varint,1,opt,name=event,proto3,enum=distributed_match_engine.ServerEdgeEvent_ServerEventType" json:"event,omitempty"`
	CloudletState            ServerEdgeEvent_CloudletState            `protobuf:"varint,2,opt,name=cloudlet_state,json=cloudletState,proto3,enum=distributed_match_engine.ServerEdgeEvent_CloudletState" json:"cloudlet_state,omitempty"`
	CloudletMaintenanceState ServerEdgeEvent_CloudletMaintenanceState `protobuf:"varint,3,opt,name=cloudlet_maintenance_state,json=cloudletMaintenanceState,proto3,enum=distributed_match_engine.ServerEdgeEvent_CloudletMaintenanceState" json:"cloudlet_maintenance_state,omitempty"`
	AppinstHealthState       ServerEdgeEvent_AppInstHealthState       `protobuf:"varint,4,opt,name=appinst_health_state,json=appinstHealthState,proto3,enum=distributed_match_engine.ServerEdgeEvent_AppInstHealthState" json:"appinst_health_state,omitempty"`
...
func init() {
	...
	proto.RegisterEnum("distributed_match_engine.ServerEdgeEvent_CloudletState", ServerEdgeEvent_CloudletState_name, ServerEdgeEvent_CloudletState_value)
	proto.RegisterEnum("distributed_match_engine.ServerEdgeEvent_CloudletMaintenanceState", ServerEdgeEvent_CloudletMaintenanceState_name, ServerEdgeEvent_CloudletMaintenanceState_value)
	proto.RegisterEnum("distributed_match_engine.ServerEdgeEvent_AppInstHealthState", ServerEdgeEvent_AppInstHealthState_name, ServerEdgeEvent_AppInstHealthState_value)
...
var fileDescriptor_bb90079a337be67f = []byte{
	...
	,
}
...
func (m *FindCloudletReply) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.DmeFqdn) > 0 {
		i -= len(m.DmeFqdn)
		copy(dAtA[i:], m.DmeFqdn)
		i = encodeVarintAppClient(dAtA, i, uint64(len(m.DmeFqdn)))
		i--
		dAtA[i] = 0x3a
	}
...
func (m *ClientEdgeEvent) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Samples) > 0 {
		for iNdEx := len(m.Samples) - 1; iNdEx >= 0; iNdEx-- {
			f11 := math.Float64bits(float64(m.Samples[iNdEx]))
			i -= 8
			encoding_binary.LittleEndian.PutUint64(dAtA[i:], uint64(f11))
		}
		i = encodeVarintAppClient(dAtA, i, uint64(len(m.Samples)*8))
		i--
		dAtA[i] = 0x2a
	}
	if m.GpsLocation != nil {
	...
	if m.Event != 0 {
		i = encodeVarintAppClient(dAtA, i, uint64(m.Event))
		i--
		dAtA[i] = 0x18
	}
	if len(m.EdgeEventsCookie) > 0 {
...
func (m *ServerEdgeEvent) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.AppinstHealthState != 0 {
		i = encodeVarintAppClient(dAtA, i, uint64(m.AppinstHealthState))
		i--
		dAtA[i] = 0x20
	}
	if m.CloudletMaintenanceState != 0 {
		i = encodeVarintAppClient(dAtA, i, uint64(m.CloudletMaintenanceState))
		i--
		dAtA[i] = 0x18
	}
...
func (m *FindCloudletReply) CopyInFields(src *FindCloudletReply) int {
	...
	if m.DmeFqdn != src.DmeFqdn {
		m.DmeFqdn = src.DmeFqdn
		changed++
	}
	if src.Tags != nil {
		m.Tags = make(map[string]string)
...
func (m *ClientEdgeEvent) DeepCopyIn(src *ClientEdgeEvent) {
	...
	if src.Samples != nil {
		m.Samples = make([]float64, len(src.Samples), len(src.Samples))
...
func (m *ClientEdgeEvent) ValidateEnums() error {
	if _, ok := ClientEdgeEvent_ClientEventType_name[int32(m.Event)]; !ok {
...
func (m *ServerEdgeEvent) CopyInFields(src *ServerEdgeEvent) int {
	...
	if m.CloudletMaintenanceState != src.CloudletMaintenanceState {
		m.CloudletMaintenanceState = src.CloudletMaintenanceState
		changed++
	}
	if m.AppinstHealthState != src.AppinstHealthState {
		m.AppinstHealthState = src.AppinstHealthState
		changed++
	}
	if src.Latency != nil {
		m.Latency = &Latency{}
		if m.Latency.Avg != src.Latency.Avg {
			m.Latency.Avg = src.Latency.Avg
			changed++
		}
		if m.Latency.Min != src.Latency.Min {
			m.Latency.Min = src.Latency.Min
			changed++
		}
		if m.Latency.Max != src.Latency.Max {
			m.Latency.Max = src.Latency.Max
			changed++
		}
		if m.Latency.StdDev != src.Latency.StdDev {
			m.Latency.StdDev = src.Latency.StdDev
			changed++
		}
		if m.Latency.Variance != src.Latency.Variance {
			m.Latency.Variance = src.Latency.Variance
			changed++
		}
		if m.Latency.NumSamples != src.Latency.NumSamples {
		...
		if src.Latency.Timestamp != nil {
			...
			if m.Latency.Timestamp.Seconds != src.Latency.Timestamp.Seconds {
				m.Latency.Timestamp.Seconds = src.Latency.Timestamp.Seconds
				changed++
			}
			if m.Latency.Timestamp.Nanos != src.Latency.Timestamp.Nanos {
				m.Latency.Timestamp.Nanos = src.Latency.Timestamp.Nanos
				changed++
			}
		} else if m.Latency.Timestamp != nil {
			m.Latency.Timestamp = nil
			changed++
		}
...
func (m *ServerEdgeEvent) DeepCopyIn(src *ServerEdgeEvent) {
	...
	m.AppinstHealthState = src.AppinstHealthState
	if src.Latency != nil {
		var tmp_Latency Latency
		tmp_Latency.DeepCopyIn(src.Latency)
		m.Latency = &tmp_Latency
	} else {
		m.Latency = nil
	}
	if src.Tags != nil {
...
func (m *ServerEdgeEvent) ValidateEnums() error {
	if _, ok := ServerEdgeEvent_ServerEventType_name[int32(m.Event)]; !ok {
		return errors.New("invalid Event")
	}
	if _, ok := ServerEdgeEvent_CloudletState_name[int32(m.CloudletState)]; !ok {
		return errors.New("invalid CloudletState")
	}
	if _, ok := ServerEdgeEvent_CloudletMaintenanceState_name[int32(m.CloudletMaintenanceState)]; !ok {
		return errors.New("invalid CloudletMaintenanceState")
	}
	if _, ok := ServerEdgeEvent_AppInstHealthState_name[int32(m.AppinstHealthState)]; !ok {
		return errors.New("invalid AppinstHealthState")
	}
	if err := m.Latency.ValidateEnums(); err != nil {
		return err
	}
	return nil
}
...
const (
	...
	CloudletStateCLOUDLET_STATE_READY       uint64 = 1 << 1
	CloudletStateCLOUDLET_OFFLINE           uint64 = 1 << 2
	CloudletStateCLOUDLET_STATE_NOT_PRESENT uint64 = 1 << 3
	CloudletStateCLOUDLET_UPGRADE           uint64 = 1 << 4
	CloudletStateCLOUDLET_STATE_ERRORS      uint64 = 1 << 5
	CloudletStateCLOUDLET_STATE_INIT        uint64 = 1 << 6
)

var ServerEdgeEvent_CloudletState_CamelName = map[int32]string{
	// CLOUDLET_STATE_UNKNOWN -> CloudletStateUnknown
	0: "CloudletStateUnknown",
	// CLOUDLET_STATE_READY -> CloudletStateReady
	1: "CloudletStateReady",
	// CLOUDLET_OFFLINE -> CloudletOffline
	2: "CloudletOffline",
	// CLOUDLET_STATE_NOT_PRESENT -> CloudletStateNotPresent
	3: "CloudletStateNotPresent",
	// CLOUDLET_UPGRADE -> CloudletUpgrade
	4: "CloudletUpgrade",
	// CLOUDLET_STATE_ERRORS -> CloudletStateErrors
	5: "CloudletStateErrors",
	// CLOUDLET_STATE_INIT -> CloudletStateInit
	6: "CloudletStateInit",
}
var ServerEdgeEvent_CloudletState_CamelValue = map[string]int32{
	"CloudletStateUnknown":    0,
	"CloudletStateReady":      1,
	"CloudletOffline":         2,
	"CloudletStateNotPresent": 3,
	"CloudletUpgrade":         4,
	"CloudletStateErrors":     5,
	"CloudletStateInit":       6,
}

func (e *ServerEdgeEvent_CloudletState) UnmarshalYAML(unmarshal func(interface{}) error) error {
	var str string
	err := unmarshal(&str)
	if err != nil {
		return err
	}
	val, ok := ServerEdgeEvent_CloudletState_CamelValue[util.CamelCase(str)]
	if !ok {
		// may be enum value instead of string
		ival, err := strconv.Atoi(str)
		val = int32(ival)
		if err == nil {
			_, ok = ServerEdgeEvent_CloudletState_CamelName[val]
		}
	}
	if !ok {
		return errors.New(fmt.Sprintf("No enum value for %s", str))
	}
	*e = ServerEdgeEvent_CloudletState(val)
	return nil
}

func (e ServerEdgeEvent_CloudletState) MarshalYAML() (interface{}, error) {
	return proto.EnumName(ServerEdgeEvent_CloudletState_CamelName, int32(e)), nil
}

// custom JSON encoding/decoding
func (e *ServerEdgeEvent_CloudletState) UnmarshalJSON(b []byte) error {
	var str string
	err := json.Unmarshal(b, &str)
	if err == nil {
		val, ok := ServerEdgeEvent_CloudletState_CamelValue[util.CamelCase(str)]
...
var CloudletMaintenanceStateStrings = []string{
	"MAINTENANCE_STATE_UNKNOWN",
	"MAINTENANCE_STATE_NORMAL",
	"MAINTENANCE_STATE_UNDER_MAINTENANCE",
	"MAINTENANCE_STATE_MAINTENANCE_FAILED",
	"MAINTENANCE_STATE_FAILING_OVER",
	"MAINTENANCE_STATE_FAILOVER_ERROR",
	"MAINTENANCE_STATE_FAILOVER_DONE",
}

const (
	CloudletMaintenanceStateMAINTENANCE_STATE_UNKNOWN            uint64 = 1 << 0
	CloudletMaintenanceStateMAINTENANCE_STATE_NORMAL             uint64 = 1 << 1
	CloudletMaintenanceStateMAINTENANCE_STATE_UNDER_MAINTENANCE  uint64 = 1 << 2
	CloudletMaintenanceStateMAINTENANCE_STATE_MAINTENANCE_FAILED uint64 = 1 << 3
	CloudletMaintenanceStateMAINTENANCE_STATE_FAILING_OVER       uint64 = 1 << 4
	CloudletMaintenanceStateMAINTENANCE_STATE_FAILOVER_ERROR     uint64 = 1 << 5
	CloudletMaintenanceStateMAINTENANCE_STATE_FAILOVER_DONE      uint64 = 1 << 6
)

var ServerEdgeEvent_CloudletMaintenanceState_CamelName = map[int32]string{
	// MAINTENANCE_STATE_UNKNOWN -> MaintenanceStateUnknown
	0: "MaintenanceStateUnknown",
	// MAINTENANCE_STATE_NORMAL -> MaintenanceStateNormal
	1: "MaintenanceStateNormal",
	// MAINTENANCE_STATE_UNDER_MAINTENANCE -> MaintenanceStateUnderMaintenance
	2: "MaintenanceStateUnderMaintenance",
	// MAINTENANCE_STATE_MAINTENANCE_FAILED -> MaintenanceStateMaintenanceFailed
	3: "MaintenanceStateMaintenanceFailed",
	// MAINTENANCE_STATE_FAILING_OVER -> MaintenanceStateFailingOver
	4: "MaintenanceStateFailingOver",
	// MAINTENANCE_STATE_FAILOVER_ERROR -> MaintenanceStateFailoverError
	5: "MaintenanceStateFailoverError",
	// MAINTENANCE_STATE_FAILOVER_DONE -> MaintenanceStateFailoverDone
	6: "MaintenanceStateFailoverDone",
}
var ServerEdgeEvent_CloudletMaintenanceState_CamelValue = map[string]int32{
	"MaintenanceStateUnknown":           0,
	"MaintenanceStateNormal":            1,
	"MaintenanceStateUnderMaintenance":  2,
	"MaintenanceStateMaintenanceFailed": 3,
	"MaintenanceStateFailingOver":       4,
	"MaintenanceStateFailoverError":     5,
	"MaintenanceStateFailoverDone":      6,
}

func (e *ServerEdgeEvent_CloudletMaintenanceState) UnmarshalYAML(unmarshal func(interface{}) error) error {
	var str string
	err := unmarshal(&str)
	if err != nil {
		return err
	}
	val, ok := ServerEdgeEvent_CloudletMaintenanceState_CamelValue[util.CamelCase(str)]
	if !ok {
		// may be enum value instead of string
		ival, err := strconv.Atoi(str)
		val = int32(ival)
		if err == nil {
			_, ok = ServerEdgeEvent_CloudletMaintenanceState_CamelName[val]
		}
	}
	if !ok {
		return errors.New(fmt.Sprintf("No enum value for %s", str))
	}
	*e = ServerEdgeEvent_CloudletMaintenanceState(val)
	return nil
}

func (e ServerEdgeEvent_CloudletMaintenanceState) MarshalYAML() (interface{}, error) {
	return proto.EnumName(ServerEdgeEvent_CloudletMaintenanceState_CamelName, int32(e)), nil
}

// custom JSON encoding/decoding
func (e *ServerEdgeEvent_CloudletMaintenanceState) UnmarshalJSON(b []byte) error {
	var str string
	err := json.Unmarshal(b, &str)
	if err == nil {
		val, ok := ServerEdgeEvent_CloudletMaintenanceState_CamelValue[util.CamelCase(str)]
...
var AppInstHealthStateStrings = []string{
...
const (
	AppInstHealthStateHEALTH_CHECK_UNKNOWN uint64 = 1 << 0
	AppInstHealthStateHEALTH_CHECK_OK      uint64 = 1 << 1
	AppInstHealthStateHEALTH_CHECK_FAIL    uint64 = 1 << 2
	AppInstHealthStateAPPINST_DOWN         uint64 = 1 << 3
)

var ServerEdgeEvent_AppInstHealthState_CamelName = map[int32]string{
	// HEALTH_CHECK_UNKNOWN -> HealthCheckUnknown
	0: "HealthCheckUnknown",
	// HEALTH_CHECK_OK -> HealthCheckOk
	1: "HealthCheckOk",
	// HEALTH_CHECK_FAIL -> HealthCheckFail
	2: "HealthCheckFail",
	// APPINST_DOWN -> AppinstDown
	3: "AppinstDown",
}
var ServerEdgeEvent_AppInstHealthState_CamelValue = map[string]int32{
...
func (e *ServerEdgeEvent_AppInstHealthState) UnmarshalYAML(unmarshal func(interface{}) error) error {
	var str string
	err := unmarshal(&str)
	if err != nil {
		return err
	}
	val, ok := ServerEdgeEvent_AppInstHealthState_CamelValue[util.CamelCase(str)]
	if !ok {
		// may be enum value instead of string
		ival, err := strconv.Atoi(str)
		val = int32(ival)
		if err == nil {
			_, ok = ServerEdgeEvent_AppInstHealthState_CamelName[val]
		}
	}
	if !ok {
		return errors.New(fmt.Sprintf("No enum value for %s", str))
	}
	*e = ServerEdgeEvent_AppInstHealthState(val)
	return nil
}

func (e ServerEdgeEvent_AppInstHealthState) MarshalYAML() (interface{}, error) {
	return proto.EnumName(ServerEdgeEvent_AppInstHealthState_CamelName, int32(e)), nil
}

// custom JSON encoding/decoding
func (e *ServerEdgeEvent_AppInstHealthState) UnmarshalJSON(b []byte) error {
	var str string
	err := json.Unmarshal(b, &str)
	if err == nil {
		val, ok := ServerEdgeEvent_AppInstHealthState_CamelValue[util.CamelCase(str)]
...
func (m *ClientEdgeEvent) Size() (n int) {
	...
	if m.Event != 0 {
		n += 1 + sovAppClient(uint64(m.Event))
	}
	if m.GpsLocation != nil {
		l = m.GpsLocation.Size()
		n += 1 + l + sovAppClient(uint64(l))
	...
	if len(m.Samples) > 0 {
		n += 1 + sovAppClient(uint64(len(m.Samples)*8)) + len(m.Samples)*8
	}
	if len(m.Tags) > 0 {
		for k, v := range m.Tags {
			_ = k
...
func (m *ServerEdgeEvent) Size() (n int) {
	...
	if m.CloudletMaintenanceState != 0 {
		n += 1 + sovAppClient(uint64(m.CloudletMaintenanceState))
	}
	if m.AppinstHealthState != 0 {
		n += 1 + sovAppClient(uint64(m.AppinstHealthState))
	}
	if m.Latency != nil {
		l = m.Latency.Size()
		n += 1 + l + sovAppClient(uint64(l))
...
func (m *FindCloudletReply) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DmeFqdn", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.DmeFqdn = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 100:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Tags", wireType)
	...
	for iNdEx < l {
		...
		case 3:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Event |= ClientEdgeEvent_ClientEventType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Event |= ServerEdgeEvent_ServerEventType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.CloudletState |= ServerEdgeEvent_CloudletState(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field CloudletMaintenanceState", wireType)
			}
			m.CloudletMaintenanceState = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowAppClient
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.CloudletMaintenanceState |= ServerEdgeEvent_CloudletMaintenanceState(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field AppinstHealthState", wireType)
			}
			m.AppinstHealthState = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowAppClient
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.AppinstHealthState |= ServerEdgeEvent_AppInstHealthState(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
