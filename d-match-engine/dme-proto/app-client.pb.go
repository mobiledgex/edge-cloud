...
type FqdnListReply struct {
	// API version
	Ver    uint32                  `protobuf:"varint,1,opt,name=ver,proto3" json:"ver,omitempty"`
	Status FqdnListReply_FL_Status `protobuf:"varint,2,opt,name=Status,proto3,enum=distributed_match_engine.FqdnListReply_FL_Status" json:"Status,omitempty"`
	Fqdns  []string                `protobuf:"bytes,3,rep,name=Fqdns" json:"Fqdns,omitempty"`
}
...
func (*FqdnListReply) Descriptor() ([]byte, []int) { return fileDescriptorAppClient, []int{13} }
...
func (*DynamicLocGroupRequest) Descriptor() ([]byte, []int) { return fileDescriptorAppClient, []int{14} }
...
func (*DynamicLocGroupReply) Descriptor() ([]byte, []int) { return fileDescriptorAppClient, []int{15} }
...
var fileDescriptorAppClient = []byte{
	...
	,
}
