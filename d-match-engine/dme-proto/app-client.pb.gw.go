...
func request_MatchEngineApi_GetAppFqdn_0(ctx context.Context, marshaler runtime.Marshaler, client MatchEngineApiClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq AppFqdnRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := client.GetAppFqdn(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err
...
func RegisterMatchEngineApiHandlerClient(ctx context.Context, mux *runtime.ServeMux, client MatchEngineApiClient) error {
	...
	mux.Handle("POST", pattern_MatchEngineApi_GetAppFqdn_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req)
		...
		resp, md, err := request_MatchEngineApi_GetAppFqdn_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_MatchEngineApi_GetAppFqdn_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	...
	pattern_MatchEngineApi_GetAppFqdn_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "getappfqdn"}, ""))
...
var (
	...
	forward_MatchEngineApi_GetAppFqdn_0 = runtime.ForwardResponseMessage
