...
var cloudletVMImagePath = flag.String("cloudletVMImagePath", "https://artifactory.mobiledgex.net/artifactory/baseimages/mobiledgex-v2.0.3.qcow2#md5:d153061120e91a296fe722275063f6cf", "mobiledgex VM image for deploying cloudlet services")
