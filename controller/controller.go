...
func startServices() error {
	...
	edgeproto.RegisterClusterInstRefsApiServer(server, &clusterInstRefsApi)
...
func InitNotify(influxQ *influxq.InfluxQ, clientQ notify.RecvAppInstClientHandler) {
	...
	notify.ServerMgrOne.RegisterSendClusterInstRefsCache(&clusterInstRefsApi.cache)
